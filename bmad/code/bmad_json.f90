...
subroutine compounddatanist_to_json (input, json_root, depth)
  ...
  !line=24 definition='integer nElements, elements(1)' name='elements' python_name='elements' type='integer' python_type='int' size=None dimension='1' comment='' fortran_default=None default=0 default_factory=''
  ...
  nullify(json_list1)
  !line=25 definition='real massFractions(1), density' name='massFractions' python_name='massfractions' type='real' python_type='float' size=None dimension='1' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine pmd_unit_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=12 definition='real(rp) :: unitDimension(7) = 0' name='unitDimension' python_name='unitdimension' type='real' python_type='float' size=None dimension='7' comment='SI Base Exponents' fortran_default='0' default=0 default_factory=''
...
subroutine ac_kicker_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%amp_vs_time)) then
    !line=686 definition='type (ac_kicker_time_struct), allocatable :: amp_vs_time(:)' name='amp_vs_time' python_name='amp_vs_time' type='ac_kicker_time_struct' python_type='AcKickerTimeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%frequency)) then
    !line=687 definition='type (ac_kicker_freq_struct), allocatable :: frequency(:)' name='frequency' python_name='frequency' type='ac_kicker_freq_struct' python_type='AcKickerFreqStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine anormal_mode_struct_to_json (input, json_root, depth)
  ...
  !line=1924 definition='real(rp) :: synch_int(4:6) = 0' name='synch_int' python_name='synch_int' type='real' python_type='float' size=None dimension='4:6' comment='Synchrotron integrals' fortran_default='0' default=0 default_factory=''
...
subroutine aperture_scan_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%point)) then
    !line=2085 definition='type (aperture_point_struct), allocatable :: point(:)' name='point' python_name='point' type='aperture_point_struct' python_type='AperturePointStruct' size=None dimension=':' comment='Set of aperture points at different angles.' fortran_default=None default=None default_factory=''
...
subroutine beam_init_struct_to_json (input, json_root, depth)
  ...
  !line=1157 definition='real(rp) :: center(6) = 0' name='center' python_name='center' type='real' python_type='float' size=None dimension='6' comment='Bench phase space center offset relative to reference.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1142 definition='real(rp) :: center_jitter(6) = 0.0' name='center_jitter' python_name='center_jitter' type='real' python_type='float' size=None dimension='6' comment='Bunch center rms jitter' fortran_default='0.0' default=0.0 default_factory=''
  ...
  !line=1137 definition="character(16) :: distribution_type(3) = 'RAN_GAUSS'" name='distribution_type' python_name='distribution_type' type='character' python_type='str' size='16' dimension='3' comment='distribution type (in x-px, y-py, and z-pz planes)' fortran_default="'RAN_GAUSS'" default='RAN_GAUSS' default_factory=''
  ...
  !line=1139 definition='type (ellipse_beam_init_struct) :: ellipse(3) = ellipse_beam_init_struct()' name='ellipse' python_name='ellipse' type='ellipse_beam_init_struct' python_type='EllipseBeamInitStruct' size=None dimension='3' comment='Ellipse beam distribution' fortran_default='ellipse_beam_init_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1143 definition='real(rp) :: emit_jitter(2)   = 0.0' name='emit_jitter' python_name='emit_jitter' type='real' python_type='float' size=None dimension='2' comment='a and b bunch emittance rms jitter normalized to emittance' fortran_default='0.0' default=0.0 default_factory=''
  ...
  !line=1141 definition='type (grid_beam_init_struct) :: grid(3) = grid_beam_init_struct()' name='grid' python_name='grid' type='grid_beam_init_struct' python_type='GridBeamInitStruct' size=None dimension='3' comment='Grid beam distribution' fortran_default='grid_beam_init_struct()' default=None default_factory=''
  ...
  !line=1138 definition='real(rp) :: spin(3) = 0' name='spin' python_name='spin' type='real' python_type='float' size=None dimension='3' comment='Spin (x, y, z)' fortran_default='0' default=0 default_factory=''
...
subroutine beam_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%bunch)) then
    !line=1111 definition='type (bunch_struct), allocatable :: bunch(:)' name='bunch' python_name='bunch' type='bunch_struct' python_type='BunchStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine bmad_common_struct_to_json (input, json_root, depth)
  ...
  !line=2223 definition='real(rp) :: d_orb(6)           = 1d-5' name='d_orb' python_name='d_orb' type='real' python_type='float' size=None dimension='6' comment='Orbit deltas for the mat6 via tracking calc.' fortran_default='1d-5' default=1e-05 default_factory=''
...
subroutine bmad_normal_form_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1534 definition='type (taylor_struct) :: A(6) = taylor_struct()' name='A' python_name='a' type='taylor_struct' python_type='TaylorStruct' size=None dimension='6' comment='Map from Floquet -> Lab coordinates' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1535 definition='type (taylor_struct) :: A_inv(6) = taylor_struct()' name='A_inv' python_name='a_inv' type='taylor_struct' python_type='TaylorStruct' size=None dimension='6' comment='Map from Lab -> Floquet coordinates' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1537 definition='type (complex_taylor_struct) :: F(6) = complex_taylor_struct()' name='F' python_name='f' type='complex_taylor_struct' python_type='ComplexTaylorStruct' size=None dimension='6' comment='Vector field factorization in phasor basis:' fortran_default='complex_taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1538 definition='type (complex_taylor_struct) :: L(6) = complex_taylor_struct()' name='L' python_name='L' type='complex_taylor_struct' python_type='ComplexTaylorStruct' size=None dimension='6' comment='L component' fortran_default='complex_taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1533 definition='type (taylor_struct) :: M(6) = taylor_struct()' name='M' python_name='m' type='taylor_struct' python_type='TaylorStruct' size=None dimension='6' comment='One-turn taylor map: M = A o N o A_inv, N = exp(:h:)' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1536 definition='type (taylor_struct) :: dhdj(6) = taylor_struct()' name='dhdj' python_name='dhdj' type='taylor_struct' python_type='TaylorStruct' size=None dimension='6' comment='Nonlinear tune function operating on Floquet coordinates' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  if (allocated(input%h)) then
    !line=1539 definition='type (resonance_h_struct), allocatable :: h(:)' name='h' python_name='h' type='resonance_h_struct' python_type='ResonanceHStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine branch_struct_to_json (input, json_root, depth)
  ...
  if (associated(input%ele)) then
    !line=1567 definition='type (ele_struct), pointer :: ele(:) => null()' name='ele' python_name='ele' type='ele_struct' python_type='EleStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%wall3d)) then
    !line=1569 definition='type (wall3d_struct), pointer :: wall3d(:) => null()' name='wall3d' python_name='wall3d' type='wall3d_struct' python_type='Wall3dStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
...
subroutine bunch_params_struct_to_json (input, json_root, depth)
  ...
  !line=1192 definition='real(rp) :: rel_max(7) = 0' name='rel_max' python_name='rel_max' type='real' python_type='float' size=None dimension='7' comment='Max orbit relative to centroid. 7 -> time.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1193 definition='real(rp) :: rel_min(7) = 0' name='rel_min' python_name='rel_min' type='real' python_type='float' size=None dimension='7' comment='Min orbit relative to_centroid. 7 -> time.' fortran_default='0' default=0 default_factory=''
  ...
  !line=1191 definition='real(rp) :: sigma(6,6) = 0' name='sigma' python_name='sigma' type='real' python_type='float' size=None dimension='6,6' comment='beam size matrix' fortran_default='0' default=0 default_factory=''
...
subroutine bunch_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ix_z)) then
    !line=1092 definition='integer, allocatable :: ix_z(:)' name='ix_z' python_name='ix_z' type='integer' python_type='int' size=None dimension=':' comment='bunch%ix_z(1) is index of head particle, etc.' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%particle)) then
    !line=1091 definition='type (coord_struct), allocatable :: particle(:)' name='particle' python_name='particle' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine bunch_track_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pt)) then
    !line=1214 definition='type (bunch_params_struct), allocatable :: pt(:)' name='pt' python_name='pt' type='bunch_params_struct' python_type='BunchParamsStruct' size=None dimension=':' comment='Array indexed from 0' fortran_default=None default=None default_factory=''
...
subroutine cartesian_map_struct_to_json (input, json_root, depth)
  ...
  !line=715 definition='real(rp) :: r0(3) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='3' comment='Field origin offset.' fortran_default='0' default=0 default_factory=''
...
subroutine cartesian_map_term_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%term)) then
    !line=710 definition='type (cartesian_map_term1_struct), allocatable :: term(:)' name='term' python_name='term' type='cartesian_map_term1_struct' python_type='CartesianMapTerm1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine complex_taylor_struct_to_json (input, json_root, depth)
  ...
  if (associated(input%term)) then
    !line=489 definition='type (complex_taylor_term_struct), pointer :: term(:) => null()' name='term' python_name='term' type='complex_taylor_term_struct' python_type='ComplexTaylorTermStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'term')
    do i1 = lbound(input%term, 1), ubound(input%term, 1)
...
subroutine complex_taylor_term_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_list1)
  !line=471 definition='integer :: expn(6)' name='expn' python_name='expn' type='integer' python_type='int' size=None dimension='6' comment='' fortran_default=None default=0 default_factory=''
...
subroutine control_ramp1_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%stack)) then
    !line=1328 definition='type (expression_atom_struct), allocatable :: stack(:)' name='stack' python_name='stack' type='expression_atom_struct' python_type='ExpressionAtomStruct' size=None dimension=':' comment='Evaluation stack' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%y_knot)) then
    !line=1327 definition='real(rp), allocatable :: y_knot(:)' name='y_knot' python_name='y_knot' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine control_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'slave_name', trim(input%slave_name))
  if (allocated(input%stack)) then
    !line=1311 definition='type (expression_atom_struct), allocatable :: stack(:)' name='stack' python_name='stack' type='expression_atom_struct' python_type='ExpressionAtomStruct' size=None dimension=':' comment='Evaluation stack' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'stack')
    do i1 = lbound(input%stack, 1), ubound(input%stack, 1)
      call expression_atom_struct_to_json(input%stack(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'value', input%value)
  if (allocated(input%y_knot)) then
    !line=1310 definition='real(rp), allocatable :: y_knot(:)' name='y_knot' python_name='y_knot' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'y_knot')
    do i1 = lbound(input%y_knot, 1), ubound(input%y_knot, 1)
      call json%create_real(json_val, input%y_knot(i1), '')
      call json%add(json_list1, json_val)
...
subroutine controller_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ramp)) then
    !line=1345 definition='type (control_ramp1_struct), allocatable :: ramp(:)' name='ramp' python_name='ramp' type='control_ramp1_struct' python_type='ControlRamp1Struct' size=None dimension=':' comment='For ramper lord elements' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%ramper_lord)) then
    !line=1346 definition='type (ramper_lord_struct), allocatable :: ramper_lord(:)' name='ramper_lord' python_name='ramper_lord' type='ramper_lord_struct' python_type='RamperLordStruct' size=None dimension=':' comment='Ramper lord info for this slave' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%var)) then
    !line=1344 definition='type (control_var1_struct), allocatable :: var(:)' name='var' python_name='var' type='control_var1_struct' python_type='ControlVar1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%x_knot)) then
    !line=1347 definition='real(rp), allocatable :: x_knot(:)' name='x_knot' python_name='x_knot' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine converter_dir_1D_struct_to_json (input, json_root, depth)
  ...
  !line=1243 definition='real(rp) :: poly(0:4) = 0' name='poly' python_name='poly' type='real' python_type='float' size=None dimension='0:4' comment='param(r) = Sum: poly(i) * r^i' fortran_default='0' default=0 default_factory=''
...
subroutine converter_dir_2D_struct_to_json (input, json_root, depth)
  ...
  !line=1248 definition='real(rp) :: poly(0:3) = 0' name='poly' python_name='poly' type='real' python_type='float' size=None dimension='0:3' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'poly')
  do i1 = lbound(input%poly, 1), ubound(input%poly, 1)
    call json%create_real(json_val, input%poly(i1), '')
    call json%add(json_list1, json_val)
...
subroutine converter_dir_coef_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%fit_1d_r)) then
    !line=1252 definition='type (converter_dir_1D_struct), allocatable :: fit_1d_r(:)' name='fit_1d_r' python_name='fit_1d_r' type='converter_dir_1D_struct' python_type='ConverterDir1dStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine converter_distribution_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%sub_dist)) then
    !line=1292 definition='type (converter_sub_distribution_struct), allocatable :: sub_dist(:)' name='sub_dist' python_name='sub_dist' type='converter_sub_distribution_struct' python_type='ConverterSubDistributionStruct' size=None dimension=':' comment='Distribution at various pc_in values.' fortran_default=None default=None default_factory=''
...
subroutine converter_prob_pc_r_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%integ_pc_out)) then
    !line=1232 definition='real(rp), allocatable :: integ_pc_out(:)' name='integ_pc_out' python_name='integ_pc_out' type='real' python_type='float' size=None dimension=':' comment='Normalized probability integrated from min pc_out up.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%integ_r)) then
    !line=1233 definition='real(rp), allocatable :: integ_r(:,:)' name='integ_r' python_name='integ_r' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%integ_r_ave)) then
    !line=1234 definition='real(rp), allocatable :: integ_r_ave(:)' name='integ_r_ave' python_name='integ_r_ave' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%p_norm)) then
    !line=1231 definition='real(rp), allocatable :: p_norm(:,:)' name='p_norm' python_name='p_norm' type='real' python_type='float' size=None dimension=':,:' comment='Normalized probability taking into account.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%pc_out)) then
    !line=1225 definition='real(rp), allocatable :: pc_out(:)' name='pc_out' python_name='pc_out' type='real' python_type='float' size=None dimension=':' comment='Grid pc_out values.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%prob)) then
    !line=1227 definition='real(rp), allocatable :: prob(:,:)' name='prob' python_name='prob' type='real' python_type='float' size=None dimension=':,:' comment='Probability grid.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%r)) then
    !line=1226 definition='real(rp), allocatable :: r(:)' name='r' python_name='r' type='real' python_type='float' size=None dimension=':' comment='Grid r_out values.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%spin_z)) then
    !line=1228 definition='real(rp), allocatable :: spin_z(:,:)' name='spin_z' python_name='spin_z' type='real' python_type='float' size=None dimension=':,:' comment='Z polarization grid.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine converter_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%dist)) then
    !line=1301 definition='type (converter_distribution_struct), allocatable :: dist(:)' name='dist' python_name='dist' type='converter_distribution_struct' python_type='ConverterDistributionStruct' size=None dimension=':' comment='Distribution at various thicknesses' fortran_default=None default=None default_factory=''
...
subroutine converter_sub_distribution_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=1269 definition='real(rp) :: spin_in(3)' name='spin_in' python_name='spin_in' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine coord_array_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%orbit)) then
    !line=562 definition='type (coord_struct), allocatable :: orbit(:)' name='orbit' python_name='orbit' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine coord_struct_to_json (input, json_root, depth)
  ...
  !line=534 definition='real(rp) :: field(2) = 0' name='field' python_name='field' type='real' python_type='float' size=None dimension='2' comment='Photon E-field intensity (x,y).' fortran_default='0' default=0 default_factory=''
  ...
  !line=535 definition='real(rp) :: phase(2) = 0' name='phase' python_name='phase' type='real' python_type='float' size=None dimension='2' comment='Photon E-field phase (x,y). phase(1) is also used with' fortran_default='0' default=0 default_factory=''
  ...
  !line=533 definition='real(rp) :: spin(3) = 0' name='spin' python_name='spin' type='real' python_type='float' size=None dimension='3' comment='Spin.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'spin')
  do i1 = lbound(input%spin, 1), ubound(input%spin, 1)
    call json%create_real(json_val, input%spin(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=530 definition='real(rp) :: vec(6) = 0' name='vec' python_name='vec' type='real' python_type='float' size=None dimension='6' comment='(x, px, y, py, z, pz). Generally phase space for charged particles. See Bmad manual.' fortran_default='0' default=0 default_factory=''
...
subroutine cylindrical_map_struct_to_json (input, json_root, depth)
  ...
  !line=744 definition='real(rp) :: r0(3) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='3' comment='Field origin offset.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine cylindrical_map_term_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'n_link', int(input%n_link))
  if (allocated(input%term)) then
    !line=732 definition='type (cylindrical_map_term1_struct), allocatable :: term(:)' name='term' python_name='term' type='cylindrical_map_term1_struct' python_type='CylindricalMapTerm1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'term')
    do i1 = lbound(input%term, 1), ubound(input%term, 1)
...
subroutine ele_struct_to_json (input, json_root, depth)
  ...
  if (associated(input%a_pole)) then
    !line=1416 definition='real(rp), pointer :: a_pole(:) => null()' name='a_pole' python_name='a_pole' type='real' python_type='float' size=None dimension=':' comment='knl for multipole elements.' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%a_pole_elec)) then
    !line=1418 definition='real(rp), pointer :: a_pole_elec(:) => null()' name='a_pole_elec' python_name='a_pole_elec' type='real' python_type='float' size=None dimension=':' comment='Electrostatic multipoles. ksnl for multipole elements.' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%b_pole)) then
    !line=1417 definition='real(rp), pointer :: b_pole(:) => null()' name='b_pole' python_name='b_pole' type='real' python_type='float' size=None dimension=':' comment='tilt for multipole elements.' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%b_pole_elec)) then
    !line=1419 definition='real(rp), pointer :: b_pole_elec(:) => null()' name='b_pole_elec' python_name='b_pole_elec' type='real' python_type='float' size=None dimension=':' comment='Electrostatic multipoles.' fortran_default='null()' default=0.0 default_factory=''
  ...
  !line=1411 definition='real(rp) :: c_mat(2,2) = 0' name='c_mat' python_name='c_mat' type='real' python_type='float' size=None dimension='2,2' comment='2x2 C coupling matrix' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%cartesian_map)) then
    !line=1398 definition='type (cartesian_map_struct), pointer :: cartesian_map(:) => null()' name='cartesian_map' python_name='cartesian_map' type='cartesian_map_struct' python_type='CartesianMapStruct' size=None dimension=':' comment='Used to define E/M fields' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%custom)) then
    !line=1420 definition='real(rp), pointer :: custom(:) => null()' name='custom' python_name='custom' type='real' python_type='float' size=None dimension=':' comment='Custom attributes.' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%cylindrical_map)) then
    !line=1399 definition='type (cylindrical_map_struct), pointer :: cylindrical_map(:) => null()' name='cylindrical_map' python_name='cylindrical_map' type='cylindrical_map_struct' python_type='CylindricalMapStruct' size=None dimension=':' comment='Used to define E/M fields' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%gen_grad_map)) then
    !line=1400 definition='type (gen_grad_map_struct), pointer :: gen_grad_map(:) => null()' name='gen_grad_map' python_name='gen_grad_map' type='gen_grad_map_struct' python_type='GenGradMapStruct' size=None dimension=':' comment='Used to define E/M fields.' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%grid_field)) then
    !line=1401 definition='type (grid_field_struct), pointer :: grid_field(:) => null()' name='grid_field' python_name='grid_field' type='grid_field_struct' python_type='GridFieldStruct' size=None dimension=':' comment='Used to define E/M fields.' fortran_default='null()' default=None default_factory=''
  ...
  ! config skip_members: ele_struct%lord (ele_struct, Pointer to a slice lord.)
  ...
  call json%add(json_root, json_val)
  !line=1410 definition='real(rp) :: mat6(6,6) = 0' name='mat6' python_name='mat6' type='real' python_type='float' size=None dimension='6,6' comment='1st order transport matrix.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  !line=1407 definition='real(rp) :: old_value(num_ele_attrib$) = 0' name='old_value' python_name='old_value' type='real' python_type='float' size=None dimension='num_ele_attrib$' comment='Used to see if %value(:) array has changed.' fortran_default='0' default=0 default_factory=''
  ...
  if (associated(input%r)) then
    !line=1421 definition='real(rp), pointer :: r(:,:,:) => null()' name='r' python_name='r' type='real' python_type='float' size=None dimension=':,:,:' comment='For general use. Not used by Bmad.' fortran_default='null()' default=0.0 default_factory=''
  ...
  !line=1408 definition='real(rp) :: spin_q(0:3,0:6) = real_garbage$' name='spin_q' python_name='spin_q' type='real' python_type='float' size=None dimension='0:3,0:6' comment='0th and 1st order Spin transport quaternion.' fortran_default='real_garbage$' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=1395 definition='type (taylor_struct) :: spin_taylor(0:3) = taylor_struct()' name='spin_taylor' python_name='spin_taylor' type='taylor_struct' python_type='TaylorStruct' size=None dimension='0:3' comment='Quaternion Spin Taylor map.' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1394 definition='real(rp) :: spin_taylor_ref_orb_in(6) = real_garbage$' name='spin_taylor_ref_orb_in' python_name='spin_taylor_ref_orb_in' type='real' python_type='float' size=None dimension='6' comment='' fortran_default='real_garbage$' default=0.0 default_factory=''
  ...
  !line=1393 definition='type (taylor_struct) :: taylor(6) = taylor_struct()' name='taylor' python_name='taylor' type='taylor_struct' python_type='TaylorStruct' size=None dimension='6' comment='Phase space Taylor map.' fortran_default='taylor_struct()' default=None default_factory=''
  ...
  !line=1406 definition='real(rp) :: value(num_ele_attrib$) = 0' name='value' python_name='value' type='real' python_type='float' size=None dimension='num_ele_attrib$' comment='attribute values.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1409 definition='real(rp) :: vec0(6) = 0' name='vec0' python_name='vec0' type='real' python_type='float' size=None dimension='6' comment='0th order transport vector.' fortran_default='0' default=0 default_factory=''
  ...
  if (associated(input%wall3d)) then
    !line=1397 definition='type (wall3d_struct), pointer :: wall3d(:) => null()' name='wall3d' python_name='wall3d' type='wall3d_struct' python_type='Wall3dStruct' size=None dimension=':' comment='Chamber or capillary wall' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'wall3d')
    do i1 = lbound(input%wall3d, 1), ubound(input%wall3d, 1)
      call wall3d_struct_to_json(input%wall3d(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine em_field_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1979 definition='real(rp) :: A(3) = 0' name='A' python_name='a' type='real' python_type='float' size=None dimension='3' comment='Magnetic vector potential.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%A, 1), ubound(input%A, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1974 definition='real(rp) :: B(3) = 0' name='B' python_name='b' type='real' python_type='float' size=None dimension='3' comment='magnetic field.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1973 definition='real(rp) :: E(3) = 0' name='E' python_name='e' type='real' python_type='float' size=None dimension='3' comment='electric field.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1976 definition='real(rp) :: dB(3,3) = 0' name='dB' python_name='db' type='real' python_type='float' size=None dimension='3,3' comment='magnetic field gradient.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=1975 definition='real(rp) :: dE(3,3) = 0' name='dE' python_name='de' type='real' python_type='float' size=None dimension='3,3' comment='electric field gradient.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine em_taylor_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%term)) then
    !line=813 definition='type (em_taylor_term_struct), allocatable :: term(:)' name='term' python_name='term' type='em_taylor_term_struct' python_type='EmTaylorTermStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'term')
    do i1 = lbound(input%term, 1), ubound(input%term, 1)
...
subroutine em_taylor_term_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'coef', input%coef)
  !line=808 definition='integer :: expn(2) = 0' name='expn' python_name='expn' type='integer' python_type='int' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'expn')
  do i1 = lbound(input%expn, 1), ubound(input%expn, 1)
    call json%create_integer(json_val, input%expn(i1), '')
    call json%add(json_list1, json_val)
...
subroutine floor_position_struct_to_json (input, json_root, depth)
  ...
  !line=828 definition='real(rp) :: r(3) = 0' name='r' python_name='r' type='real' python_type='float' size=None dimension='3' comment='(x, y, z) offset from origin' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r')
  do i1 = lbound(input%r, 1), ubound(input%r, 1)
    call json%create_real(json_val, input%r(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=829 definition='real(rp) :: w(3,3) =  mat3_unit$' name='w' python_name='w' type='real' python_type='float' size=None dimension='3,3' comment='W matrix. Columns are unit vectors of the frame axes.' fortran_default='mat3_unit$' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine foil_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%material)) then
    !line=1285 definition='type (material_struct), allocatable :: material(:)' name='material' python_name='material' type='material_struct' python_type='MaterialStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine fringe_field_info_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%location)) then
    !line=41 definition='integer, allocatable :: location(:)' name='location' python_name='location' type='integer' python_type='int' size=None dimension=':' comment='Particle location in an element. entrance_end$, inside$, or exit_end$' fortran_default=None default=0 default_factory=''
...
subroutine gen_grad1_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%deriv)) then
    !line=754 definition='real(rp), allocatable :: deriv(:,:)' name='deriv' python_name='deriv' type='real' python_type='float' size=None dimension=':,:' comment='Range: (iz0:iz1, 0:2*n_deriv_max+1)' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine gen_grad_map_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%gg)) then
    !line=760 definition='type (gen_grad1_struct), allocatable :: gg(:)' name='gg' python_name='gg' type='gen_grad1_struct' python_type='GenGrad1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  call json%add(json_root, 'master_parameter', int(input%master_parameter))
  !line=766 definition='real(rp) :: r0(3) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='3' comment='field origin relative to ele_anchor_pt.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine grid_field_pt1_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=776 definition='complex(rp) :: B(3) = 0' name='B' python_name='b' type='complex' python_type='Complex' size=None dimension='3' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'b')
  do i1 = lbound(input%B, 1), ubound(input%B, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=775 definition='complex(rp) :: E(3) = 0' name='E' python_name='e' type='complex' python_type='Complex' size=None dimension='3' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'e')
  do i1 = lbound(input%E, 1), ubound(input%E, 1)
...
subroutine grid_field_pt_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'n_link', int(input%n_link))
  if (allocated(input%pt)) then
    !line=782 definition='type (grid_field_pt1_struct), allocatable :: pt(:,:,:)' name='pt' python_name='pt' type='grid_field_pt1_struct' python_type='GridFieldPt1Struct' size=None dimension=':,:,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list3, 'dim-3')
...
subroutine grid_field_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=798 definition='type (bicubic_cmplx_coef_struct) bi_coef(4, 2, 3)' name='bi_coef' python_name='bi_coef' type='bicubic_cmplx_coef_struct' python_type='BicubicCmplxCoefStruct' size=None dimension='4, 2, 3' comment='Save computed coefs for faster tracking' fortran_default=None default=None default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  nullify(json_list3)
  call json%add(json_root, 'curved_ref_frame', input%curved_ref_frame)
  !line=794 definition='real(rp) :: dr(3) = 0' name='dr' python_name='dr' type='real' python_type='float' size=None dimension='3' comment='Grid spacing.' fortran_default='0' default=0 default_factory=''
  ...
  !line=795 definition='real(rp) :: r0(3) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='3' comment='Field origin relative to ele_anchor_pt.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=799 definition='type (tricubic_cmplx_coef_struct) tri_coef(4, 2, 3)' name='tri_coef' python_name='tri_coef' type='tricubic_cmplx_coef_struct' python_type='TricubicCmplxCoefStruct' size=None dimension='4, 2, 3' comment='Save computed coefs for faster tracking' fortran_default=None default=None default_factory=''
  call json%create_array(json_list3, 'dim-3')
...
subroutine kv_beam_init_struct_to_json (input, json_root, depth)
  ...
  !line=1121 definition='integer :: part_per_phi(2) = 0' name='part_per_phi' python_name='part_per_phi' type='integer' python_type='int' size=None dimension='2' comment='number of particles per angle variable.' fortran_default='0' default=0 default_factory=''
...
subroutine lat_ele_order_array_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ele)) then
    !line=866 definition='type (lat_ele_order1_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='lat_ele_order1_struct' python_type='LatEleOrder1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine lat_ele_order_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%branch)) then
    !line=885 definition='type (lat_ele_order_array_struct), allocatable :: branch(:)' name='branch' python_name='branch' type='lat_ele_order_array_struct' python_type='LatEleOrderArrayStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine lat_param_struct_to_json (input, json_root, depth)
  ...
  !line=1479 definition='real(rp) :: t1_no_RF(6,6) = 0' name='t1_no_RF' python_name='t1_no_rf' type='real' python_type='float' size=None dimension='6,6' comment='Full 1-turn matrix with RF off.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=1478 definition='real(rp) :: t1_with_RF(6,6) = 0' name='t1_with_RF' python_name='t1_with_rf' type='real' python_type='float' size=None dimension='6,6' comment='Full 1-turn matrix with RF on.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine lat_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  if (allocated(input%branch)) then
    !line=1605 definition='type (branch_struct), allocatable :: branch(:)' name='branch' python_name='branch' type='branch_struct' python_type='BranchStruct' size=None dimension=':' comment='Branch(0:) array' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'branch')
    do i1 = lbound(input%branch, 1), ubound(input%branch, 1)
  ...
  if (allocated(input%constant)) then
    !line=1599 definition='type (expression_atom_struct), allocatable :: constant(:)' name='constant' python_name='constant' type='expression_atom_struct' python_type='ExpressionAtomStruct' size=None dimension=':' comment='Constants defined in the lattice' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%control)) then
    !line=1606 definition='type (control_struct), allocatable :: control(:)' name='control' python_name='control' type='control_struct' python_type='ControlStruct' size=None dimension=':' comment='Control list' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%custom)) then
    !line=1611 definition='real(rp), allocatable :: custom(:)' name='custom' python_name='custom' type='real' python_type='float' size=None dimension=':' comment='Custom attributes.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'custom')
    do i1 = lbound(input%custom, 1), ubound(input%custom, 1)
      call json%create_real(json_val, input%custom(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ele)) then
    !line=1604 definition='type (ele_struct), pointer ::  ele(:) => null()' name='ele' python_name='ele' type='ele_struct' python_type='EleStruct' size=None dimension=':' comment='Array of elements [=> branch(0)].' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
      call ele_struct_to_json(input%ele(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%ic)) then
    !line=1618 definition='integer, allocatable :: ic(:)' name='ic' python_name='ic' type='integer' python_type='int' size=None dimension=':' comment='Index to %control(:) from slaves.' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%print_str)) then
    !line=1598 definition='character(100), allocatable :: print_str(:)' name='print_str' python_name='print_str' type='character' python_type='str' size='100' dimension=':' comment='Saved print statements.' fortran_default=None default='' default_factory='list'
...
subroutine linear_ele_isf_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%node)) then
    !line=323 definition='type (linear_isf1_struct), allocatable :: node(:)' name='node' python_name='node' type='linear_isf1_struct' python_type='LinearIsf1Struct' size=None dimension=':' comment='Array per PTC integration node.' fortran_default=None default=None default_factory=''
...
subroutine linear_isf1_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=315 definition='real(rp) :: isf(0:3, 0:6) = 0' name='isf' python_name='isf' type='real' python_type='float' size=None dimension='0:3, 0:6' comment='Linear ISF map at a given point.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=314 definition='real(rp) :: orb0(6) = 0' name='orb0' python_name='orb0' type='real' python_type='float' size=None dimension='6' comment='Closed orbit.' fortran_default='0' default=0 default_factory=''
...
subroutine mode3_struct_to_json (input, json_root, depth)
  ...
  call json%rename(json_val, 'c')
  call json%add(json_root, json_val)
  !line=916 definition='real(rp) v(6,6)' name='v' python_name='v' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine multipass_all_info_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%branch)) then
    !line=2054 definition='type (multipass_branch_info_struct), allocatable :: branch(:)' name='branch' python_name='branch' type='multipass_branch_info_struct' python_type='MultipassBranchInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'branch')
    do i1 = lbound(input%branch, 1), ubound(input%branch, 1)
  ...
  if (allocated(input%lord)) then
    !line=2053 definition='type (multipass_lord_info_struct), allocatable :: lord(:)' name='lord' python_name='lord' type='multipass_lord_info_struct' python_type='MultipassLordInfoStruct' size=None dimension=':' comment='Array of lords' fortran_default=None default=None default_factory=''
...
subroutine multipass_branch_info_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%ele)) then
    !line=2046 definition='type (multipass_ele_info_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='multipass_ele_info_struct' python_type='MultipassEleInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine multipass_ele_info_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ix_lord)) then
    !line=2041 definition='integer, allocatable :: ix_lord(:)' name='ix_lord' python_name='ix_lord' type='integer' python_type='int' size=None dimension=':' comment='Pointers to lord(:) array' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%ix_super)) then
    !line=2042 definition='integer, allocatable :: ix_super(:)' name='ix_super' python_name='ix_super' type='integer' python_type='int' size=None dimension=':' comment='Indexes to slave(ix_pass, super_slave%ix_ele) matrix' fortran_default=None default=0 default_factory=''
...
subroutine multipass_lord_info_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%slave)) then
    !line=2032 definition='type (ele_pointer_struct), allocatable :: slave(:,:)' name='slave' python_name='slave' type='ele_pointer_struct' python_type='ElePointerStruct' size=None dimension=':,:' comment='Slaves list in tracking part.' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%super_lord)) then
    !line=2031 definition='type (ele_pointer_struct), allocatable :: super_lord(:)' name='super_lord' python_name='super_lord' type='ele_pointer_struct' python_type='ElePointerStruct' size=None dimension=':' comment='Super_lord list if they exist.' fortran_default=None default=None default_factory=''
...
subroutine multipole_cache_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%a_kick_elec)) then
    !line=952 definition='real(rp), allocatable :: a_kick_elec(:), b_kick_elec(:)' name='a_kick_elec' python_name='a_kick_elec' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%a_kick_mag)) then
    !line=948 definition='real(rp), allocatable :: a_kick_mag(:), b_kick_mag(:)' name='a_kick_mag' python_name='a_kick_mag' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%a_pole_elec)) then
    !line=951 definition='real(rp), allocatable :: a_pole_elec(:), b_pole_elec(:)' name='a_pole_elec' python_name='a_pole_elec' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'a_pole_elec')
    do i1 = lbound(input%a_pole_elec, 1), ubound(input%a_pole_elec, 1)
      call json%create_real(json_val, input%a_pole_elec(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%a_pole_mag)) then
    !line=947 definition='real(rp), allocatable :: a_pole_mag(:), b_pole_mag(:)' name='a_pole_mag' python_name='a_pole_mag' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%b_kick_elec)) then
    !line=952 definition='real(rp), allocatable :: a_kick_elec(:), b_kick_elec(:)' name='b_kick_elec' python_name='b_kick_elec' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%b_kick_mag)) then
    !line=948 definition='real(rp), allocatable :: a_kick_mag(:), b_kick_mag(:)' name='b_kick_mag' python_name='b_kick_mag' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%b_pole_elec)) then
    !line=951 definition='real(rp), allocatable :: a_pole_elec(:), b_pole_elec(:)' name='b_pole_elec' python_name='b_pole_elec' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'b_pole_elec')
    do i1 = lbound(input%b_pole_elec, 1), ubound(input%b_pole_elec, 1)
      call json%create_real(json_val, input%b_pole_elec(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%b_pole_mag)) then
    !line=947 definition='real(rp), allocatable :: a_pole_mag(:), b_pole_mag(:)' name='b_pole_mag' python_name='b_pole_mag' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine normal_modes_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'sig_z', input%sig_z)
  !line=1942 definition='real(rp) :: synch_int(0:3) = 0' name='synch_int' python_name='synch_int' type='real' python_type='float' size=None dimension='0:3' comment='Synchrotron integrals I0, I1, I2, and I3' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'synch_int')
  do i1 = lbound(input%synch_int, 1), ubound(input%synch_int, 1)
    call json%create_real(json_val, input%synch_int(i1), '')
    call json%add(json_list1, json_val)
...
subroutine pauli_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=260 definition='complex(rp) sigma(2,2)' name='sigma' python_name='sigma' type='complex' python_type='Complex' size=None dimension='2,2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%sigma, 2), ubound(input%sigma, 2)
    call json%create_array(json_list1, 'sigma')
    do i1 = lbound(input%sigma, 1), ubound(input%sigma, 1)
...
subroutine photon_element_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%init_energy_prob)) then
    !line=1083 definition='type (spline_struct), allocatable :: init_energy_prob(:)' name='init_energy_prob' python_name='init_energy_prob' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='Initial energy probability density' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%integrated_init_energy_prob)) then
    !line=1084 definition='real(rp), allocatable :: integrated_init_energy_prob(:)' name='integrated_init_energy_prob' python_name='integrated_init_energy_prob' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine photon_material_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_list1)
  !line=1063 definition='real(rp) :: h_norm(3) = 0' name='h_norm' python_name='h_norm' type='real' python_type='float' size=None dimension='3' comment='Normalized H vector for crystals.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1064 definition='real(rp) :: l_ref(3) = 0' name='l_ref' python_name='l_ref' type='real' python_type='float' size=None dimension='3' comment='Crystal reference orbit displacement vector in element coords.' fortran_default='0' default=0 default_factory=''
...
subroutine photon_reflect_surface_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%table)) then
    !line=222 definition='type (photon_reflect_table_struct), allocatable :: table(:)' name='table' python_name='table' type='photon_reflect_table_struct' python_type='PhotonReflectTableStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine photon_reflect_table_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%angle)) then
    !line=205 definition='real(rp), allocatable :: angle(:)' name='angle' python_name='angle' type='real' python_type='float' size=None dimension=':' comment='Vector of angle values for %p_reflect' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%bragg_angle)) then
    !line=211 definition='real(rp), allocatable :: bragg_angle(:)' name='bragg_angle' python_name='bragg_angle' type='real' python_type='float' size=None dimension=':' comment='Bragg angle at energy values.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%energy)) then
    !line=206 definition='real(rp), allocatable :: energy(:)' name='energy' python_name='energy' type='real' python_type='float' size=None dimension=':' comment='Vector of energy values for %p_reflect' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%int1)) then
    !line=207 definition='type (interval1_coef_struct), allocatable :: int1(:)' name='int1' python_name='int1' type='interval1_coef_struct' python_type='Interval1CoefStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%p_reflect)) then
    !line=208 definition='real(rp), allocatable :: p_reflect(:,:)' name='p_reflect' python_name='p_reflect' type='real' python_type='float' size=None dimension=':,:' comment='(angle, ev) probability. Log used for smooth surface reflection' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%p_reflect_scratch)) then
    !line=210 definition='real(rp), allocatable :: p_reflect_scratch(:)' name='p_reflect_scratch' python_name='p_reflect_scratch' type='real' python_type='float' size=None dimension=':' comment='Scratch space' fortran_default=None default=0.0 default_factory=''
...
subroutine photon_target_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=1053 definition='type (target_point_struct) :: corner(8) = target_point_struct()' name='corner' python_name='corner' type='target_point_struct' python_type='TargetPointStruct' size=None dimension='8' comment='' fortran_default='target_point_struct()' default=None default_factory=''
...
subroutine pixel_detec_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1027 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='dr' python_name='dr' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'dr')
  do i1 = lbound(input%dr, 1), ubound(input%dr, 1)
    call json%create_real(json_val, input%dr(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (allocated(input%pt)) then
    !line=1031 definition='type (pixel_pt_struct), allocatable :: pt(:,:)' name='pt' python_name='pt' type='pixel_pt_struct' python_type='PixelPtStruct' size=None dimension=':,:' comment='Grid of pixels' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%pt, 2), ubound(input%pt, 2)
      call json%create_array(json_list1, 'pt')
      do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
  ...
  !line=1027 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine pixel_pt_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_list1)
  !line=1022 definition='real(rp) :: init_orbit(6) = 0' name='init_orbit' python_name='init_orbit' type='real' python_type='float' size=None dimension='6' comment='Initial orbit at start of lattice statistics.' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1023 definition='real(rp) :: init_orbit_rms(6) = 0' name='init_orbit_rms' python_name='init_orbit_rms' type='real' python_type='float' size=None dimension='6' comment='Initial orbit at start of lattice RMS statistics.' fortran_default='0' default=0 default_factory=''
  ...
  !line=1020 definition='real(rp) :: orbit(6) = 0' name='orbit' python_name='orbit' type='real' python_type='float' size=None dimension='6' comment='x, Vx/c, y, Vy/c, dummy, E - E_ref.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'orbit')
  do i1 = lbound(input%orbit, 1), ubound(input%orbit, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1021 definition='real(rp) :: orbit_rms(6) = 0' name='orbit_rms' python_name='orbit_rms' type='real' python_type='float' size=None dimension='6' comment='RMS statistics.' fortran_default='0' default=0 default_factory=''
...
subroutine ptc_branch1_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%m_u_layout)) then
    !line=1504 definition='type (ptc_layout_pointer_struct), allocatable :: m_u_layout(:)' name='m_u_layout' python_name='m_u_layout' type='ptc_layout_pointer_struct' python_type='PtcLayoutPointerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine ptc_normal_form_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=1545 definition='real(rp) orb0(6)' name='orb0' python_name='orb0' type='real' python_type='float' size=None dimension='6' comment='Closed orbit at element.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'orb0')
  do i1 = lbound(input%orb0, 1), ubound(input%orb0, 1)
    call json%create_real(json_val, input%orb0(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_val)
  !line=1547 definition='type (c_taylor) phase(3)' name='phase' python_name='phase' type='c_taylor' python_type='CTaylor' size=None dimension='3' comment='Phase/chromaticity maps' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'phase')
  do i1 = lbound(input%phase, 1), ubound(input%phase, 1)
...
subroutine rad_int_all_ele_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%branch)) then
    !line=2352 definition='type (rad_int_branch_struct), allocatable :: branch(:)' name='branch' python_name='branch' type='rad_int_branch_struct' python_type='RadIntBranchStruct' size=None dimension=':' comment='Array is indexed from 0' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'branch')
    do i1 = lbound(input%branch, 1), ubound(input%branch, 1)
...
subroutine rad_int_branch_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%ele)) then
    !line=2348 definition='type (rad_int1_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='rad_int1_struct' python_type='RadInt1Struct' size=None dimension=':' comment='Array is indexed from 0' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine rad_map_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=963 definition='real(rp) :: damp_dmat(6,6) = 0' name='damp_dmat' python_name='damp_dmat' type='real' python_type='float' size=None dimension='6,6' comment='damp_correction = xfer_mat_with_damping - xfer_mat_without_damping.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=962 definition='real(rp) :: ref_orb(6) = -1' name='ref_orb' python_name='ref_orb' type='real' python_type='float' size=None dimension='6' comment='Reference point around which damp_mat is calculated.' fortran_default='-1' default=-1 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=966 definition='real(rp) :: stoc_mat(6,6) = 0' name='stoc_mat' python_name='stoc_mat' type='real' python_type='float' size=None dimension='6,6' comment='Stochastic variance or "kick" (Cholesky decomposed) matrix.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=965 definition='real(rp) :: xfer_damp_mat(6,6) = mat6_unit$' name='xfer_damp_mat' python_name='xfer_damp_mat' type='real' python_type='float' size=None dimension='6,6' comment='1st order matrix: xfer_no_damp_mat + xfer_damp_correction.' fortran_default='mat6_unit$' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=964 definition='real(rp) :: xfer_damp_vec(6) = 0' name='xfer_damp_vec' python_name='xfer_damp_vec' type='real' python_type='float' size=None dimension='6' comment='Transfer map with damping 0th order vector.' fortran_default='0' default=0 default_factory=''
...
subroutine space_charge_common_struct_to_json (input, json_root, depth)
  ...
  !line=2103 definition='integer :: csr3d_mesh_size(3) = [32, 32, 64]' name='csr3d_mesh_size' python_name='csr3d_mesh_size' type='integer' python_type='int' size=None dimension='3' comment='Gird size for CSR.' fortran_default='[32, 32, 64]' default=[32, 32, 64] default_factory=''
  ...
  !line=2102 definition='integer :: space_charge_mesh_size(3) = [32, 32, 64]' name='space_charge_mesh_size' python_name='space_charge_mesh_size' type='integer' python_type='int' size=None dimension='3' comment='Gird size for fft_3d space charge calc.' fortran_default='[32, 32, 64]' default=[32, 32, 64] default_factory=''
...
subroutine spin_axis_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=275 definition='real(rp) :: l(3) = 0' name='l' python_name='L' type='real' python_type='float' size=None dimension='3' comment='Transverse axis.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'L')
  do i1 = lbound(input%l, 1), ubound(input%l, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=277 definition='real(rp) :: m(3) = 0' name='m' python_name='m' type='real' python_type='float' size=None dimension='3' comment='Transverse axis.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'm')
  do i1 = lbound(input%m, 1), ubound(input%m, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=276 definition='real(rp) :: n0(3) = 0' name='n0' python_name='n0' type='real' python_type='float' size=None dimension='3' comment='Invariant spin axis on closed orbit.' fortran_default='0' default=0 default_factory=''
...
subroutine spin_eigen_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_list1)
  !line=270 definition='complex(rp) :: vec(8) = 0' name='vec' python_name='vec' type='complex' python_type='Complex' size=None dimension='8' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'vec')
  do i1 = lbound(input%vec, 1), ubound(input%vec, 1)
...
subroutine spin_matching_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=287 definition='real(rp) :: M_1turn(8,8) = 0' name='M_1turn' python_name='m_1turn' type='real' python_type='float' size=None dimension='8,8' comment='1-turn matrix' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=288 definition='real(rp) :: M_ele(8,8) = 0' name='M_ele' python_name='m_ele' type='real' python_type='float' size=None dimension='8,8' comment='Transfer matrix through element.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=284 definition='real(rp) :: alpha(6) = 0' name='alpha' python_name='alpha' type='real' python_type='float' size=None dimension='6' comment='Alpha vector' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_val)
  !line=285 definition='real(rp) :: beta(6) = 0' name='beta' python_name='beta' type='real' python_type='float' size=None dimension='6' comment='Beta vector' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=283 definition='real(rp) :: dn_dpz(3) = 0' name='dn_dpz' python_name='dn_dpz' type='real' python_type='float' size=None dimension='3' comment='Invariant spin derivative' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=282 definition='type (spin_eigen_struct) :: eigen(8) = spin_eigen_struct()' name='eigen' python_name='eigen' type='spin_eigen_struct' python_type='SpinEigenStruct' size=None dimension='8' comment='' fortran_default='spin_eigen_struct()' default=None default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=286 definition='real(rp) :: orb0(6) = 0' name='orb0' python_name='orb0' type='real' python_type='float' size=None dimension='6' comment='Closed orbit' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'orb0')
  do i1 = lbound(input%orb0, 1), ubound(input%orb0, 1)
    call json%create_real(json_val, input%orb0(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=289 definition='real(rp) :: sq_ele(0:3) = 0, sq_1turn(0:3) = 0' name='sq_1turn' python_name='sq_1turn' type='real' python_type='float' size=None dimension='0:3' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=289 definition='real(rp) :: sq_ele(0:3) = 0, sq_1turn(0:3) = 0' name='sq_ele' python_name='sq_ele' type='real' python_type='float' size=None dimension='0:3' comment='' fortran_default='0' default=0 default_factory=''
...
subroutine spin_orbit_map1_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=306 definition='real(rp) :: orb_mat(6,6) = 0' name='orb_mat' python_name='orb_mat' type='real' python_type='float' size=None dimension='6,6' comment='Orbital matrix' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=308 definition='real(rp) :: spin_q(0:3,0:6) = 0' name='spin_q' python_name='spin_q' type='real' python_type='float' size=None dimension='0:3,0:6' comment='0th and 1st order quaternion spin map' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%spin_q, 2), ubound(input%spin_q, 2)
    call json%create_array(json_list1, 'spin_q')
    do i1 = lbound(input%spin_q, 1), ubound(input%spin_q, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=307 definition='real(rp) :: vec0(6) = 0' name='vec0' python_name='vec0' type='real' python_type='float' size=None dimension='6' comment='Orbital 0th order map: r_out = mat6 * r_in + vec0' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'vec0')
  do i1 = lbound(input%vec0, 1), ubound(input%vec0, 1)
    call json%create_real(json_val, input%vec0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine surface_curvature_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1039 definition='real(rp) :: elliptical(3) = 0' name='elliptical' python_name='elliptical' type='real' python_type='float' size=None dimension='3' comment='Total curvature = elliptical + spherical' fortran_default='0' default=0 default_factory=''
  ...
  !line=1037 definition='real(rp) :: xy(0:6,0:6) = 0' name='xy' python_name='xy' type='real' python_type='float' size=None dimension='0:6,0:6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine surface_displacement_struct_to_json (input, json_root, depth)
  ...
  !line=1010 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='dr' python_name='dr' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'dr')
  do i1 = lbound(input%dr, 1), ubound(input%dr, 1)
    call json%create_real(json_val, input%dr(i1), '')
    call json%add(json_list1, json_val)
  ...
  nullify(json_list1)
  if (allocated(input%pt)) then
    !line=1011 definition='type (surface_displacement_pt_struct), allocatable :: pt(:,:)' name='pt' python_name='pt' type='surface_displacement_pt_struct' python_type='SurfaceDisplacementPtStruct' size=None dimension=':,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%pt, 2), ubound(input%pt, 2)
      call json%create_array(json_list1, 'pt')
      do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
  ...
  !line=1010 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine surface_h_misalign_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'active', input%active)
  !line=997 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='dr' python_name='dr' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'dr')
  do i1 = lbound(input%dr, 1), ubound(input%dr, 1)
    call json%create_real(json_val, input%dr(i1), '')
    call json%add(json_list1, json_val)
  ...
  nullify(json_list1)
  if (allocated(input%pt)) then
    !line=998 definition='type (surface_h_misalign_pt_struct), allocatable :: pt(:,:)' name='pt' python_name='pt' type='surface_h_misalign_pt_struct' python_type='SurfaceHMisalignPtStruct' size=None dimension=':,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%pt, 2), ubound(input%pt, 2)
      call json%create_array(json_list1, 'pt')
      do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
  ...
  !line=997 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine surface_segmented_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'active', input%active)
  !line=984 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='dr' python_name='dr' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'dr')
  do i1 = lbound(input%dr, 1), ubound(input%dr, 1)
    call json%create_real(json_val, input%dr(i1), '')
    call json%add(json_list1, json_val)
  ...
  nullify(json_list1)
  if (allocated(input%pt)) then
    !line=985 definition='type (surface_segmented_pt_struct), allocatable :: pt(:,:)' name='pt' python_name='pt' type='surface_segmented_pt_struct' python_type='SurfaceSegmentedPtStruct' size=None dimension=':,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%pt, 2), ubound(input%pt, 2)
      call json%create_array(json_list1, 'pt')
      do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
  ...
  !line=984 definition='real(rp) :: dr(2) = 0, r0(2) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine target_point_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1046 definition='real(rp) :: r(3) = 0' name='r' python_name='r' type='real' python_type='float' size=None dimension='3' comment='(x, y, z)' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r')
  do i1 = lbound(input%r, 1), ubound(input%r, 1)
    call json%create_real(json_val, input%r(i1), '')
    call json%add(json_list1, json_val)
...
subroutine taylor_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'ref', input%ref)
  if (associated(input%term)) then
    !line=480 definition='type (taylor_term_struct), pointer :: term(:) => null()' name='term' python_name='term' type='taylor_term_struct' python_type='TaylorTermStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'term')
    do i1 = lbound(input%term, 1), ubound(input%term, 1)
...
subroutine taylor_term_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'coef', input%coef)
  !line=466 definition='integer :: expn(6) = 0' name='expn' python_name='expn' type='integer' python_type='int' size=None dimension='6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'expn')
  do i1 = lbound(input%expn, 1), ubound(input%expn, 1)
    call json%create_integer(json_val, input%expn(i1), '')
    call json%add(json_list1, json_val)
...
subroutine track_point_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=2003 definition='real(rp) mat6(6,6)' name='mat6' python_name='mat6' type='real' python_type='float' size=None dimension='6,6' comment='1st order part of xfer map (transfer matrix).' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%mat6, 2), ubound(input%mat6, 2)
    call json%create_array(json_list1, 'mat6')
    do i1 = lbound(input%mat6, 1), ubound(input%mat6, 1)
  ...
  call json%add(json_root, json_val)
  !line=2002 definition='real(rp) vec0(6)' name='vec0' python_name='vec0' type='real' python_type='float' size=None dimension='6' comment='0th order part of xfer map from the beginning.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'vec0')
  do i1 = lbound(input%vec0, 1), ubound(input%vec0, 1)
    call json%create_real(json_val, input%vec0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine track_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'n_pt', int(input%n_pt))
  if (allocated(input%pt)) then
    !line=2009 definition='type (track_point_struct), allocatable :: pt(:)' name='pt' python_name='pt' type='track_point_struct' python_type='TrackPointStruct' size=None dimension=':' comment='Array of track points indexed from 0.' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pt')
    do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
...
subroutine wake_lr_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%mode)) then
    !line=654 definition='type (wake_lr_mode_struct), allocatable :: mode(:)' name='mode' python_name='mode' type='wake_lr_mode_struct' python_type='WakeLrModeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine wake_sr_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%long)) then
    !line=623 definition='type (wake_sr_mode_struct), allocatable :: long(:)' name='long' python_name='long' type='wake_sr_mode_struct' python_type='WakeSrModeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%trans)) then
    !line=624 definition='type (wake_sr_mode_struct), allocatable :: trans(:)' name='trans' python_name='trans' type='wake_sr_mode_struct' python_type='WakeSrModeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine wake_sr_z_long_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%fbunch)) then
    !line=597 definition='complex(rp), allocatable :: fbunch(:), w_out(:)' name='fbunch' python_name='fbunch' type='complex' python_type='Complex' size=None dimension=':' comment='Scratch space.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%fw)) then
    !line=596 definition='complex(rp), allocatable :: fw(:)' name='fw' python_name='fw' type='complex' python_type='Complex' size=None dimension=':' comment='Fourier transform of w.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%w)) then
    !line=595 definition='real(rp), allocatable :: w(:)' name='w' python_name='w' type='real' python_type='float' size=None dimension=':' comment='Input single particle Wake. Indexed from 1.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'w')
    do i1 = lbound(input%w, 1), ubound(input%w, 1)
  ...
  if (allocated(input%w_out)) then
    !line=597 definition='complex(rp), allocatable :: fbunch(:), w_out(:)' name='w_out' python_name='w_out' type='complex' python_type='Complex' size=None dimension=':' comment='Scratch space.' fortran_default=None default=0.0 default_factory=''
...
subroutine wall3d_section_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'name', trim(input%name))
  !line=436 definition='real(rp) :: p1_coef(3) = 0' name='p1_coef' python_name='p1_coef' type='real' python_type='float' size=None dimension='3' comment='Spline coefs for p0 function' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=437 definition='real(rp) :: p2_coef(3) = 0' name='p2_coef' python_name='p2_coef' type='real' python_type='float' size=None dimension='3' comment='Spline coefs for p1 function' fortran_default='0' default=0 default_factory=''
  ...
  !line=430 definition='real(rp) :: r0(2) = 0' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='2' comment='Center of section' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'r0')
  do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
    call json%create_real(json_val, input%r0(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (allocated(input%v)) then
    !line=420 definition='type (wall3d_vertex_struct), allocatable :: v(:)' name='v' python_name='v' type='wall3d_vertex_struct' python_type='Wall3dVertexStruct' size=None dimension=':' comment='Array of vertices. Always stored relative.' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'v')
    do i1 = lbound(input%v, 1), ubound(input%v, 1)
  ...
  !line=433 definition='real(rp) :: x0_coef(0:3) = 0' name='x0_coef' python_name='x0_coef' type='real' python_type='float' size=None dimension='0:3' comment='Spline coefs for x-center' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=434 definition='real(rp) :: y0_coef(0:3) = 0' name='y0_coef' python_name='y0_coef' type='real' python_type='float' size=None dimension='0:3' comment='Spline coefs for y-center' fortran_default='0' default=0 default_factory=''
...
subroutine wall3d_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%section)) then
    !line=459 definition='type (wall3d_section_struct), allocatable :: section(:)' name='section' python_name='section' type='wall3d_section_struct' python_type='Wall3dSectionStruct' size=None dimension=':' comment='Indexed from 1.' fortran_default=None default=None default_factory=''
...
subroutine wiggler_modeling_common_struct_to_json (input, json_root, depth)
  ...
  !line=29 definition='real(rp) :: len_drifts(3)' name='len_drifts' python_name='len_drifts' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine mad_map_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=24 definition='real(rp) k(6)' name='k' python_name='k' type='real' python_type='float' size=None dimension='6' comment='0th order map.' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=25 definition='real(rp) r(6,6)' name='r' python_name='r' type='real' python_type='float' size=None dimension='6,6' comment='1st order map.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%r, 2), ubound(input%r, 2)
    call json%create_array(json_list1, 'r')
    do i1 = lbound(input%r, 1), ubound(input%r, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=26 definition='real(rp) t(6,6,6)' name='t' python_name='t' type='real' python_type='float' size=None dimension='6,6,6' comment='2nd order map.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
...
subroutine rad_int_cache1_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'n_pt', int(input%n_pt))
  if (allocated(input%pt)) then
    !line=29 definition='type (rad_int_track_point_struct), allocatable :: pt(:)' name='pt' python_name='pt' type='rad_int_track_point_struct' python_type='RadIntTrackPointStruct' size=None dimension=':' comment='pt(0:n_pt)' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pt')
    do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
...
subroutine rad_int_cache_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%c_ele)) then
    !line=35 definition='type (rad_int_cache1_struct), allocatable :: c_ele(:)' name='c_ele' python_name='c_ele' type='rad_int_cache1_struct' python_type='RadIntCache1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine rad_int_info_struct_to_json (input, json_root, depth)
  ...
  !line=49 definition='real(rp) eta_a(4), eta_b(4)' name='eta_a' python_name='eta_a' type='real' python_type='float' size=None dimension='4' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=49 definition='real(rp) eta_a(4), eta_b(4)' name='eta_b' python_name='eta_b' type='real' python_type='float' size=None dimension='4' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%orbit)) then
    !line=46 definition='type (coord_struct), pointer :: orbit(:)' name='orbit' python_name='orbit' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'orbit')
    do i1 = lbound(input%orbit, 1), ubound(input%orbit, 1)
      call coord_struct_to_json(input%orbit(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine rad_int_track_point_struct_to_json (input, json_root, depth)
  ...
  !line=17 definition='real(rp) :: mat6(6,6) = 0' name='mat6' python_name='mat6' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%mat6, 2), ubound(input%mat6, 2)
    call json%create_array(json_list1, 'mat6')
    do i1 = lbound(input%mat6, 1), ubound(input%mat6, 1)
  ...
  call json%add(json_root, json_val)
  call json%add(json_root, 's_body', input%s_body)
  !line=18 definition='real(rp) :: vec0(6) = 0' name='vec0' python_name='vec0' type='real' python_type='float' size=None dimension='6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'vec0')
  do i1 = lbound(input%vec0, 1), ubound(input%vec0, 1)
    call json%create_real(json_val, input%vec0(i1), '')
    call json%add(json_list1, json_val)
...
subroutine multipass_region_branch_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%ele)) then
    !line=13 definition='type (multipass_region_ele_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='multipass_region_ele_struct' python_type='MultipassRegionEleStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine multipass_region_lat_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%branch)) then
    !line=17 definition='type (multipass_region_branch_struct), allocatable :: branch(:)' name='branch' python_name='branch' type='multipass_region_branch_struct' python_type='MultipassRegionBranchStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'branch')
    do i1 = lbound(input%branch, 1), ubound(input%branch, 1)
...
subroutine bp_common2_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%const)) then
    !line=177 definition='type (bp_const_struct), allocatable :: const(:)' name='const' python_name='const' type='bp_const_struct' python_type='BpConstStruct' size=None dimension=':' comment='Constant name' fortran_default=None default=None default_factory=''
...
subroutine bp_common_struct_to_json (input, json_root, depth)
  ...
  !line=128 definition='type (stack_file_struct) :: file(0:f_maxx) = stack_file_struct()' name='file' python_name='file' type='stack_file_struct' python_type='StackFileStruct' size=None dimension='0:f_maxx' comment='' fortran_default='stack_file_struct()' default=None default_factory=''
  ...
  if (allocated(input%lat_file_names)) then
    !line=137 definition='character(400), allocatable :: lat_file_names(:)' name='lat_file_names' python_name='lat_file_names' type='character' python_type='str' size='400' dimension=':' comment='List of all files used to create lat' fortran_default=None default='' default_factory='list'
...
subroutine parser_controller_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'name', trim(input%name))
  if (allocated(input%stack)) then
    !line=81 definition='type (expression_atom_struct), allocatable :: stack(:)' name='stack' python_name='stack' type='expression_atom_struct' python_type='ExpressionAtomStruct' size=None dimension=':' comment='Arithmetic expression stack' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'stack')
    do i1 = lbound(input%stack, 1), ubound(input%stack, 1)
      call expression_atom_struct_to_json(input%stack(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%y_knot)) then
    !line=82 definition='real(rp), allocatable :: y_knot(:)' name='y_knot' python_name='y_knot' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list1, 'y_knot')
    do i1 = lbound(input%y_knot, 1), ubound(input%y_knot, 1)
      call json%create_real(json_val, input%y_knot(i1), '')
      call json%add(json_list1, json_val)
...
subroutine parser_ele_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%control)) then
    !line=87 definition='type (parser_controller_struct), allocatable :: control(:)' name='control' python_name='control' type='parser_controller_struct' python_type='ParserControllerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'control')
    do i1 = lbound(input%control, 1), ubound(input%control, 1)
  ...
  if (allocated(input%field_overlaps)) then
    !line=88 definition='character(40), allocatable :: field_overlaps(:)' name='field_overlaps' python_name='field_overlaps' type='character' python_type='str' size='40' dimension=':' comment='' fortran_default=None default='' default_factory='list'
  ...
  if (allocated(input%names1)) then
    !line=92 definition='character(40), allocatable :: names1(:)' name='names1' python_name='names1' type='character' python_type='str' size='40' dimension=':' comment='Currently just used by feedback element.' fortran_default=None default='' default_factory='list'
  ...
  if (allocated(input%names2)) then
    !line=93 definition='character(40), allocatable :: names2(:)' name='names2' python_name='names2' type='character' python_type='str' size='40' dimension=':' comment='Currently just used by feedback element.' fortran_default=None default='' default_factory='list'
...
subroutine parser_lat_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%ele)) then
    !line=109 definition='type (parser_ele_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='parser_ele_struct' python_type='ParserEleStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine seq_ele_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%actual_arg)) then
    !line=16 definition='character(40), allocatable :: actual_arg(:)' name='actual_arg' python_name='actual_arg' type='character' python_type='str' size='40' dimension=':' comment='' fortran_default=None default='' default_factory='list'
...
subroutine seq_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%corresponding_actual_arg)) then
    !line=42 definition='character(40), allocatable :: corresponding_actual_arg(:)' name='corresponding_actual_arg' python_name='corresponding_actual_arg' type='character' python_type='str' size='40' dimension=':' comment='' fortran_default=None default='' default_factory='list'
  ...
  if (allocated(input%dummy_arg)) then
    !line=41 definition='character(40), allocatable :: dummy_arg(:)' name='dummy_arg' python_name='dummy_arg' type='character' python_type='str' size='40' dimension=':' comment='' fortran_default=None default='' default_factory='list'
  ...
  if (allocated(input%ele)) then
    !line=40 definition='type (seq_ele_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='seq_ele_struct' python_type='SeqEleStruct' size=None dimension=':' comment='Elements in the sequence' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'ele')
    do i1 = lbound(input%ele, 1), ubound(input%ele, 1)
...
subroutine photon_init_spline_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pt)) then
    !line=30 definition='type (photon_init_spline_pt_struct), allocatable :: pt(:)' name='pt' python_name='pt' type='photon_init_spline_pt_struct' python_type='PhotonInitSplinePtStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pt')
    do i1 = lbound(input%pt, 1), ubound(input%pt, 1)
...
subroutine photon_init_splines_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%energy_prob)) then
    !line=27 definition='type (spline_struct), allocatable :: energy_prob(:)' name='energy_prob' python_name='energy_prob' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%y_angle)) then
    !line=28 definition='type (photon_init_y_angle_spline_struct), allocatable :: y_angle(:)' name='y_angle' python_name='y_angle' type='photon_init_y_angle_spline_struct' python_type='PhotonInitYAngleSplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine photon_init_x_angle_spline_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pc)) then
    !line=16 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pc' python_name='pc' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%pl)) then
    !line=16 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pl' python_name='pl' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%pl45)) then
    !line=16 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pl45' python_name='pl45' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%prob)) then
    !line=16 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='prob' python_name='prob' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'prob')
    do i1 = lbound(input%prob, 1), ubound(input%prob, 1)
...
subroutine photon_init_y_angle_spline_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (allocated(input%pc)) then
    !line=20 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pc' python_name='pc' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pc')
    do i1 = lbound(input%pc, 1), ubound(input%pc, 1)
      call spline_struct_to_json(input%pc(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%pl)) then
    !line=20 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pl' python_name='pl' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pl')
    do i1 = lbound(input%pl, 1), ubound(input%pl, 1)
      call spline_struct_to_json(input%pl(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%pl45)) then
    !line=20 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='pl45' python_name='pl45' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'pl45')
    do i1 = lbound(input%pl45, 1), ubound(input%pl45, 1)
      call spline_struct_to_json(input%pl45(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%prob)) then
    !line=20 definition='type (spline_struct), allocatable :: prob(:), pl(:), pc(:), pl45(:)' name='prob' python_name='prob' type='spline_struct' python_type='SplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'prob')
    do i1 = lbound(input%prob, 1), ubound(input%prob, 1)
      call spline_struct_to_json(input%prob(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%x_angle)) then
    !line=21 definition='type (photon_init_x_angle_spline_struct), allocatable :: x_angle(:)' name='x_angle' python_name='x_angle' type='photon_init_x_angle_spline_struct' python_type='PhotonInitXAngleSplineStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine cheb_diffuse_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=21 definition='real(rp) cch_int(n_cheb_term$), cch(n_cheb_term$)' name='cch' python_name='cch' type='real' python_type='float' size=None dimension='n_cheb_term$' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=21 definition='real(rp) cch_int(n_cheb_term$), cch(n_cheb_term$)' name='cch_int' python_name='cch_int' type='real' python_type='float' size=None dimension='n_cheb_term$' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine diffuse_param_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'lambda_', input%lambda)
  call json%add(json_root, 'n_pt_spline', int(input%n_pt_spline))
  !line=16 definition='type (spline_struct) prob_spline(0:50)' name='prob_spline' python_name='prob_spline' type='spline_struct' python_type='SplineStruct' size=None dimension='0:50' comment='' fortran_default=None default=None default_factory=''
...
subroutine crystal_param_struct_to_json (input, json_root, depth)
  ...
  !line=11 definition='real(rp) old_vvec(3), new_vvec(3)' name='new_vvec' python_name='new_vvec' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=11 definition='real(rp) old_vvec(3), new_vvec(3)' name='old_vvec' python_name='old_vvec' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine ptc_rad_map_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=22 definition='real(rp) damp_mat(6,6)' name='damp_mat' python_name='damp_mat' type='real' python_type='float' size=None dimension='6,6' comment='Damping "correction" to orbital matrix.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  !line=21 definition='real(rp) nodamp_mat(6,6)' name='nodamp_mat' python_name='nodamp_mat' type='real' python_type='float' size=None dimension='6,6' comment='Nondamped orbital matrix. M_orbit = M_damp * M_nodamp' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, 'radiation_damping_on', input%radiation_damping_on)
  !line=24 definition='real(rp) ref0(6)' name='ref0' python_name='ref0' type='real' python_type='float' size=None dimension='6' comment='Reference orbit at start.' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=25 definition='real(rp) ref1(6)' name='ref1' python_name='ref1' type='real' python_type='float' size=None dimension='6' comment='Reference orbit at end.' fortran_default=None default=0.0 default_factory=''
  ...
  !line=23 definition='real(rp) stoc_mat(6,6)' name='stoc_mat' python_name='stoc_mat' type='real' python_type='float' size=None dimension='6,6' comment='Stochatic matrix for the orbit.' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%stoc_mat, 2), ubound(input%stoc_mat, 2)
    call json%create_array(json_list1, 'stoc_mat')
    do i1 = lbound(input%stoc_mat, 1), ubound(input%stoc_mat, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  ! config skip_members: ptc_rad_map_struct%sub_map (tree_element_zhe, Type tree_element in PTC)
...
subroutine csr_bunch_slice_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'charge', input%charge)
  !line=46 definition='real(rp) :: coef_lsc_minus(0:2,0:2) = 0' name='coef_lsc_minus' python_name='coef_lsc_minus' type='real' python_type='float' size=None dimension='0:2,0:2' comment='LSC Kick coefs.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=45 definition='real(rp) :: coef_lsc_plus(0:2,0:2) = 0' name='coef_lsc_plus' python_name='coef_lsc_plus' type='real' python_type='float' size=None dimension='0:2,0:2' comment='LSC Kick coefs.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine csr_kick1_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'L', input%L)
  !line=61 definition='real(rp) L_vec(3)' name='L_vec' python_name='l_vec' type='real' python_type='float' size=None dimension='3' comment='L vector in global coordinates.' fortran_default=None default=0.0 default_factory=''
...
subroutine csr_particle_position_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'charge', input%charge)
  !line=74 definition='real(rp) :: r(3)' name='r' python_name='r' type='real' python_type='float' size=None dimension='3' comment='particle position' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'r')
  do i1 = lbound(input%r, 1), ubound(input%r, 1)
    call json%create_real(json_val, input%r(i1), '')
    call json%add(json_list1, json_val)
...
subroutine csr_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%eleinfo)) then
    !line=95 definition='type (csr_ele_info_struct), allocatable :: eleinfo(:)' name='eleinfo' python_name='eleinfo' type='csr_ele_info_struct' python_type='CsrEleInfoStruct' size=None dimension=':' comment='Element-by-element information.' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%kick1)) then
    !line=94 definition='type (csr_kick1_struct), allocatable :: kick1(:)' name='kick1' python_name='kick1' type='csr_kick1_struct' python_type='CsrKick1Struct' size=None dimension=':' comment='kick1(i) referes to the kick between two slices i bins apart.' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%position)) then
    !line=98 definition='type (csr_particle_position_struct), allocatable :: position(:)' name='position' python_name='position' type='csr_particle_position_struct' python_type='CsrParticlePositionStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%slice)) then
    !line=93 definition='type (csr_bunch_slice_struct), allocatable :: slice(:)' name='slice' python_name='slice' type='csr_bunch_slice_struct' python_type='CsrBunchSliceStruct' size=None dimension=':' comment='slice(i) refers to the i^th bunch slice.' fortran_default=None default=None default_factory=''
...
subroutine mesh3d_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%bfield)) then
    !line=26 definition='real(dp), allocatable, dimension(:,:,:,:) :: bfield' name='bfield' python_name='bfield' type='real' python_type='float' size=None dimension=':,:,:,:' comment='magnetic field grid' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, 'charge', input%charge)
  !line=20 definition='real(dp) :: delta(3)' name='delta' python_name='delta' type='real' python_type='float' size=None dimension='3' comment='Grid spacing' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%efield)) then
    !line=25 definition='real(dp), allocatable, dimension(:,:,:,:) :: efield' name='efield' python_name='efield' type='real' python_type='float' size=None dimension=':,:,:,:' comment='electric field grid' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list4, 'dim-4')
  ...
  call json%add(json_root, 'gamma', input%gamma)
  !line=19 definition='real(dp) :: max(3)' name='max' python_name='max' type='real' python_type='float' size=None dimension='3' comment='Maximum in each dimension' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=18 definition='real(dp) :: min(3)' name='min' python_name='min' type='real' python_type='float' size=None dimension='3' comment='Minimim in each dimension' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=16 definition='integer :: nhi(3) = [64, 64, 64]' name='nhi' python_name='nhi' type='integer' python_type='int' size=None dimension='3' comment='Highest grid index in x, y, z (m) of rho and the quantity being computed (phi or E)' fortran_default='[64, 64, 64]' default=[64, 64, 64] default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=15 definition='integer :: nlo(3) = [ 1,  1,  1]' name='nlo' python_name='nlo' type='integer' python_type='int' size=None dimension='3' comment='Lowest  grid index in x, y, z (m) of rho and the quantity being computed (phi or E)' fortran_default='[ 1,  1,  1]' default=[1, 1, 1] default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=17 definition='integer :: npad(3) = [ 1,  1,  1]' name='npad' python_name='npad' type='integer' python_type='int' size=None dimension='3' comment='Array padding for cyclic convolution' fortran_default='[ 1,  1,  1]' default=[1, 1, 1] default_factory=''
  ...
  if (allocated(input%phi)) then
    !line=24 definition='real(dp), allocatable, dimension(:,:,:) :: phi' name='phi' python_name='phi' type='real' python_type='float' size=None dimension=':,:,:' comment='electric potential grid' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list3, 'dim-3')
  ...
  if (allocated(input%rho)) then
    !line=23 definition='real(dp), allocatable, dimension(:,:,:) :: rho' name='rho' python_name='rho' type='real' python_type='float' size=None dimension=':,:,:' comment='Charge density grid' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list3, 'dim-3')
