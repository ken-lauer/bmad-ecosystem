...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%synch_int, 1), ubound(input%synch_int, 1)
      call json%add(json_list1, '', input%synch_int(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%distribution_type, 1), ubound(input%distribution_type, 1)
      call json%add(json_list1, '', trim(input%distribution_type(i1)))
    enddo
    call json%add(json_root, json_list1)
    ...
    do i1 = lbound(input%center, 1), ubound(input%center, 1)
      call json%add(json_list1, '', input%center(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%d_orb, 1), ubound(input%d_orb, 1)
      call json%add(json_list1, '', input%d_orb(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%lat_file_names)) then
    ...
    do i1 = lbound(input%lat_file_names, 1), ubound(input%lat_file_names, 1)
      call json%add(json_list1, '', trim(input%lat_file_names(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%sigma, 2), ubound(input%sigma, 2)
      ...
      do i1 = lbound(input%sigma, 1), ubound(input%sigma, 1)
        call json%add(json_list1, '', input%sigma(i1, i2))
      enddo
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%ix_z)) then
    ...
    do i1 = lbound(input%ix_z, 1), ubound(input%ix_z, 1)
      call json%add(json_list1, '', int(input%ix_z(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
    call json%add(json_root, 'charge_tot', input%charge_tot)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    call complex_to_json(input%ref, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'ref')
    call json%add(json_root, json_val)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    call complex_to_json(input%coef, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'coef')
    call json%add(json_root, json_val)
    call json%create_array(json_list1, 'expn')
    do i1 = lbound(input%expn, 1), ubound(input%expn, 1)
      call json%add(json_list1, '', int(input%expn(i1)))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%y_knot)) then
    ...
    do i1 = lbound(input%y_knot, 1), ubound(input%y_knot, 1)
      call json%add(json_list1, '', input%y_knot(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%x_knot)) then
    ...
    do i1 = lbound(input%x_knot, 1), ubound(input%x_knot, 1)
      call json%add(json_list1, '', input%x_knot(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%poly, 1), ubound(input%poly, 1)
      call json%add(json_list1, '', input%poly(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1, json_list2
  ...
  if (allocated(input%pc_out)) then
    ...
    do i1 = lbound(input%pc_out, 1), ubound(input%pc_out, 1)
      call json%add(json_list1, '', input%pc_out(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%prob)) then
    ...
    do i2 = lbound(input%prob, 2), ubound(input%prob, 2)
      ...
      do i1 = lbound(input%prob, 1), ubound(input%prob, 1)
        call json%add(json_list1, '', input%prob(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (allocated(input%spin_z)) then
    ...
    do i2 = lbound(input%spin_z, 2), ubound(input%spin_z, 2)
      ...
      do i1 = lbound(input%spin_z, 1), ubound(input%spin_z, 1)
        call json%add(json_list1, '', input%spin_z(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (allocated(input%p_norm)) then
    ...
    do i2 = lbound(input%p_norm, 2), ubound(input%p_norm, 2)
      ...
      do i1 = lbound(input%p_norm, 1), ubound(input%p_norm, 1)
        call json%add(json_list1, '', input%p_norm(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (allocated(input%integ_pc_out)) then
    ...
    do i1 = lbound(input%integ_pc_out, 1), ubound(input%integ_pc_out, 1)
      call json%add(json_list1, '', input%integ_pc_out(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%integ_r)) then
    ...
    do i2 = lbound(input%integ_r, 2), ubound(input%integ_r, 2)
      ...
      do i1 = lbound(input%integ_r, 1), ubound(input%integ_r, 1)
        call json%add(json_list1, '', input%integ_r(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (allocated(input%integ_r_ave)) then
    ...
    do i1 = lbound(input%integ_r_ave, 1), ubound(input%integ_r_ave, 1)
      call json%add(json_list1, '', input%integ_r_ave(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%spin_in, 1), ubound(input%spin_in, 1)
      call json%add(json_list1, '', input%spin_in(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%field, 1), ubound(input%field, 1)
      call json%add(json_list1, '', input%field(i1))
    enddo
    call json%add(json_root, json_list1)
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%coef_lsc_plus, 2), ubound(input%coef_lsc_plus, 2)
      ...
      do i1 = lbound(input%coef_lsc_plus, 1), ubound(input%coef_lsc_plus, 1)
        call json%add(json_list1, '', input%coef_lsc_plus(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%coef_lsc_minus, 2), ubound(input%coef_lsc_minus, 2)
      ...
      do i1 = lbound(input%coef_lsc_minus, 1), ubound(input%coef_lsc_minus, 1)
        call json%add(json_list1, '', input%coef_lsc_minus(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
subroutine cylindrical_map_term1_struct_to_json (input, json_root, depth, max_depth)
  ...
  call json%create_object(json_root, '')
    call complex_to_json(input%e_coef, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e_coef')
    call json%add(json_root, json_val)
    call complex_to_json(input%b_coef, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'b_coef')
    call json%add(json_root, json_val)
...
type (json_value), pointer :: json_list1, json_list2, json_list3
  ...
  ! skipped: ele_struct%foil
  ! skipped: ele_struct%lord
  ...
  ! skipped: ele_struct%multipole_cache
  if (associated(input%rad_map)) then
    ...
    do i1 = lbound(input%spin_taylor_ref_orb_in, 1), ubound(input%spin_taylor_ref_orb_in, 1)
      call json%add(json_list1, '', input%spin_taylor_ref_orb_in(i1))
    enddo
    call json%add(json_root, json_list1)
  ...
  if (associated(input%grid_field)) then
    ...
    do i1 = lbound(input%old_value, 1), ubound(input%old_value, 1)
      call json%add(json_list1, '', input%old_value(i1))
    enddo
    call json%add(json_root, json_list1)
    ...
    do i2 = lbound(input%spin_q, 2), ubound(input%spin_q, 2)
      ...
      do i1 = lbound(input%spin_q, 1), ubound(input%spin_q, 1)
        call json%add(json_list1, '', input%spin_q(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i1 = lbound(input%vec0, 1), ubound(input%vec0, 1)
      call json%add(json_list1, '', input%vec0(i1))
    enddo
    call json%add(json_root, json_list1)
    ...
    do i2 = lbound(input%mat6, 2), ubound(input%mat6, 2)
      ...
      do i1 = lbound(input%mat6, 1), ubound(input%mat6, 1)
        call json%add(json_list1, '', input%mat6(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%c_mat, 2), ubound(input%c_mat, 2)
      ...
      do i1 = lbound(input%c_mat, 1), ubound(input%c_mat, 1)
        call json%add(json_list1, '', input%c_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    call json%add(json_root, json_list2)
    call json%create_array(json_list2, 'dc_mat_dpz')
    do i2 = lbound(input%dc_mat_dpz, 2), ubound(input%dc_mat_dpz, 2)
      call json%create_array(json_list1, '')
      do i1 = lbound(input%dc_mat_dpz, 1), ubound(input%dc_mat_dpz, 1)
        call json%add(json_list1, '', input%dc_mat_dpz(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (associated(input%a_pole)) then
    ...
    do i1 = lbound(input%a_pole, 1), ubound(input%a_pole, 1)
      call json%add(json_list1, '', input%a_pole(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (associated(input%b_pole)) then
    ...
    do i1 = lbound(input%b_pole, 1), ubound(input%b_pole, 1)
      call json%add(json_list1, '', input%b_pole(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (associated(input%a_pole_elec)) then
    ...
    do i1 = lbound(input%a_pole_elec, 1), ubound(input%a_pole_elec, 1)
      call json%add(json_list1, '', input%a_pole_elec(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (associated(input%b_pole_elec)) then
    ...
    do i1 = lbound(input%b_pole_elec, 1), ubound(input%b_pole_elec, 1)
      call json%add(json_list1, '', input%b_pole_elec(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (associated(input%custom)) then
    ...
    do i1 = lbound(input%custom, 1), ubound(input%custom, 1)
      call json%add(json_list1, '', input%custom(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (associated(input%r)) then
    ...
    do i3 = lbound(input%r, 3), ubound(input%r, 3)
      ...
      do i2 = lbound(input%r, 2), ubound(input%r, 2)
        call json%create_array(json_list1, '')
        do i1 = lbound(input%r, 1), ubound(input%r, 1)
          call json%add(json_list1, '', input%r(i1, i2, i3))
        enddo
        call json%add(json_list2, json_list1)
        nullify(json_list1)
      enddo
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%dE, 2), ubound(input%dE, 2)
      ...
      do i1 = lbound(input%dE, 1), ubound(input%dE, 1)
        call json%add(json_list1, '', input%dE(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%dB, 2), ubound(input%dB, 2)
      ...
      do i1 = lbound(input%dB, 1), ubound(input%dB, 1)
        call json%add(json_list1, '', input%dB(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    call json%add(json_root, 'type', int(input%type))
    call json%add(json_root, 'value', input%value)
  ! skipped: expression_tree_struct%node
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%w, 2), ubound(input%w, 2)
      ...
      do i1 = lbound(input%w, 1), ubound(input%w, 1)
        call json%add(json_list1, '', input%w(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%location)) then
    ...
    do i1 = lbound(input%location, 1), ubound(input%location, 1)
      call json%add(json_list1, '', int(input%location(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%deriv)) then
    ...
    do i2 = lbound(input%deriv, 2), ubound(input%deriv, 2)
      ...
      do i1 = lbound(input%deriv, 1), ubound(input%deriv, 1)
        call json%add(json_list1, '', input%deriv(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1, json_list2, json_list3
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%dr, 1), ubound(input%dr, 1)
      call json%add(json_list1, '', input%dr(i1))
    enddo
    call json%add(json_root, json_list1)
    call json%create_array(json_list1, 'r0')
    do i1 = lbound(input%r0, 1), ubound(input%r0, 1)
...
type (json_value), pointer :: json_list1
  ...
  ! skipped: hdf5_info_struct%data_dim
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%part_per_phi, 1), ubound(input%part_per_phi, 1)
      call json%add(json_list1, '', int(input%part_per_phi(i1)))
    enddo
    call json%add(json_root, json_list1)
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%t1_with_RF, 2), ubound(input%t1_with_RF, 2)
      ...
      do i1 = lbound(input%t1_with_RF, 1), ubound(input%t1_with_RF, 1)
        call json%add(json_list1, '', input%t1_with_RF(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%t1_no_RF, 2), ubound(input%t1_no_RF, 2)
      ...
      do i1 = lbound(input%t1_no_RF, 1), ubound(input%t1_no_RF, 1)
        call json%add(json_list1, '', input%t1_no_RF(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%print_str)) then
    ...
    do i1 = lbound(input%print_str, 1), ubound(input%print_str, 1)
      call json%add(json_list1, '', trim(input%print_str(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%ic)) then
    ...
    do i1 = lbound(input%ic, 1), ubound(input%ic, 1)
      call json%add(json_list1, '', int(input%ic(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%isf, 2), ubound(input%isf, 2)
      ...
      do i1 = lbound(input%isf, 1), ubound(input%isf, 1)
        call json%add(json_list1, '', input%isf(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i3 = lbound(input%t, 3), ubound(input%t, 3)
      ...
      do i2 = lbound(input%t, 2), ubound(input%t, 2)
        ...
        do i1 = lbound(input%t, 1), ubound(input%t, 1)
          call json%add(json_list1, '', input%t(i1, i2, i3))
        enddo
        call json%add(json_list2, json_list1)
        nullify(json_list1)
      enddo
...
subroutine mesh3d_struct_to_json (input, json_root, depth, max_depth)
  ...
  integer, optional, value :: max_depth
  integer :: i1, i2, i3, i4
type (json_value), pointer :: json_list1, json_list2, json_list3, json_list4
  if (.not. present(depth)) depth = 0
  if (present(max_depth) .and. depth >= max_depth) then
    call json%create_null(json_root, '')
    return
    ...
    do i3 = lbound(input%rho, 3), ubound(input%rho, 3)
      ...
      do i2 = lbound(input%rho, 2), ubound(input%rho, 2)
        ...
        do i1 = lbound(input%rho, 1), ubound(input%rho, 1)
          call json%add(json_list1, '', input%rho(i1, i2, i3))
        enddo
        call json%add(json_list2, json_list1)
        nullify(json_list1)
      enddo
    ...
    do i3 = lbound(input%phi, 3), ubound(input%phi, 3)
      ...
      do i2 = lbound(input%phi, 2), ubound(input%phi, 2)
        ...
        do i1 = lbound(input%phi, 1), ubound(input%phi, 1)
          call json%add(json_list1, '', input%phi(i1, i2, i3))
        enddo
        call json%add(json_list2, json_list1)
        nullify(json_list1)
      enddo
      ...
      do i3 = lbound(input%efield, 3), ubound(input%efield, 3)
        ...
        do i2 = lbound(input%efield, 2), ubound(input%efield, 2)
          ...
          do i1 = lbound(input%efield, 1), ubound(input%efield, 1)
            call json%add(json_list1, '', input%efield(i1, i2, i3, i4))
          enddo
          call json%add(json_list2, json_list1)
          nullify(json_list1)
        enddo
      ...
      do i3 = lbound(input%bfield, 3), ubound(input%bfield, 3)
        ...
        do i2 = lbound(input%bfield, 2), ubound(input%bfield, 2)
          ...
          do i1 = lbound(input%bfield, 1), ubound(input%bfield, 1)
            call json%add(json_list1, '', input%bfield(i1, i2, i3, i4))
          enddo
          call json%add(json_list2, json_list1)
          nullify(json_list1)
        enddo
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%v, 2), ubound(input%v, 2)
      ...
      do i1 = lbound(input%v, 1), ubound(input%v, 1)
        call json%add(json_list1, '', input%v(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%ix_lord)) then
    ...
    do i1 = lbound(input%ix_lord, 1), ubound(input%ix_lord, 1)
      call json%add(json_list1, '', int(input%ix_lord(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%ix_super)) then
    ...
    do i1 = lbound(input%ix_super, 1), ubound(input%ix_super, 1)
      call json%add(json_list1, '', int(input%ix_super(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%a_pole_mag)) then
    ...
    do i1 = lbound(input%a_pole_mag, 1), ubound(input%a_pole_mag, 1)
      call json%add(json_list1, '', input%a_pole_mag(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%b_pole_mag)) then
    ...
    do i1 = lbound(input%b_pole_mag, 1), ubound(input%b_pole_mag, 1)
      call json%add(json_list1, '', input%b_pole_mag(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%a_kick_mag)) then
    ...
    do i1 = lbound(input%a_kick_mag, 1), ubound(input%a_kick_mag, 1)
      call json%add(json_list1, '', input%a_kick_mag(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%b_kick_mag)) then
    ...
    do i1 = lbound(input%b_kick_mag, 1), ubound(input%b_kick_mag, 1)
      call json%add(json_list1, '', input%b_kick_mag(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%a_kick_elec)) then
    ...
    do i1 = lbound(input%a_kick_elec, 1), ubound(input%a_kick_elec, 1)
      call json%add(json_list1, '', input%a_kick_elec(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%b_kick_elec)) then
    ...
    do i1 = lbound(input%b_kick_elec, 1), ubound(input%b_kick_elec, 1)
      call json%add(json_list1, '', input%b_kick_elec(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%field_overlaps)) then
    ...
    do i1 = lbound(input%field_overlaps, 1), ubound(input%field_overlaps, 1)
      call json%add(json_list1, '', trim(input%field_overlaps(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%names1)) then
    ...
    do i1 = lbound(input%names1, 1), ubound(input%names1, 1)
      call json%add(json_list1, '', trim(input%names1(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%names2)) then
    ...
    do i1 = lbound(input%names2, 1), ubound(input%names2, 1)
      call json%add(json_list1, '', trim(input%names2(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%integrated_init_energy_prob)) then
    ...
    do i1 = lbound(input%integrated_init_energy_prob, 1), ubound(input%integrated_init_energy_prob, 1)
      call json%add(json_list1, '', input%integrated_init_energy_prob(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    call complex_to_json(input%f0_m1, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f0_m1')
    call json%add(json_root, json_val)
    call complex_to_json(input%f0_m2, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f0_m2')
    call json%add(json_root, json_val)
    call complex_to_json(input%f_0, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f_0')
    call json%add(json_root, json_val)
    call complex_to_json(input%f_h, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f_h')
    call json%add(json_root, json_val)
    call complex_to_json(input%f_hbar, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f_hbar')
    call json%add(json_root, json_val)
    call complex_to_json(input%f_hkl, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'f_hkl')
    call json%add(json_root, json_val)
    call json%create_array(json_list1, 'h_norm')
    do i1 = lbound(input%h_norm, 1), ubound(input%h_norm, 1)
      call json%add(json_list1, '', input%h_norm(i1))
    enddo
    call json%add(json_root, json_list1)
    call json%create_array(json_list1, 'l_ref')
    do i1 = lbound(input%l_ref, 1), ubound(input%l_ref, 1)
      call json%add(json_list1, '', input%l_ref(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1, json_list2
  ...
  if (allocated(input%energy)) then
    ...
    do i1 = lbound(input%energy, 1), ubound(input%energy, 1)
      call json%add(json_list1, '', input%energy(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  ...
  if (allocated(input%p_reflect)) then
    ...
    do i2 = lbound(input%p_reflect, 2), ubound(input%p_reflect, 2)
      ...
      do i1 = lbound(input%p_reflect, 1), ubound(input%p_reflect, 1)
        call json%add(json_list1, '', input%p_reflect(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  if (allocated(input%p_reflect_scratch)) then
    ...
    do i1 = lbound(input%p_reflect_scratch, 1), ubound(input%p_reflect_scratch, 1)
      call json%add(json_list1, '', input%p_reflect_scratch(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%bragg_angle)) then
    ...
    do i1 = lbound(input%bragg_angle, 1), ubound(input%bragg_angle, 1)
      call json%add(json_list1, '', input%bragg_angle(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    call complex_to_json(input%E_x, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e_x')
    call json%add(json_root, json_val)
    call complex_to_json(input%E_y, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e_y')
    call json%add(json_root, json_val)
...
type (json_value), pointer :: json_list1, json_list2
  ...
  call json%create_object(json_root, '')
  ! skipped: ptc_rad_map_struct%sub_map
    ...
    do i2 = lbound(input%nodamp_mat, 2), ubound(input%nodamp_mat, 2)
      ...
      do i1 = lbound(input%nodamp_mat, 1), ubound(input%nodamp_mat, 1)
        call json%add(json_list1, '', input%nodamp_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%damp_mat, 2), ubound(input%damp_mat, 2)
      ...
      do i1 = lbound(input%damp_mat, 1), ubound(input%damp_mat, 1)
        call json%add(json_list1, '', input%damp_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%stoc_mat, 2), ubound(input%stoc_mat, 2)
      ...
      do i1 = lbound(input%stoc_mat, 1), ubound(input%stoc_mat, 1)
        call json%add(json_list1, '', input%stoc_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
type (json_value), pointer :: json_list1, json_list2
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%ref_orb, 1), ubound(input%ref_orb, 1)
      call json%add(json_list1, '', input%ref_orb(i1))
    enddo
    call json%add(json_root, json_list1)
    ...
    do i2 = lbound(input%damp_dmat, 2), ubound(input%damp_dmat, 2)
      ...
      do i1 = lbound(input%damp_dmat, 1), ubound(input%damp_dmat, 1)
        call json%add(json_list1, '', input%damp_dmat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i1 = lbound(input%xfer_damp_vec, 1), ubound(input%xfer_damp_vec, 1)
      call json%add(json_list1, '', input%xfer_damp_vec(i1))
    enddo
    call json%add(json_root, json_list1)
    ...
    do i2 = lbound(input%xfer_damp_mat, 2), ubound(input%xfer_damp_mat, 2)
      ...
      do i1 = lbound(input%xfer_damp_mat, 1), ubound(input%xfer_damp_mat, 1)
        call json%add(json_list1, '', input%xfer_damp_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
subroutine resonance_h_struct_to_json (input, json_root, depth, max_depth)
  ...
  call json%create_object(json_root, '')
    ...
    call complex_to_json(input%c_val, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'c_val')
    call json%add(json_root, json_val)
...
subroutine rf_stair_step_struct_to_json (input, json_root, depth, max_depth)
  ...
  call json%create_object(json_root, '')
    ...
    call json%add(json_root, 'time', input%time)
    call json%add(json_root, 's0', input%s0)
    call json%add(json_root, 's', input%s)
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%actual_arg)) then
    ...
    do i1 = lbound(input%actual_arg, 1), ubound(input%actual_arg, 1)
      call json%add(json_list1, '', trim(input%actual_arg(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
    call json%add(json_root, 'tag', trim(input%tag))
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%dummy_arg)) then
    ...
    do i1 = lbound(input%dummy_arg, 1), ubound(input%dummy_arg, 1)
      call json%add(json_list1, '', trim(input%dummy_arg(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
  if (allocated(input%corresponding_actual_arg)) then
    ...
    do i1 = lbound(input%corresponding_actual_arg, 1), ubound(input%corresponding_actual_arg, 1)
      call json%add(json_list1, '', trim(input%corresponding_actual_arg(i1)))
    enddo
    call json%add(json_root, json_list1)
  endif
    call json%add(json_root, 'type', int(input%type))
...
subroutine sliced_eles_struct_to_json (input, json_root, depth, max_depth)
  ...
  call json%create_object(json_root, '')
    ...
    call json%add(json_root, json_val)
    call complex_to_json(input%ea, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'ea')
    call json%add(json_root, json_val)
    call complex_to_json(input%eb, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'eb')
    call json%add(json_root, json_val)
    call complex_to_json(input%e2a, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e2a')
    call json%add(json_root, json_val)
    call complex_to_json(input%e2b, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e2b')
    call json%add(json_root, json_val)
    call complex_to_json(input%e3a, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'e3a')
    call json%add(json_root, json_val)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    call json%create_array(json_list1, 'l')
    do i1 = lbound(input%l, 1), ubound(input%l, 1)
      call json%add(json_list1, '', input%l(i1))
    enddo
    call json%add(json_root, json_list1)
    call json%create_array(json_list1, 'n0')
    do i1 = lbound(input%n0, 1), ubound(input%n0, 1)
      call json%add(json_list1, '', input%n0(i1))
    enddo
    call json%add(json_root, json_list1)
    call json%create_array(json_list1, 'm')
    do i1 = lbound(input%m, 1), ubound(input%m, 1)
      call json%add(json_list1, '', input%m(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    enddo
    call json%add(json_root, json_list1)
    call complex_to_json(input%val, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'val')
    call json%add(json_root, json_val)
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%M_1turn, 2), ubound(input%M_1turn, 2)
      ...
      do i1 = lbound(input%M_1turn, 1), ubound(input%M_1turn, 1)
        call json%add(json_list1, '', input%M_1turn(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i2 = lbound(input%M_ele, 2), ubound(input%M_ele, 2)
      ...
      do i1 = lbound(input%M_ele, 1), ubound(input%M_ele, 1)
        call json%add(json_list1, '', input%M_ele(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%orb_mat, 2), ubound(input%orb_mat, 2)
      ...
      do i1 = lbound(input%orb_mat, 1), ubound(input%orb_mat, 1)
        call json%add(json_list1, '', input%orb_mat(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
...
subroutine summation_rdt_struct_to_json (input, json_root, depth, max_depth)
  ...
  call json%create_object(json_root, '')
    call complex_to_json(input%h11001, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h11001')
    call json%add(json_root, json_val)
    call complex_to_json(input%h00111, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h00111')
    call json%add(json_root, json_val)
    call complex_to_json(input%h20001, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h20001')
    call json%add(json_root, json_val)
    call complex_to_json(input%h00201, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h00201')
    call json%add(json_root, json_val)
    call complex_to_json(input%h10002, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h10002')
    call json%add(json_root, json_val)
    call complex_to_json(input%h21000, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h21000')
    call json%add(json_root, json_val)
    call complex_to_json(input%h30000, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h30000')
    call json%add(json_root, json_val)
    call complex_to_json(input%h10110, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h10110')
    call json%add(json_root, json_val)
    call complex_to_json(input%h10020, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h10020')
    call json%add(json_root, json_val)
    call complex_to_json(input%h10200, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h10200')
    call json%add(json_root, json_val)
    call complex_to_json(input%h31000, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h31000')
    call json%add(json_root, json_val)
    call complex_to_json(input%h40000, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h40000')
    call json%add(json_root, json_val)
    call complex_to_json(input%h20110, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h20110')
    call json%add(json_root, json_val)
    call complex_to_json(input%h11200, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h11200')
    call json%add(json_root, json_val)
    call complex_to_json(input%h20020, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h20020')
    call json%add(json_root, json_val)
    call complex_to_json(input%h20200, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h20200')
    call json%add(json_root, json_val)
    call complex_to_json(input%h00310, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h00310')
    call json%add(json_root, json_val)
    call complex_to_json(input%h00400, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h00400')
    call json%add(json_root, json_val)
    call complex_to_json(input%h22000, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h22000')
    call json%add(json_root, json_val)
    call complex_to_json(input%h00220, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h00220')
    call json%add(json_root, json_val)
    call complex_to_json(input%h11110, json_val, depth=depth + 1, max_depth=max_depth)
    call json%rename(json_val, 'h11110')
    call json%add(json_root, json_val)
  ...
  call json%create_object(json_root, '')
    ...
    do i2 = lbound(input%xy, 2), ubound(input%xy, 2)
      ...
      do i1 = lbound(input%xy, 1), ubound(input%xy, 1)
        call json%add(json_list1, '', input%xy(i1, i2))
      enddo
      call json%add(json_list2, json_list1)
      nullify(json_list1)
    enddo
    ...
    do i1 = lbound(input%elliptical, 1), ubound(input%elliptical, 1)
      call json%add(json_list1, '', input%elliptical(i1))
    enddo
    call json%add(json_root, json_list1)
...
type (json_value), pointer :: json_list1
  ...
  if (allocated(input%w)) then
    ...
    do i1 = lbound(input%w, 1), ubound(input%w, 1)
      call json%add(json_list1, '', input%w(i1))
    enddo
    call json%add(json_root, json_list1)
  endif
...
type (json_value), pointer :: json_list1
  ...
  call json%create_object(json_root, '')
    ...
    do i1 = lbound(input%len_drifts, 1), ubound(input%len_drifts, 1)
      call json%add(json_list1, '', input%len_drifts(i1))
    enddo
    call json%add(json_root, json_list1)
