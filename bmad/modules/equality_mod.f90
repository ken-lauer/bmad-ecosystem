...
interface operator (==)
  ...
  module procedure eq_aperture_param, eq_aperture_scan, eq_resonance_h, eq_spin_orbit_map1, eq_spin_axis
  module procedure eq_ptc_normal_form, eq_bmad_normal_form, eq_bunch_track, eq_summation_rdt, eq_lat_ele_order1
  module procedure eq_lat_ele_order_array, eq_lat_ele_order
end interface
