...
double SplineProxy::x0() const {
  double value;
  spline_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double SplineProxy::y0() const {
  double value;
  spline_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
double SplineProxy::x1() const {
  double value;
  spline_struct_get_x1(get_fortran_ptr_(), &value);
  return value;
}
...
double SpinPolarProxy::polarization() const {
  double value;
  spin_polar_struct_get_polarization(get_fortran_ptr_(), &value);
  return value;
}
double SpinPolarProxy::theta() const {
  double value;
  spin_polar_struct_get_theta(get_fortran_ptr_(), &value);
  return value;
}
double SpinPolarProxy::phi() const {
  double value;
  spin_polar_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double SpinPolarProxy::xi() const {
  double value;
  spin_polar_struct_get_xi(get_fortran_ptr_(), &value);
  return value;
}
double AcKickerTimeProxy::amp() const {
  double value;
  ac_kicker_time_struct_get_amp(get_fortran_ptr_(), &value);
  return value;
}
double AcKickerTimeProxy::time() const {
  double value;
  ac_kicker_time_struct_get_time(get_fortran_ptr_(), &value);
  return value;
}
SplineProxy AcKickerTimeProxy::spline() const {
  void* ptr;
  ac_kicker_time_struct_get_spline(get_fortran_ptr_(), &ptr);
  return SplineProxy(get_fortran_ptr_());
}
double AcKickerFreqProxy::f() const {
  double value;
  ac_kicker_freq_struct_get_f(get_fortran_ptr_(), &value);
  return value;
}
double AcKickerFreqProxy::amp() const {
  double value;
  ac_kicker_freq_struct_get_amp(get_fortran_ptr_(), &value);
  return value;
}
double AcKickerFreqProxy::phi() const {
  double value;
  ac_kicker_freq_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
...
double Interval1CoefProxy::c1() const {
  double value;
  interval1_coef_struct_get_c1(get_fortran_ptr_(), &value);
  return value;
}
double Interval1CoefProxy::n_exp() const {
  double value;
  interval1_coef_struct_get_n_exp(get_fortran_ptr_(), &value);
  return value;
}
...
double PhotonReflectTableProxy::max_energy() const {
  double value;
  photon_reflect_table_struct_get_max_energy(get_fortran_ptr_(), &value);
  return value;
}
...
int PhotonReflectSurfaceProxy::ix_surface() const {
  int value;
  photon_reflect_surface_struct_get_ix_surface(get_fortran_ptr_(), &value);
  return value;
}
...
double CoordProxy::s() const {
  double value;
  coord_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
long double CoordProxy::t() const {
  long double value;
  coord_struct_get_t(get_fortran_ptr_(), &value);
  return value;
}
...
double CoordProxy::charge() const {
  double value;
  coord_struct_get_charge(get_fortran_ptr_(), &value);
  return value;
}
double CoordProxy::dt_ref() const {
  double value;
  coord_struct_get_dt_ref(get_fortran_ptr_(), &value);
  return value;
}
double CoordProxy::r() const {
  double value;
  coord_struct_get_r(get_fortran_ptr_(), &value);
  return value;
}
double CoordProxy::p0c() const {
  double value;
  coord_struct_get_p0c(get_fortran_ptr_(), &value);
  return value;
}
double CoordProxy::E_potential() const {
  double value;
  coord_struct_get_E_potential(get_fortran_ptr_(), &value);
  return value;
}
double CoordProxy::beta() const {
  double value;
  coord_struct_get_beta(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::ix_ele() const {
  int value;
  coord_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::ix_branch() const {
  int value;
  coord_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::ix_turn() const {
  int value;
  coord_struct_get_ix_turn(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::ix_user() const {
  int value;
  coord_struct_get_ix_user(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::state() const {
  int value;
  coord_struct_get_state(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::direction() const {
  int value;
  coord_struct_get_direction(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::time_dir() const {
  int value;
  coord_struct_get_time_dir(get_fortran_ptr_(), &value);
  return value;
}
int CoordProxy::species() const {
  int value;
  coord_struct_get_species(get_fortran_ptr_(), &value);
  return value;
}
...
double BpmPhaseCouplingProxy::K_22a() const {
  double value;
  bpm_phase_coupling_struct_get_K_22a(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::K_12a() const {
  double value;
  bpm_phase_coupling_struct_get_K_12a(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::K_11b() const {
  double value;
  bpm_phase_coupling_struct_get_K_11b(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::K_12b() const {
  double value;
  bpm_phase_coupling_struct_get_K_12b(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::Cbar22_a() const {
  double value;
  bpm_phase_coupling_struct_get_Cbar22_a(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::Cbar12_a() const {
  double value;
  bpm_phase_coupling_struct_get_Cbar12_a(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::Cbar11_b() const {
  double value;
  bpm_phase_coupling_struct_get_Cbar11_b(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::Cbar12_b() const {
  double value;
  bpm_phase_coupling_struct_get_Cbar12_b(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::phi_a() const {
  double value;
  bpm_phase_coupling_struct_get_phi_a(get_fortran_ptr_(), &value);
  return value;
}
double BpmPhaseCouplingProxy::phi_b() const {
  double value;
  bpm_phase_coupling_struct_get_phi_b(get_fortran_ptr_(), &value);
  return value;
}
...
int ExpressionAtomProxy::type() const {
  int value;
  expression_atom_struct_get_type(get_fortran_ptr_(), &value);
  return value;
}
double ExpressionAtomProxy::value() const {
  double value;
  expression_atom_struct_get_value(get_fortran_ptr_(), &value);
  return value;
}
...
double WakeSrZLongProxy::dz() const {
  double value;
  wake_sr_z_long_struct_get_dz(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrZLongProxy::z0() const {
  double value;
  wake_sr_z_long_struct_get_z0(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrZLongProxy::smoothing_sigma() const {
  double value;
  wake_sr_z_long_struct_get_smoothing_sigma(get_fortran_ptr_(), &value);
  return value;
}
int WakeSrZLongProxy::position_dependence() const {
  int value;
  wake_sr_z_long_struct_get_position_dependence(get_fortran_ptr_(), &value);
  return value;
}
bool WakeSrZLongProxy::time_based() const {
  bool value;
  wake_sr_z_long_struct_get_time_based(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::amp() const {
  double value;
  wake_sr_mode_struct_get_amp(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::damp() const {
  double value;
  wake_sr_mode_struct_get_damp(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::k() const {
  double value;
  wake_sr_mode_struct_get_k(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::phi() const {
  double value;
  wake_sr_mode_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::b_sin() const {
  double value;
  wake_sr_mode_struct_get_b_sin(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::b_cos() const {
  double value;
  wake_sr_mode_struct_get_b_cos(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::a_sin() const {
  double value;
  wake_sr_mode_struct_get_a_sin(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrModeProxy::a_cos() const {
  double value;
  wake_sr_mode_struct_get_a_cos(get_fortran_ptr_(), &value);
  return value;
}
int WakeSrModeProxy::polarization() const {
  int value;
  wake_sr_mode_struct_get_polarization(get_fortran_ptr_(), &value);
  return value;
}
int WakeSrModeProxy::position_dependence() const {
  int value;
  wake_sr_mode_struct_get_position_dependence(get_fortran_ptr_(), &value);
  return value;
}
...
double WakeSrProxy::z_ref_trans() const {
  double value;
  wake_sr_struct_get_z_ref_trans(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrProxy::z_max() const {
  double value;
  wake_sr_struct_get_z_max(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrProxy::amp_scale() const {
  double value;
  wake_sr_struct_get_amp_scale(get_fortran_ptr_(), &value);
  return value;
}
double WakeSrProxy::z_scale() const {
  double value;
  wake_sr_struct_get_z_scale(get_fortran_ptr_(), &value);
  return value;
}
bool WakeSrProxy::scale_with_length() const {
  bool value;
  wake_sr_struct_get_scale_with_length(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::freq() const {
  double value;
  wake_lr_mode_struct_get_freq(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::freq_in() const {
  double value;
  wake_lr_mode_struct_get_freq_in(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::R_over_Q() const {
  double value;
  wake_lr_mode_struct_get_R_over_Q(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::Q() const {
  double value;
  wake_lr_mode_struct_get_Q(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::damp() const {
  double value;
  wake_lr_mode_struct_get_damp(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::phi() const {
  double value;
  wake_lr_mode_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::angle() const {
  double value;
  wake_lr_mode_struct_get_angle(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::b_sin() const {
  double value;
  wake_lr_mode_struct_get_b_sin(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::b_cos() const {
  double value;
  wake_lr_mode_struct_get_b_cos(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::a_sin() const {
  double value;
  wake_lr_mode_struct_get_a_sin(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrModeProxy::a_cos() const {
  double value;
  wake_lr_mode_struct_get_a_cos(get_fortran_ptr_(), &value);
  return value;
}
int WakeLrModeProxy::m() const {
  int value;
  wake_lr_mode_struct_get_m(get_fortran_ptr_(), &value);
  return value;
}
bool WakeLrModeProxy::polarized() const {
  bool value;
  wake_lr_mode_struct_get_polarized(get_fortran_ptr_(), &value);
  return value;
}
...
double WakeLrProxy::freq_spread() const {
  double value;
  wake_lr_struct_get_freq_spread(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrProxy::amp_scale() const {
  double value;
  wake_lr_struct_get_amp_scale(get_fortran_ptr_(), &value);
  return value;
}
double WakeLrProxy::time_scale() const {
  double value;
  wake_lr_struct_get_time_scale(get_fortran_ptr_(), &value);
  return value;
}
bool WakeLrProxy::self_wake_on() const {
  bool value;
  wake_lr_struct_get_self_wake_on(get_fortran_ptr_(), &value);
  return value;
}
int LatEleLocProxy::ix_ele() const {
  int value;
  lat_ele_loc_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int LatEleLocProxy::ix_branch() const {
  int value;
  lat_ele_loc_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
WakeSrProxy WakeProxy::sr() const {
  void* ptr;
  wake_struct_get_sr(get_fortran_ptr_(), &ptr);
  return WakeSrProxy(get_fortran_ptr_());
}
WakeLrProxy WakeProxy::lr() const {
  void* ptr;
  wake_struct_get_lr(get_fortran_ptr_(), &ptr);
  return WakeLrProxy(get_fortran_ptr_());
}
double TaylorTermProxy::coef() const {
  double value;
  taylor_term_struct_get_coef(get_fortran_ptr_(), &value);
  return value;
}
...
double CartesianMapTerm1Proxy::coef() const {
  double value;
  cartesian_map_term1_struct_get_coef(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::kx() const {
  double value;
  cartesian_map_term1_struct_get_kx(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::ky() const {
  double value;
  cartesian_map_term1_struct_get_ky(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::kz() const {
  double value;
  cartesian_map_term1_struct_get_kz(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::x0() const {
  double value;
  cartesian_map_term1_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::y0() const {
  double value;
  cartesian_map_term1_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
double CartesianMapTerm1Proxy::phi_z() const {
  double value;
  cartesian_map_term1_struct_get_phi_z(get_fortran_ptr_(), &value);
  return value;
}
int CartesianMapTerm1Proxy::family() const {
  int value;
  cartesian_map_term1_struct_get_family(get_fortran_ptr_(), &value);
  return value;
}
int CartesianMapTerm1Proxy::form() const {
  int value;
  cartesian_map_term1_struct_get_form(get_fortran_ptr_(), &value);
  return value;
}
...
int CartesianMapProxy::master_parameter() const {
  int value;
  cartesian_map_struct_get_master_parameter(get_fortran_ptr_(), &value);
  return value;
}
int CartesianMapProxy::ele_anchor_pt() const {
  int value;
  cartesian_map_struct_get_ele_anchor_pt(get_fortran_ptr_(), &value);
  return value;
}
int CartesianMapProxy::field_type() const {
  int value;
  cartesian_map_struct_get_field_type(get_fortran_ptr_(), &value);
  return value;
}
const void* CartesianMapProxy::ptr() const {
  void* ptr;
  cartesian_map_struct_get_ptr(get_fortran_ptr_(), &ptr);
  return ptr;
}
std::complex<double> CylindricalMapTerm1Proxy::e_coef() const {
  std::complex<double> c_value;
  cylindrical_map_term1_struct_get_e_coef(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> CylindricalMapTerm1Proxy::b_coef() const {
  std::complex<double> c_value;
  cylindrical_map_term1_struct_get_b_coef(get_fortran_ptr_(), &c_value);
  return c_value;
}
...
int CylindricalMapProxy::m() const {
  int value;
  cylindrical_map_struct_get_m(get_fortran_ptr_(), &value);
  return value;
}
int CylindricalMapProxy::harmonic() const {
  int value;
  cylindrical_map_struct_get_harmonic(get_fortran_ptr_(), &value);
  return value;
}
double CylindricalMapProxy::phi0_fieldmap() const {
  double value;
  cylindrical_map_struct_get_phi0_fieldmap(get_fortran_ptr_(), &value);
  return value;
}
double CylindricalMapProxy::theta0_azimuth() const {
  double value;
  cylindrical_map_struct_get_theta0_azimuth(get_fortran_ptr_(), &value);
  return value;
}
double CylindricalMapProxy::field_scale() const {
  double value;
  cylindrical_map_struct_get_field_scale(get_fortran_ptr_(), &value);
  return value;
}
int CylindricalMapProxy::master_parameter() const {
  int value;
  cylindrical_map_struct_get_master_parameter(get_fortran_ptr_(), &value);
  return value;
}
int CylindricalMapProxy::ele_anchor_pt() const {
  int value;
  cylindrical_map_struct_get_ele_anchor_pt(get_fortran_ptr_(), &value);
  return value;
}
double CylindricalMapProxy::dz() const {
  double value;
  cylindrical_map_struct_get_dz(get_fortran_ptr_(), &value);
  return value;
}
...
const void* CylindricalMapProxy::ptr() const {
  void* ptr;
  cylindrical_map_struct_get_ptr(get_fortran_ptr_(), &ptr);
  return ptr;
}
...
int GridFieldPtProxy::n_link() const {
  int value;
  grid_field_pt_struct_get_n_link(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::geometry() const {
  int value;
  grid_field_struct_get_geometry(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::harmonic() const {
  int value;
  grid_field_struct_get_harmonic(get_fortran_ptr_(), &value);
  return value;
}
double GridFieldProxy::phi0_fieldmap() const {
  double value;
  grid_field_struct_get_phi0_fieldmap(get_fortran_ptr_(), &value);
  return value;
}
double GridFieldProxy::field_scale() const {
  double value;
  grid_field_struct_get_field_scale(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::field_type() const {
  int value;
  grid_field_struct_get_field_type(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::master_parameter() const {
  int value;
  grid_field_struct_get_master_parameter(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::ele_anchor_pt() const {
  int value;
  grid_field_struct_get_ele_anchor_pt(get_fortran_ptr_(), &value);
  return value;
}
int GridFieldProxy::interpolation_order() const {
  int value;
  grid_field_struct_get_interpolation_order(get_fortran_ptr_(), &value);
  return value;
}
...
bool GridFieldProxy::curved_ref_frame() const {
  bool value;
  grid_field_struct_get_curved_ref_frame(get_fortran_ptr_(), &value);
  return value;
}
const void* GridFieldProxy::ptr() const {
  void* ptr;
  grid_field_struct_get_ptr(get_fortran_ptr_(), &ptr);
  return ptr;
}
...
double FloorPositionProxy::theta() const {
  double value;
  floor_position_struct_get_theta(get_fortran_ptr_(), &value);
  return value;
}
double FloorPositionProxy::phi() const {
  double value;
  floor_position_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double FloorPositionProxy::psi() const {
  double value;
  floor_position_struct_get_psi(get_fortran_ptr_(), &value);
  return value;
}
CoordProxy HighEnergySpaceChargeProxy::closed_orb() const {
  void* ptr;
  high_energy_space_charge_struct_get_closed_orb(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
double HighEnergySpaceChargeProxy::kick_const() const {
  double value;
  high_energy_space_charge_struct_get_kick_const(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::sig_x() const {
  double value;
  high_energy_space_charge_struct_get_sig_x(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::sig_y() const {
  double value;
  high_energy_space_charge_struct_get_sig_y(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::phi() const {
  double value;
  high_energy_space_charge_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::sin_phi() const {
  double value;
  high_energy_space_charge_struct_get_sin_phi(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::cos_phi() const {
  double value;
  high_energy_space_charge_struct_get_cos_phi(get_fortran_ptr_(), &value);
  return value;
}
double HighEnergySpaceChargeProxy::sig_z() const {
  double value;
  high_energy_space_charge_struct_get_sig_z(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::eta() const {
  double value;
  xy_disp_struct_get_eta(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::etap() const {
  double value;
  xy_disp_struct_get_etap(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::deta_ds() const {
  double value;
  xy_disp_struct_get_deta_ds(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::sigma() const {
  double value;
  xy_disp_struct_get_sigma(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::deta_dpz() const {
  double value;
  xy_disp_struct_get_deta_dpz(get_fortran_ptr_(), &value);
  return value;
}
double XyDispProxy::detap_dpz() const {
  double value;
  xy_disp_struct_get_detap_dpz(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::beta() const {
  double value;
  twiss_struct_get_beta(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::alpha() const {
  double value;
  twiss_struct_get_alpha(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::gamma() const {
  double value;
  twiss_struct_get_gamma(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::phi() const {
  double value;
  twiss_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::eta() const {
  double value;
  twiss_struct_get_eta(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::etap() const {
  double value;
  twiss_struct_get_etap(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::deta_ds() const {
  double value;
  twiss_struct_get_deta_ds(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::sigma() const {
  double value;
  twiss_struct_get_sigma(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::sigma_p() const {
  double value;
  twiss_struct_get_sigma_p(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::emit() const {
  double value;
  twiss_struct_get_emit(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::norm_emit() const {
  double value;
  twiss_struct_get_norm_emit(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::chrom() const {
  double value;
  twiss_struct_get_chrom(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::dbeta_dpz() const {
  double value;
  twiss_struct_get_dbeta_dpz(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::dalpha_dpz() const {
  double value;
  twiss_struct_get_dalpha_dpz(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::deta_dpz() const {
  double value;
  twiss_struct_get_deta_dpz(get_fortran_ptr_(), &value);
  return value;
}
double TwissProxy::detap_dpz() const {
  double value;
  twiss_struct_get_detap_dpz(get_fortran_ptr_(), &value);
  return value;
}
TwissProxy Mode3Proxy::a() const {
  void* ptr;
  mode3_struct_get_a(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy Mode3Proxy::b() const {
  void* ptr;
  mode3_struct_get_b(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy Mode3Proxy::c() const {
  void* ptr;
  mode3_struct_get_c(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy Mode3Proxy::x() const {
  void* ptr;
  mode3_struct_get_x(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy Mode3Proxy::y() const {
  void* ptr;
  mode3_struct_get_y(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
int BookkeepingStateProxy::attributes() const {
  int value;
  bookkeeping_state_struct_get_attributes(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::control() const {
  int value;
  bookkeeping_state_struct_get_control(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::floor_position() const {
  int value;
  bookkeeping_state_struct_get_floor_position(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::s_position() const {
  int value;
  bookkeeping_state_struct_get_s_position(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::ref_energy() const {
  int value;
  bookkeeping_state_struct_get_ref_energy(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::mat6() const {
  int value;
  bookkeeping_state_struct_get_mat6(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::rad_int() const {
  int value;
  bookkeeping_state_struct_get_rad_int(get_fortran_ptr_(), &value);
  return value;
}
int BookkeepingStateProxy::ptc() const {
  int value;
  bookkeeping_state_struct_get_ptc(get_fortran_ptr_(), &value);
  return value;
}
bool BookkeepingStateProxy::has_misalign() const {
  bool value;
  bookkeeping_state_struct_get_has_misalign(get_fortran_ptr_(), &value);
  return value;
}
...
RadMapProxy RadMapEleProxy::rm0() const {
  void* ptr;
  rad_map_ele_struct_get_rm0(get_fortran_ptr_(), &ptr);
  return RadMapProxy(get_fortran_ptr_());
}
RadMapProxy RadMapEleProxy::rm1() const {
  void* ptr;
  rad_map_ele_struct_get_rm1(get_fortran_ptr_(), &ptr);
  return RadMapProxy(get_fortran_ptr_());
}
bool RadMapEleProxy::stale() const {
  bool value;
  rad_map_ele_struct_get_stale(get_fortran_ptr_(), &value);
  return value;
}
int GenGrad1Proxy::m() const {
  int value;
  gen_grad1_struct_get_m(get_fortran_ptr_(), &value);
  return value;
}
int GenGrad1Proxy::sincos() const {
  int value;
  gen_grad1_struct_get_sincos(get_fortran_ptr_(), &value);
  return value;
}
int GenGrad1Proxy::n_deriv_max() const {
  int value;
  gen_grad1_struct_get_n_deriv_max(get_fortran_ptr_(), &value);
  return value;
}
...
int GenGradMapProxy::field_type() const {
  int value;
  gen_grad_map_struct_get_field_type(get_fortran_ptr_(), &value);
  return value;
}
int GenGradMapProxy::iz0() const {
  int value;
  gen_grad_map_struct_get_iz0(get_fortran_ptr_(), &value);
  return value;
}
int GenGradMapProxy::iz1() const {
  int value;
  gen_grad_map_struct_get_iz1(get_fortran_ptr_(), &value);
  return value;
}
double GenGradMapProxy::dz() const {
  double value;
  gen_grad_map_struct_get_dz(get_fortran_ptr_(), &value);
  return value;
}
...
double GenGradMapProxy::field_scale() const {
  double value;
  gen_grad_map_struct_get_field_scale(get_fortran_ptr_(), &value);
  return value;
}
int GenGradMapProxy::master_parameter() const {
  int value;
  gen_grad_map_struct_get_master_parameter(get_fortran_ptr_(), &value);
  return value;
}
bool GenGradMapProxy::curved_ref_frame() const {
  bool value;
  gen_grad_map_struct_get_curved_ref_frame(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceSegmentedPtProxy::x0() const {
  double value;
  surface_segmented_pt_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceSegmentedPtProxy::y0() const {
  double value;
  surface_segmented_pt_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceSegmentedPtProxy::z0() const {
  double value;
  surface_segmented_pt_struct_get_z0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceSegmentedPtProxy::dz_dx() const {
  double value;
  surface_segmented_pt_struct_get_dz_dx(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceSegmentedPtProxy::dz_dy() const {
  double value;
  surface_segmented_pt_struct_get_dz_dy(get_fortran_ptr_(), &value);
  return value;
}
bool SurfaceSegmentedProxy::active() const {
  bool value;
  surface_segmented_struct_get_active(get_fortran_ptr_(), &value);
  return value;
}
...
double SurfaceHMisalignPtProxy::x0() const {
  double value;
  surface_h_misalign_pt_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceHMisalignPtProxy::y0() const {
  double value;
  surface_h_misalign_pt_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceHMisalignPtProxy::rot_y() const {
  double value;
  surface_h_misalign_pt_struct_get_rot_y(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceHMisalignPtProxy::rot_t() const {
  double value;
  surface_h_misalign_pt_struct_get_rot_t(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceHMisalignPtProxy::rot_y_rms() const {
  double value;
  surface_h_misalign_pt_struct_get_rot_y_rms(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceHMisalignPtProxy::rot_t_rms() const {
  double value;
  surface_h_misalign_pt_struct_get_rot_t_rms(get_fortran_ptr_(), &value);
  return value;
}
bool SurfaceHMisalignProxy::active() const {
  bool value;
  surface_h_misalign_struct_get_active(get_fortran_ptr_(), &value);
  return value;
}
...
double SurfaceDisplacementPtProxy::x0() const {
  double value;
  surface_displacement_pt_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceDisplacementPtProxy::y0() const {
  double value;
  surface_displacement_pt_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceDisplacementPtProxy::z0() const {
  double value;
  surface_displacement_pt_struct_get_z0(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceDisplacementPtProxy::dz_dx() const {
  double value;
  surface_displacement_pt_struct_get_dz_dx(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceDisplacementPtProxy::dz_dy() const {
  double value;
  surface_displacement_pt_struct_get_dz_dy(get_fortran_ptr_(), &value);
  return value;
}
double SurfaceDisplacementPtProxy::d2z_dxdy() const {
  double value;
  surface_displacement_pt_struct_get_d2z_dxdy(get_fortran_ptr_(), &value);
  return value;
}
bool SurfaceDisplacementProxy::active() const {
  bool value;
  surface_displacement_struct_get_active(get_fortran_ptr_(), &value);
  return value;
}
...
double SurfaceCurvatureProxy::spherical() const {
  double value;
  surface_curvature_struct_get_spherical(get_fortran_ptr_(), &value);
  return value;
}
...
bool SurfaceCurvatureProxy::has_curvature() const {
  bool value;
  surface_curvature_struct_get_has_curvature(get_fortran_ptr_(), &value);
  return value;
}
int PhotonTargetProxy::type() const {
  int value;
  photon_target_struct_get_type(get_fortran_ptr_(), &value);
  return value;
}
int PhotonTargetProxy::n_corner() const {
  int value;
  photon_target_struct_get_n_corner(get_fortran_ptr_(), &value);
  return value;
}
...
TargetPointProxy PhotonTargetProxy::center() const {
  ...
  return TargetPointProxy(get_fortran_ptr_());
}
std::complex<double> PhotonMaterialProxy::f0_m1() const {
  std::complex<double> c_value;
  photon_material_struct_get_f0_m1(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PhotonMaterialProxy::f0_m2() const {
  std::complex<double> c_value;
  photon_material_struct_get_f0_m2(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PhotonMaterialProxy::f_0() const {
  std::complex<double> c_value;
  photon_material_struct_get_f_0(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PhotonMaterialProxy::f_h() const {
  std::complex<double> c_value;
  photon_material_struct_get_f_h(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PhotonMaterialProxy::f_hbar() const {
  std::complex<double> c_value;
  photon_material_struct_get_f_hbar(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PhotonMaterialProxy::f_hkl() const {
  std::complex<double> c_value;
  photon_material_struct_get_f_hkl(get_fortran_ptr_(), &c_value);
  return c_value;
}
...
long long PixelPtProxy::n_photon() const {
  long long value;
  pixel_pt_struct_get_n_photon(get_fortran_ptr_(), &value);
  return value;
}
std::complex<double> PixelPtProxy::E_x() const {
  std::complex<double> c_value;
  pixel_pt_struct_get_E_x(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> PixelPtProxy::E_y() const {
  std::complex<double> c_value;
  pixel_pt_struct_get_E_y(get_fortran_ptr_(), &c_value);
  return c_value;
}
double PixelPtProxy::intensity_x() const {
  double value;
  pixel_pt_struct_get_intensity_x(get_fortran_ptr_(), &value);
  return value;
}
double PixelPtProxy::intensity_y() const {
  double value;
  pixel_pt_struct_get_intensity_y(get_fortran_ptr_(), &value);
  return value;
}
double PixelPtProxy::intensity() const {
  double value;
  pixel_pt_struct_get_intensity(get_fortran_ptr_(), &value);
  return value;
}
...
long long PixelDetecProxy::n_track_tot() const {
  long long value;
  pixel_detec_struct_get_n_track_tot(get_fortran_ptr_(), &value);
  return value;
}
long long PixelDetecProxy::n_hit_detec() const {
  long long value;
  pixel_detec_struct_get_n_hit_detec(get_fortran_ptr_(), &value);
  return value;
}
long long PixelDetecProxy::n_hit_pixel() const {
  long long value;
  pixel_detec_struct_get_n_hit_pixel(get_fortran_ptr_(), &value);
  return value;
}
SurfaceCurvatureProxy PhotonElementProxy::curvature() const {
  void* ptr;
  photon_element_struct_get_curvature(get_fortran_ptr_(), &ptr);
  return SurfaceCurvatureProxy(get_fortran_ptr_());
}
PhotonTargetProxy PhotonElementProxy::target() const {
  void* ptr;
  photon_element_struct_get_target(get_fortran_ptr_(), &ptr);
  return PhotonTargetProxy(get_fortran_ptr_());
}
PhotonMaterialProxy PhotonElementProxy::material() const {
  void* ptr;
  photon_element_struct_get_material(get_fortran_ptr_(), &ptr);
  return PhotonMaterialProxy(get_fortran_ptr_());
}
SurfaceSegmentedProxy PhotonElementProxy::segmented() const {
  void* ptr;
  photon_element_struct_get_segmented(get_fortran_ptr_(), &ptr);
  return SurfaceSegmentedProxy(get_fortran_ptr_());
}
SurfaceHMisalignProxy PhotonElementProxy::h_misalign() const {
  void* ptr;
  photon_element_struct_get_h_misalign(get_fortran_ptr_(), &ptr);
  return SurfaceHMisalignProxy(get_fortran_ptr_());
}
SurfaceDisplacementProxy PhotonElementProxy::displacement() const {
  void* ptr;
  photon_element_struct_get_displacement(get_fortran_ptr_(), &ptr);
  return SurfaceDisplacementProxy(get_fortran_ptr_());
}
PixelDetecProxy PhotonElementProxy::pixel() const {
  void* ptr;
  photon_element_struct_get_pixel(get_fortran_ptr_(), &ptr);
  return PixelDetecProxy(get_fortran_ptr_());
}
int PhotonElementProxy::reflectivity_table_type() const {
  int value;
  photon_element_struct_get_reflectivity_table_type(get_fortran_ptr_(), &value);
  return value;
}
PhotonReflectTableProxy PhotonElementProxy::reflectivity_table_sigma() const {
  void* ptr;
  photon_element_struct_get_reflectivity_table_sigma(get_fortran_ptr_(), &ptr);
...
double Wall3dVertexProxy::x() const {
  double value;
  wall3d_vertex_struct_get_x(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::y() const {
  double value;
  wall3d_vertex_struct_get_y(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::radius_x() const {
  double value;
  wall3d_vertex_struct_get_radius_x(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::radius_y() const {
  double value;
  wall3d_vertex_struct_get_radius_y(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::tilt() const {
  double value;
  wall3d_vertex_struct_get_tilt(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::angle() const {
  double value;
  wall3d_vertex_struct_get_angle(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::x0() const {
  double value;
  wall3d_vertex_struct_get_x0(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dVertexProxy::y0() const {
  double value;
  wall3d_vertex_struct_get_y0(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dVertexProxy::type() const {
  int value;
  wall3d_vertex_struct_get_type(get_fortran_ptr_(), &value);
  return value;
}
...
const void* Wall3dSectionProxy::surface() const {
  void* ptr;
  wall3d_section_struct_get_surface(get_fortran_ptr_(), &ptr);
  return ptr;
}
int Wall3dSectionProxy::type() const {
  int value;
  wall3d_section_struct_get_type(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dSectionProxy::n_vertex_input() const {
  int value;
  wall3d_section_struct_get_n_vertex_input(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dSectionProxy::ix_ele() const {
  int value;
  wall3d_section_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dSectionProxy::ix_branch() const {
  int value;
  wall3d_section_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dSectionProxy::vertices_state() const {
  int value;
  wall3d_section_struct_get_vertices_state(get_fortran_ptr_(), &value);
  return value;
}
bool Wall3dSectionProxy::patch_in_region() const {
  bool value;
  wall3d_section_struct_get_patch_in_region(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dSectionProxy::thickness() const {
  double value;
  wall3d_section_struct_get_thickness(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dSectionProxy::s() const {
  double value;
  wall3d_section_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
...
double Wall3dSectionProxy::dx0_ds() const {
  double value;
  wall3d_section_struct_get_dx0_ds(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dSectionProxy::dy0_ds() const {
  double value;
  wall3d_section_struct_get_dy0_ds(get_fortran_ptr_(), &value);
  return value;
}
...
double Wall3dSectionProxy::dr_ds() const {
  double value;
  wall3d_section_struct_get_dr_ds(get_fortran_ptr_(), &value);
  return value;
}
...
int Wall3dProxy::type() const {
  int value;
  wall3d_struct_get_type(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dProxy::ix_wall3d() const {
  int value;
  wall3d_struct_get_ix_wall3d(get_fortran_ptr_(), &value);
  return value;
}
int Wall3dProxy::n_link() const {
  int value;
  wall3d_struct_get_n_link(get_fortran_ptr_(), &value);
  return value;
}
double Wall3dProxy::thickness() const {
  double value;
  wall3d_struct_get_thickness(get_fortran_ptr_(), &value);
  return value;
}
...
bool Wall3dProxy::superimpose() const {
  bool value;
  wall3d_struct_get_superimpose(get_fortran_ptr_(), &value);
  return value;
}
...
int RamperLordProxy::ix_con() const {
  int value;
  ramper_lord_struct_get_ix_con(get_fortran_ptr_(), &value);
  return value;
}
double* RamperLordProxy::attrib_ptr() const {
  double* ptr;
  ramper_lord_struct_get_attrib_ptr(get_fortran_ptr_(), &ptr);
  return ptr;
}
double ControlProxy::value() const {
  double value;
  control_struct_get_value(get_fortran_ptr_(), &value);
  return value;
}
...
LatEleLocProxy ControlProxy::slave() const {
  void* ptr;
  control_struct_get_slave(get_fortran_ptr_(), &ptr);
  return LatEleLocProxy(get_fortran_ptr_());
}
LatEleLocProxy ControlProxy::lord() const {
  void* ptr;
  control_struct_get_lord(get_fortran_ptr_(), &ptr);
  return LatEleLocProxy(get_fortran_ptr_());
}
...
int ControlProxy::ix_attrib() const {
  int value;
  control_struct_get_ix_attrib(get_fortran_ptr_(), &value);
  return value;
}
...
double ControlVar1Proxy::value() const {
  double value;
  control_var1_struct_get_value(get_fortran_ptr_(), &value);
  return value;
}
double ControlVar1Proxy::old_value() const {
  double value;
  control_var1_struct_get_old_value(get_fortran_ptr_(), &value);
  return value;
}
...
int EllipseBeamInitProxy::part_per_ellipse() const {
  int value;
  ellipse_beam_init_struct_get_part_per_ellipse(get_fortran_ptr_(), &value);
  return value;
}
int EllipseBeamInitProxy::n_ellipse() const {
  int value;
  ellipse_beam_init_struct_get_n_ellipse(get_fortran_ptr_(), &value);
  return value;
}
double EllipseBeamInitProxy::sigma_cutoff() const {
  double value;
  ellipse_beam_init_struct_get_sigma_cutoff(get_fortran_ptr_(), &value);
  return value;
}
...
int KvBeamInitProxy::n_I2() const {
  int value;
  kv_beam_init_struct_get_n_I2(get_fortran_ptr_(), &value);
  return value;
}
double KvBeamInitProxy::A() const {
  double value;
  kv_beam_init_struct_get_A(get_fortran_ptr_(), &value);
  return value;
}
int GridBeamInitProxy::n_x() const {
  int value;
  grid_beam_init_struct_get_n_x(get_fortran_ptr_(), &value);
  return value;
}
int GridBeamInitProxy::n_px() const {
  int value;
  grid_beam_init_struct_get_n_px(get_fortran_ptr_(), &value);
  return value;
}
double GridBeamInitProxy::x_min() const {
  double value;
  grid_beam_init_struct_get_x_min(get_fortran_ptr_(), &value);
  return value;
}
double GridBeamInitProxy::x_max() const {
  double value;
  grid_beam_init_struct_get_x_max(get_fortran_ptr_(), &value);
  return value;
}
double GridBeamInitProxy::px_min() const {
  double value;
  grid_beam_init_struct_get_px_min(get_fortran_ptr_(), &value);
  return value;
}
double GridBeamInitProxy::px_max() const {
  double value;
  grid_beam_init_struct_get_px_max(get_fortran_ptr_(), &value);
  return value;
}
...
double BeamInitProxy::sig_z_jitter() const {
  double value;
  beam_init_struct_get_sig_z_jitter(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::sig_pz_jitter() const {
  double value;
  beam_init_struct_get_sig_pz_jitter(get_fortran_ptr_(), &value);
  return value;
}
int BeamInitProxy::n_particle() const {
  int value;
  beam_init_struct_get_n_particle(get_fortran_ptr_(), &value);
  return value;
}
bool BeamInitProxy::renorm_center() const {
  bool value;
  beam_init_struct_get_renorm_center(get_fortran_ptr_(), &value);
  return value;
}
bool BeamInitProxy::renorm_sigma() const {
  bool value;
  beam_init_struct_get_renorm_sigma(get_fortran_ptr_(), &value);
  return value;
}
...
double BeamInitProxy::random_sigma_cutoff() const {
  double value;
  beam_init_struct_get_random_sigma_cutoff(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::a_norm_emit() const {
  double value;
  beam_init_struct_get_a_norm_emit(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::b_norm_emit() const {
  double value;
  beam_init_struct_get_b_norm_emit(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::a_emit() const {
  double value;
  beam_init_struct_get_a_emit(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::b_emit() const {
  double value;
  beam_init_struct_get_b_emit(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::dPz_dz() const {
  double value;
  beam_init_struct_get_dPz_dz(get_fortran_ptr_(), &value);
  return value;
}
...
double BeamInitProxy::t_offset() const {
  double value;
  beam_init_struct_get_t_offset(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::dt_bunch() const {
  double value;
  beam_init_struct_get_dt_bunch(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::sig_z() const {
  double value;
  beam_init_struct_get_sig_z(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::sig_pz() const {
  double value;
  beam_init_struct_get_sig_pz(get_fortran_ptr_(), &value);
  return value;
}
double BeamInitProxy::bunch_charge() const {
  double value;
  beam_init_struct_get_bunch_charge(get_fortran_ptr_(), &value);
  return value;
}
int BeamInitProxy::n_bunch() const {
  int value;
  beam_init_struct_get_n_bunch(get_fortran_ptr_(), &value);
  return value;
}
int BeamInitProxy::ix_turn() const {
  int value;
  beam_init_struct_get_ix_turn(get_fortran_ptr_(), &value);
  return value;
}
...
bool BeamInitProxy::full_6D_coupling_calc() const {
  bool value;
  beam_init_struct_get_full_6D_coupling_calc(get_fortran_ptr_(), &value);
  return value;
}
bool BeamInitProxy::use_particle_start() const {
  bool value;
  beam_init_struct_get_use_particle_start(get_fortran_ptr_(), &value);
  return value;
}
bool BeamInitProxy::use_t_coords() const {
  bool value;
  beam_init_struct_get_use_t_coords(get_fortran_ptr_(), &value);
  return value;
}
bool BeamInitProxy::use_z_as_t() const {
  bool value;
  beam_init_struct_get_use_z_as_t(get_fortran_ptr_(), &value);
  return value;
}
...
double LatParamProxy::n_part() const {
  double value;
  lat_param_struct_get_n_part(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::total_length() const {
  double value;
  lat_param_struct_get_total_length(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::unstable_factor() const {
  double value;
  lat_param_struct_get_unstable_factor(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::spin_tune() const {
  double value;
  lat_param_struct_get_spin_tune(get_fortran_ptr_(), &value);
  return value;
}
int LatParamProxy::particle() const {
  int value;
  lat_param_struct_get_particle(get_fortran_ptr_(), &value);
  return value;
}
int LatParamProxy::default_tracking_species() const {
  int value;
  lat_param_struct_get_default_tracking_species(get_fortran_ptr_(), &value);
  return value;
}
int LatParamProxy::geometry() const {
  int value;
  lat_param_struct_get_geometry(get_fortran_ptr_(), &value);
  return value;
}
int LatParamProxy::ixx() const {
  int value;
  lat_param_struct_get_ixx(get_fortran_ptr_(), &value);
  return value;
}
bool LatParamProxy::stable() const {
  bool value;
  lat_param_struct_get_stable(get_fortran_ptr_(), &value);
  return value;
}
bool LatParamProxy::live_branch() const {
  bool value;
  lat_param_struct_get_live_branch(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::g1_integral() const {
  double value;
  lat_param_struct_get_g1_integral(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::g2_integral() const {
  double value;
  lat_param_struct_get_g2_integral(get_fortran_ptr_(), &value);
  return value;
}
double LatParamProxy::g3_integral() const {
  double value;
  lat_param_struct_get_g3_integral(get_fortran_ptr_(), &value);
  return value;
}
BookkeepingStateProxy LatParamProxy::bookkeeping_state() const {
  void* ptr;
  lat_param_struct_get_bookkeeping_state(get_fortran_ptr_(), &ptr);
  return BookkeepingStateProxy(get_fortran_ptr_());
}
BeamInitProxy LatParamProxy::beam_init() const {
  void* ptr;
  lat_param_struct_get_beam_init(get_fortran_ptr_(), &ptr);
  return BeamInitProxy(get_fortran_ptr_());
}
bool ModeInfoProxy::stable() const {
  bool value;
  mode_info_struct_get_stable(get_fortran_ptr_(), &value);
  return value;
}
double ModeInfoProxy::tune() const {
  double value;
  mode_info_struct_get_tune(get_fortran_ptr_(), &value);
  return value;
}
double ModeInfoProxy::emit() const {
  double value;
  mode_info_struct_get_emit(get_fortran_ptr_(), &value);
  return value;
}
double ModeInfoProxy::chrom() const {
  double value;
  mode_info_struct_get_chrom(get_fortran_ptr_(), &value);
  return value;
}
double ModeInfoProxy::sigma() const {
  double value;
  mode_info_struct_get_sigma(get_fortran_ptr_(), &value);
  return value;
}
double ModeInfoProxy::sigmap() const {
  double value;
  mode_info_struct_get_sigmap(get_fortran_ptr_(), &value);
  return value;
}
int PreTrackerProxy::who() const {
  int value;
  pre_tracker_struct_get_who(get_fortran_ptr_(), &value);
  return value;
}
int PreTrackerProxy::ix_ele_start() const {
  int value;
  pre_tracker_struct_get_ix_ele_start(get_fortran_ptr_(), &value);
  return value;
}
int PreTrackerProxy::ix_ele_end() const {
  int value;
  pre_tracker_struct_get_ix_ele_end(get_fortran_ptr_(), &value);
  return value;
}
...
double AnormalModeProxy::emittance() const {
  double value;
  anormal_mode_struct_get_emittance(get_fortran_ptr_(), &value);
  return value;
}
double AnormalModeProxy::emittance_no_vert() const {
  double value;
  anormal_mode_struct_get_emittance_no_vert(get_fortran_ptr_(), &value);
  return value;
}
...
double AnormalModeProxy::j_damp() const {
  double value;
  anormal_mode_struct_get_j_damp(get_fortran_ptr_(), &value);
  return value;
}
double AnormalModeProxy::alpha_damp() const {
  double value;
  anormal_mode_struct_get_alpha_damp(get_fortran_ptr_(), &value);
  return value;
}
double AnormalModeProxy::chrom() const {
  double value;
  anormal_mode_struct_get_chrom(get_fortran_ptr_(), &value);
  return value;
}
double AnormalModeProxy::tune() const {
  double value;
  anormal_mode_struct_get_tune(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::i2_E4() const {
  double value;
  linac_normal_mode_struct_get_i2_E4(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::i3_E7() const {
  double value;
  linac_normal_mode_struct_get_i3_E7(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::i5a_E6() const {
  double value;
  linac_normal_mode_struct_get_i5a_E6(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::i5b_E6() const {
  double value;
  linac_normal_mode_struct_get_i5b_E6(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::sig_E1() const {
  double value;
  linac_normal_mode_struct_get_sig_E1(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::a_emittance_end() const {
  double value;
  linac_normal_mode_struct_get_a_emittance_end(get_fortran_ptr_(), &value);
  return value;
}
double LinacNormalModeProxy::b_emittance_end() const {
  double value;
  linac_normal_mode_struct_get_b_emittance_end(get_fortran_ptr_(), &value);
  return value;
}
...
double NormalModesProxy::sigE_E() const {
  double value;
  normal_modes_struct_get_sigE_E(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::sig_z() const {
  double value;
  normal_modes_struct_get_sig_z(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::e_loss() const {
  double value;
  normal_modes_struct_get_e_loss(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::rf_voltage() const {
  double value;
  normal_modes_struct_get_rf_voltage(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::pz_aperture() const {
  double value;
  normal_modes_struct_get_pz_aperture(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::pz_average() const {
  double value;
  normal_modes_struct_get_pz_average(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::momentum_compaction() const {
  double value;
  normal_modes_struct_get_momentum_compaction(get_fortran_ptr_(), &value);
  return value;
}
double NormalModesProxy::dpz_damp() const {
  double value;
  normal_modes_struct_get_dpz_damp(get_fortran_ptr_(), &value);
  return value;
}
AnormalModeProxy NormalModesProxy::a() const {
  void* ptr;
  normal_modes_struct_get_a(get_fortran_ptr_(), &ptr);
  return AnormalModeProxy(get_fortran_ptr_());
}
AnormalModeProxy NormalModesProxy::b() const {
  void* ptr;
  normal_modes_struct_get_b(get_fortran_ptr_(), &ptr);
  return AnormalModeProxy(get_fortran_ptr_());
}
AnormalModeProxy NormalModesProxy::z() const {
  void* ptr;
  normal_modes_struct_get_z(get_fortran_ptr_(), &ptr);
  return AnormalModeProxy(get_fortran_ptr_());
}
LinacNormalModeProxy NormalModesProxy::lin() const {
  void* ptr;
  normal_modes_struct_get_lin(get_fortran_ptr_(), &ptr);
  return LinacNormalModeProxy(get_fortran_ptr_());
}
...
double EmFieldProxy::phi() const {
  double value;
  em_field_struct_get_phi(get_fortran_ptr_(), &value);
  return value;
}
double EmFieldProxy::phi_B() const {
  double value;
  em_field_struct_get_phi_B(get_fortran_ptr_(), &value);
  return value;
}
...
int StrongBeamProxy::ix_slice() const {
  int value;
  strong_beam_struct_get_ix_slice(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::x_center() const {
  double value;
  strong_beam_struct_get_x_center(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::y_center() const {
  double value;
  strong_beam_struct_get_y_center(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::x_sigma() const {
  double value;
  strong_beam_struct_get_x_sigma(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::y_sigma() const {
  double value;
  strong_beam_struct_get_y_sigma(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::dx() const {
  double value;
  strong_beam_struct_get_dx(get_fortran_ptr_(), &value);
  return value;
}
double StrongBeamProxy::dy() const {
  double value;
  strong_beam_struct_get_dy(get_fortran_ptr_(), &value);
  return value;
}
double TrackPointProxy::s_lab() const {
  double value;
  track_point_struct_get_s_lab(get_fortran_ptr_(), &value);
  return value;
}
double TrackPointProxy::s_body() const {
  double value;
  track_point_struct_get_s_body(get_fortran_ptr_(), &value);
  return value;
}
CoordProxy TrackPointProxy::orb() const {
  void* ptr;
  track_point_struct_get_orb(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
EmFieldProxy TrackPointProxy::field() const {
  void* ptr;
  track_point_struct_get_field(get_fortran_ptr_(), &ptr);
  return EmFieldProxy(get_fortran_ptr_());
}
StrongBeamProxy TrackPointProxy::strong_beam() const {
  void* ptr;
  track_point_struct_get_strong_beam(get_fortran_ptr_(), &ptr);
  return StrongBeamProxy(get_fortran_ptr_());
}
...
int TrackProxy::n_pt() const {
  int value;
  track_struct_get_n_pt(get_fortran_ptr_(), &value);
  return value;
}
int TrackProxy::n_bad() const {
  int value;
  track_struct_get_n_bad(get_fortran_ptr_(), &value);
  return value;
}
int TrackProxy::n_ok() const {
  int value;
  track_struct_get_n_ok(get_fortran_ptr_(), &value);
  return value;
}
double SpaceChargeCommonProxy::ds_track_step() const {
  double value;
  space_charge_common_struct_get_ds_track_step(get_fortran_ptr_(), &value);
  return value;
}
double SpaceChargeCommonProxy::dt_track_step() const {
  double value;
  space_charge_common_struct_get_dt_track_step(get_fortran_ptr_(), &value);
  return value;
}
...
double SpaceChargeCommonProxy::rel_tol_tracking() const {
  double value;
  space_charge_common_struct_get_rel_tol_tracking(get_fortran_ptr_(), &value);
  return value;
}
double SpaceChargeCommonProxy::abs_tol_tracking() const {
  double value;
  space_charge_common_struct_get_abs_tol_tracking(get_fortran_ptr_(), &value);
  return value;
}
double SpaceChargeCommonProxy::beam_chamber_height() const {
  double value;
  space_charge_common_struct_get_beam_chamber_height(
      get_fortran_ptr_(), &value);
  return value;
}
double SpaceChargeCommonProxy::lsc_sigma_cutoff() const {
  double value;
  space_charge_common_struct_get_lsc_sigma_cutoff(get_fortran_ptr_(), &value);
  return value;
}
...
int SpaceChargeCommonProxy::n_bin() const {
  int value;
  space_charge_common_struct_get_n_bin(get_fortran_ptr_(), &value);
  return value;
}
int SpaceChargeCommonProxy::particle_bin_span() const {
  int value;
  space_charge_common_struct_get_particle_bin_span(get_fortran_ptr_(), &value);
  return value;
}
int SpaceChargeCommonProxy::n_shield_images() const {
  int value;
  space_charge_common_struct_get_n_shield_images(get_fortran_ptr_(), &value);
  return value;
}
int SpaceChargeCommonProxy::sc_min_in_bin() const {
  int value;
  space_charge_common_struct_get_sc_min_in_bin(get_fortran_ptr_(), &value);
  return value;
}
...
bool SpaceChargeCommonProxy::debug() const {
  bool value;
  space_charge_common_struct_get_debug(get_fortran_ptr_(), &value);
  return value;
}
...
double BmadCommonProxy::max_aperture_limit() const {
  double value;
  bmad_common_struct_get_max_aperture_limit(get_fortran_ptr_(), &value);
  return value;
}
...
double BmadCommonProxy::default_ds_step() const {
  double value;
  bmad_common_struct_get_default_ds_step(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::significant_length() const {
  double value;
  bmad_common_struct_get_significant_length(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::rel_tol_tracking() const {
  double value;
  bmad_common_struct_get_rel_tol_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::abs_tol_tracking() const {
  double value;
  bmad_common_struct_get_abs_tol_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::rel_tol_adaptive_tracking() const {
  double value;
  bmad_common_struct_get_rel_tol_adaptive_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::abs_tol_adaptive_tracking() const {
  double value;
  bmad_common_struct_get_abs_tol_adaptive_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::init_ds_adaptive_tracking() const {
  double value;
  bmad_common_struct_get_init_ds_adaptive_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::min_ds_adaptive_tracking() const {
  double value;
  bmad_common_struct_get_min_ds_adaptive_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::fatal_ds_adaptive_tracking() const {
  double value;
  bmad_common_struct_get_fatal_ds_adaptive_tracking(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::autoscale_amp_abs_tol() const {
  double value;
  bmad_common_struct_get_autoscale_amp_abs_tol(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::autoscale_amp_rel_tol() const {
  double value;
  bmad_common_struct_get_autoscale_amp_rel_tol(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::autoscale_phase_tol() const {
  double value;
  bmad_common_struct_get_autoscale_phase_tol(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::electric_dipole_moment() const {
  double value;
  bmad_common_struct_get_electric_dipole_moment(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::synch_rad_scale() const {
  double value;
  bmad_common_struct_get_synch_rad_scale(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::sad_eps_scale() const {
  double value;
  bmad_common_struct_get_sad_eps_scale(get_fortran_ptr_(), &value);
  return value;
}
double BmadCommonProxy::sad_amp_max() const {
  double value;
  bmad_common_struct_get_sad_amp_max(get_fortran_ptr_(), &value);
  return value;
}
int BmadCommonProxy::sad_n_div_max() const {
  int value;
  bmad_common_struct_get_sad_n_div_max(get_fortran_ptr_(), &value);
  return value;
}
int BmadCommonProxy::taylor_order() const {
  int value;
  bmad_common_struct_get_taylor_order(get_fortran_ptr_(), &value);
  return value;
}
int BmadCommonProxy::runge_kutta_order() const {
  int value;
  bmad_common_struct_get_runge_kutta_order(get_fortran_ptr_(), &value);
  return value;
}
int BmadCommonProxy::default_integ_order() const {
  int value;
  bmad_common_struct_get_default_integ_order(get_fortran_ptr_(), &value);
  return value;
}
int BmadCommonProxy::max_num_runge_kutta_step() const {
  int value;
  bmad_common_struct_get_max_num_runge_kutta_step(get_fortran_ptr_(), &value);
  return value;
}
...
bool BmadCommonProxy::sr_wakes_on() const {
  bool value;
  bmad_common_struct_get_sr_wakes_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::lr_wakes_on() const {
  bool value;
  bmad_common_struct_get_lr_wakes_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::auto_bookkeeper() const {
  bool value;
  bmad_common_struct_get_auto_bookkeeper(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::high_energy_space_charge_on() const {
  bool value;
  bmad_common_struct_get_high_energy_space_charge_on(
      get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::csr_and_space_charge_on() const {
  bool value;
  bmad_common_struct_get_csr_and_space_charge_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::spin_tracking_on() const {
  bool value;
  bmad_common_struct_get_spin_tracking_on(get_fortran_ptr_(), &value);
  return value;
}
...
bool BmadCommonProxy::radiation_damping_on() const {
  bool value;
  bmad_common_struct_get_radiation_damping_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::radiation_zero_average() const {
  bool value;
  bmad_common_struct_get_radiation_zero_average(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::radiation_fluctuations_on() const {
  bool value;
  bmad_common_struct_get_radiation_fluctuations_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::conserve_taylor_maps() const {
  bool value;
  bmad_common_struct_get_conserve_taylor_maps(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::absolute_time_tracking() const {
  bool value;
  bmad_common_struct_get_absolute_time_tracking(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::absolute_time_ref_shift() const {
  bool value;
  bmad_common_struct_get_absolute_time_ref_shift(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::convert_to_kinetic_momentum() const {
  bool value;
  bmad_common_struct_get_convert_to_kinetic_momentum(
      get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::normalize_twiss() const {
  bool value;
  bmad_common_struct_get_normalize_twiss(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::aperture_limit_on() const {
  bool value;
  bmad_common_struct_get_aperture_limit_on(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::spin_n0_direction_user_set() const {
  bool value;
  bmad_common_struct_get_spin_n0_direction_user_set(get_fortran_ptr_(), &value);
  return value;
}
bool BmadCommonProxy::debug() const {
  bool value;
  bmad_common_struct_get_debug(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i0() const {
  double value;
  rad_int1_struct_get_i0(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i1() const {
  double value;
  rad_int1_struct_get_i1(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i2() const {
  double value;
  rad_int1_struct_get_i2(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i3() const {
  double value;
  rad_int1_struct_get_i3(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i4a() const {
  double value;
  rad_int1_struct_get_i4a(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i4b() const {
  double value;
  rad_int1_struct_get_i4b(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i4z() const {
  double value;
  rad_int1_struct_get_i4z(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i5a() const {
  double value;
  rad_int1_struct_get_i5a(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i5b() const {
  double value;
  rad_int1_struct_get_i5b(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::i6b() const {
  double value;
  rad_int1_struct_get_i6b(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_i2_E4() const {
  double value;
  rad_int1_struct_get_lin_i2_E4(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_i3_E7() const {
  double value;
  rad_int1_struct_get_lin_i3_E7(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_i5a_E6() const {
  double value;
  rad_int1_struct_get_lin_i5a_E6(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_i5b_E6() const {
  double value;
  rad_int1_struct_get_lin_i5b_E6(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_norm_emit_a() const {
  double value;
  rad_int1_struct_get_lin_norm_emit_a(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_norm_emit_b() const {
  double value;
  rad_int1_struct_get_lin_norm_emit_b(get_fortran_ptr_(), &value);
  return value;
}
double RadInt1Proxy::lin_sig_E() const {
  double value;
  rad_int1_struct_get_lin_sig_E(get_fortran_ptr_(), &value);
  return value;
}
...
double RfStairStepProxy::E_tot1() const {
  double value;
  rf_stair_step_struct_get_E_tot1(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::p0c() const {
  double value;
  rf_stair_step_struct_get_p0c(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::p1c() const {
  double value;
  rf_stair_step_struct_get_p1c(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::dE_amp() const {
  double value;
  rf_stair_step_struct_get_dE_amp(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::scale() const {
  double value;
  rf_stair_step_struct_get_scale(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::time() const {
  double value;
  rf_stair_step_struct_get_time(get_fortran_ptr_(), &value);
  return value;
}
double RfStairStepProxy::s() const {
  double value;
  rf_stair_step_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
...
double RfEleProxy::ds_step() const {
  double value;
  rf_ele_struct_get_ds_step(get_fortran_ptr_(), &value);
  return value;
}
...
TwissProxy EleProxy::a() const {
  void* ptr;
  ele_struct_get_a(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy EleProxy::b() const {
  void* ptr;
  ele_struct_get_b(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy EleProxy::z() const {
  void* ptr;
  ele_struct_get_z(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
XyDispProxy EleProxy::x() const {
  void* ptr;
  ele_struct_get_x(get_fortran_ptr_(), &ptr);
  return XyDispProxy(get_fortran_ptr_());
}
XyDispProxy EleProxy::y() const {
  void* ptr;
  ele_struct_get_y(get_fortran_ptr_(), &ptr);
  return XyDispProxy(get_fortran_ptr_());
}
const void* EleProxy::ac_kick() const {
  void* ptr;
  ele_struct_get_ac_kick(get_fortran_ptr_(), &ptr);
  return ptr;
}
BookkeepingStateProxy EleProxy::bookkeeping_state() const {
  void* ptr;
  ele_struct_get_bookkeeping_state(get_fortran_ptr_(), &ptr);
  return BookkeepingStateProxy(get_fortran_ptr_());
}
const void* EleProxy::branch() const {
  void* ptr;
  ele_struct_get_branch(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* EleProxy::control() const {
  void* ptr;
  ele_struct_get_control(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* EleProxy::rf() const {
  void* ptr;
  ele_struct_get_rf(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* EleProxy::lord() const {
  void* ptr;
  ele_struct_get_lord(get_fortran_ptr_(), &ptr);
  return ptr;
}
FloorPositionProxy EleProxy::floor() const {
  void* ptr;
  ele_struct_get_floor(get_fortran_ptr_(), &ptr);
  return FloorPositionProxy(get_fortran_ptr_());
}
const void* EleProxy::high_energy_space_charge() const {
  void* ptr;
  ele_struct_get_high_energy_space_charge(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* EleProxy::mode3() const {
  void* ptr;
  ele_struct_get_mode3(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* EleProxy::photon() const {
  void* ptr;
  ele_struct_get_photon(get_fortran_ptr_(), &ptr);
  return ptr;
}
...
CoordProxy EleProxy::map_ref_orb_in() const {
  void* ptr;
  ele_struct_get_map_ref_orb_in(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
CoordProxy EleProxy::map_ref_orb_out() const {
  void* ptr;
  ele_struct_get_map_ref_orb_out(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
CoordProxy EleProxy::time_ref_orb_in() const {
  void* ptr;
  ele_struct_get_time_ref_orb_in(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
CoordProxy EleProxy::time_ref_orb_out() const {
  void* ptr;
  ele_struct_get_time_ref_orb_out(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
...
double EleProxy::gamma_c() const {
  double value;
  ele_struct_get_gamma_c(get_fortran_ptr_(), &value);
  return value;
}
double EleProxy::s_start() const {
  double value;
  ele_struct_get_s_start(get_fortran_ptr_(), &value);
  return value;
}
double EleProxy::s() const {
  double value;
  ele_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
double EleProxy::ref_time() const {
  double value;
  ele_struct_get_ref_time(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::key() const {
  int value;
  ele_struct_get_key(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::sub_key() const {
  int value;
  ele_struct_get_sub_key(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ix_ele() const {
  int value;
  ele_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ix_branch() const {
  int value;
  ele_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::lord_status() const {
  int value;
  ele_struct_get_lord_status(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::n_slave() const {
  int value;
  ele_struct_get_n_slave(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::n_slave_field() const {
  int value;
  ele_struct_get_n_slave_field(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ix1_slave() const {
  int value;
  ele_struct_get_ix1_slave(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::slave_status() const {
  int value;
  ele_struct_get_slave_status(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::n_lord() const {
  int value;
  ele_struct_get_n_lord(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::n_lord_field() const {
  int value;
  ele_struct_get_n_lord_field(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::n_lord_ramper() const {
  int value;
  ele_struct_get_n_lord_ramper(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ic1_lord() const {
  int value;
  ele_struct_get_ic1_lord(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ix_pointer() const {
  int value;
  ele_struct_get_ix_pointer(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ixx() const {
  int value;
  ele_struct_get_ixx(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::iyy() const {
  int value;
  ele_struct_get_iyy(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::izz() const {
  int value;
  ele_struct_get_izz(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::mat6_calc_method() const {
  int value;
  ele_struct_get_mat6_calc_method(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::tracking_method() const {
  int value;
  ele_struct_get_tracking_method(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::spin_tracking_method() const {
  int value;
  ele_struct_get_spin_tracking_method(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::csr_method() const {
  int value;
  ele_struct_get_csr_method(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::space_charge_method() const {
  int value;
  ele_struct_get_space_charge_method(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ptc_integration_type() const {
  int value;
  ele_struct_get_ptc_integration_type(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::field_calc() const {
  int value;
  ele_struct_get_field_calc(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::aperture_at() const {
  int value;
  ele_struct_get_aperture_at(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::aperture_type() const {
  int value;
  ele_struct_get_aperture_type(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::ref_species() const {
  int value;
  ele_struct_get_ref_species(get_fortran_ptr_(), &value);
  return value;
}
int EleProxy::orientation() const {
  int value;
  ele_struct_get_orientation(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::symplectify() const {
  bool value;
  ele_struct_get_symplectify(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::mode_flip() const {
  bool value;
  ele_struct_get_mode_flip(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::multipoles_on() const {
  bool value;
  ele_struct_get_multipoles_on(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::scale_multipoles() const {
  bool value;
  ele_struct_get_scale_multipoles(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::taylor_map_includes_offsets() const {
  bool value;
  ele_struct_get_taylor_map_includes_offsets(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::field_master() const {
  bool value;
  ele_struct_get_field_master(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::is_on() const {
  bool value;
  ele_struct_get_is_on(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::logic() const {
  bool value;
  ele_struct_get_logic(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::bmad_logic() const {
  bool value;
  ele_struct_get_bmad_logic(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::select() const {
  bool value;
  ele_struct_get_select(get_fortran_ptr_(), &value);
  return value;
}
bool EleProxy::offset_moves_aperture() const {
  bool value;
  ele_struct_get_offset_moves_aperture(get_fortran_ptr_(), &value);
  return value;
}
std::complex<double> ComplexTaylorTermProxy::coef() const {
  std::complex<double> c_value;
  complex_taylor_term_struct_get_coef(get_fortran_ptr_(), &c_value);
  return c_value;
}
...
int BranchProxy::ix_branch() const {
  int value;
  branch_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::ix_from_branch() const {
  int value;
  branch_struct_get_ix_from_branch(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::ix_from_ele() const {
  int value;
  branch_struct_get_ix_from_ele(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::ix_to_ele() const {
  int value;
  branch_struct_get_ix_to_ele(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::ix_fixer() const {
  int value;
  branch_struct_get_ix_fixer(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::n_ele_track() const {
  int value;
  branch_struct_get_n_ele_track(get_fortran_ptr_(), &value);
  return value;
}
int BranchProxy::n_ele_max() const {
  int value;
  branch_struct_get_n_ele_max(get_fortran_ptr_(), &value);
  return value;
}
const void* BranchProxy::lat() const {
  void* ptr;
  branch_struct_get_lat(get_fortran_ptr_(), &ptr);
  return ptr;
}
ModeInfoProxy BranchProxy::a() const {
  void* ptr;
  branch_struct_get_a(get_fortran_ptr_(), &ptr);
  return ModeInfoProxy(get_fortran_ptr_());
}
ModeInfoProxy BranchProxy::b() const {
  void* ptr;
  branch_struct_get_b(get_fortran_ptr_(), &ptr);
  return ModeInfoProxy(get_fortran_ptr_());
}
...
LatParamProxy BranchProxy::param() const {
  ...
  return LatParamProxy(get_fortran_ptr_());
}
...
const void* LatProxy::b() const {
  void* ptr;
  lat_struct_get_b(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* LatProxy::z() const {
  void* ptr;
  lat_struct_get_z(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* LatProxy::param() const {
  void* ptr;
  lat_struct_get_param(get_fortran_ptr_(), &ptr);
  return ptr;
}
BookkeepingStateProxy LatProxy::lord_state() const {
  void* ptr;
  lat_struct_get_lord_state(get_fortran_ptr_(), &ptr);
  return BookkeepingStateProxy(get_fortran_ptr_());
}
...
const void* LatProxy::particle_start() const {
  void* ptr;
  lat_struct_get_particle_start(get_fortran_ptr_(), &ptr);
  return ptr;
}
BeamInitProxy LatProxy::beam_init() const {
  void* ptr;
  lat_struct_get_beam_init(get_fortran_ptr_(), &ptr);
  return BeamInitProxy(get_fortran_ptr_());
}
PreTrackerProxy LatProxy::pre_tracker() const {
  void* ptr;
  lat_struct_get_pre_tracker(get_fortran_ptr_(), &ptr);
  return PreTrackerProxy(get_fortran_ptr_());
}
...
int LatProxy::version() const {
  int value;
  lat_struct_get_version(get_fortran_ptr_(), &value);
  return value;
}
int* LatProxy::n_ele_track() const {
  int* ptr;
  lat_struct_get_n_ele_track(get_fortran_ptr_(), &ptr);
  return ptr;
}
int* LatProxy::n_ele_max() const {
  int* ptr;
  lat_struct_get_n_ele_max(get_fortran_ptr_(), &ptr);
  return ptr;
}
int LatProxy::n_control_max() const {
  int value;
  lat_struct_get_n_control_max(get_fortran_ptr_(), &value);
  return value;
}
int LatProxy::n_ic_max() const {
  int value;
  lat_struct_get_n_ic_max(get_fortran_ptr_(), &value);
  return value;
}
int LatProxy::input_taylor_order() const {
  int value;
  lat_struct_get_input_taylor_order(get_fortran_ptr_(), &value);
  return value;
}
...
int LatProxy::photon_type() const {
  int value;
  lat_struct_get_photon_type(get_fortran_ptr_(), &value);
  return value;
}
int LatProxy::creation_hash() const {
  int value;
  lat_struct_get_creation_hash(get_fortran_ptr_(), &value);
  return value;
}
...
double BunchProxy::charge_tot() const {
  double value;
  bunch_struct_get_charge_tot(get_fortran_ptr_(), &value);
  return value;
}
double BunchProxy::charge_live() const {
  double value;
  bunch_struct_get_charge_live(get_fortran_ptr_(), &value);
  return value;
}
double BunchProxy::z_center() const {
  double value;
  bunch_struct_get_z_center(get_fortran_ptr_(), &value);
  return value;
}
double BunchProxy::t_center() const {
  double value;
  bunch_struct_get_t_center(get_fortran_ptr_(), &value);
  return value;
}
double BunchProxy::t0() const {
  double value;
  bunch_struct_get_t0(get_fortran_ptr_(), &value);
  return value;
}
bool BunchProxy::drift_between_t_and_s() const {
  bool value;
  bunch_struct_get_drift_between_t_and_s(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::ix_ele() const {
  int value;
  bunch_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::ix_bunch() const {
  int value;
  bunch_struct_get_ix_bunch(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::ix_turn() const {
  int value;
  bunch_struct_get_ix_turn(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::n_live() const {
  int value;
  bunch_struct_get_n_live(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::n_good() const {
  int value;
  bunch_struct_get_n_good(get_fortran_ptr_(), &value);
  return value;
}
int BunchProxy::n_bad() const {
  int value;
  bunch_struct_get_n_bad(get_fortran_ptr_(), &value);
  return value;
}
CoordProxy BunchParamsProxy::centroid() const {
  void* ptr;
  bunch_params_struct_get_centroid(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::x() const {
  void* ptr;
  bunch_params_struct_get_x(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::y() const {
  void* ptr;
  bunch_params_struct_get_y(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::z() const {
  void* ptr;
  bunch_params_struct_get_z(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::a() const {
  void* ptr;
  bunch_params_struct_get_a(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::b() const {
  void* ptr;
  bunch_params_struct_get_b(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
TwissProxy BunchParamsProxy::c() const {
  void* ptr;
  bunch_params_struct_get_c(get_fortran_ptr_(), &ptr);
  return TwissProxy(get_fortran_ptr_());
}
...
double BunchParamsProxy::s() const {
  double value;
  bunch_params_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
double BunchParamsProxy::t() const {
  double value;
  bunch_params_struct_get_t(get_fortran_ptr_(), &value);
  return value;
}
double BunchParamsProxy::sigma_t() const {
  double value;
  bunch_params_struct_get_sigma_t(get_fortran_ptr_(), &value);
  return value;
}
double BunchParamsProxy::charge_live() const {
  double value;
  bunch_params_struct_get_charge_live(get_fortran_ptr_(), &value);
  return value;
}
double BunchParamsProxy::charge_tot() const {
  double value;
  bunch_params_struct_get_charge_tot(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::n_particle_tot() const {
  int value;
  bunch_params_struct_get_n_particle_tot(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::n_particle_live() const {
  int value;
  bunch_params_struct_get_n_particle_live(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::n_particle_lost_in_ele() const {
  int value;
  bunch_params_struct_get_n_particle_lost_in_ele(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::n_good_steps() const {
  int value;
  bunch_params_struct_get_n_good_steps(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::n_bad_steps() const {
  int value;
  bunch_params_struct_get_n_bad_steps(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::ix_ele() const {
  int value;
  bunch_params_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int BunchParamsProxy::location() const {
  int value;
  bunch_params_struct_get_location(get_fortran_ptr_(), &value);
  return value;
}
...
double AperturePointProxy::y() const {
  double value;
  aperture_point_struct_get_y(get_fortran_ptr_(), &value);
  return value;
}
int AperturePointProxy::plane() const {
  int value;
  aperture_point_struct_get_plane(get_fortran_ptr_(), &value);
  return value;
}
int AperturePointProxy::ix_ele() const {
  int value;
  aperture_point_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int AperturePointProxy::i_turn() const {
  int value;
  aperture_point_struct_get_i_turn(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::min_angle() const {
  double value;
  aperture_param_struct_get_min_angle(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::max_angle() const {
  double value;
  aperture_param_struct_get_max_angle(get_fortran_ptr_(), &value);
  return value;
}
int ApertureParamProxy::n_angle() const {
  int value;
  aperture_param_struct_get_n_angle(get_fortran_ptr_(), &value);
  return value;
}
int ApertureParamProxy::n_turn() const {
  int value;
  aperture_param_struct_get_n_turn(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::x_init() const {
  double value;
  aperture_param_struct_get_x_init(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::y_init() const {
  double value;
  aperture_param_struct_get_y_init(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::rel_accuracy() const {
  double value;
  aperture_param_struct_get_rel_accuracy(get_fortran_ptr_(), &value);
  return value;
}
double ApertureParamProxy::abs_accuracy() const {
  double value;
  aperture_param_struct_get_abs_accuracy(get_fortran_ptr_(), &value);
  return value;
}
...
CoordProxy ApertureScanProxy::ref_orb() const {
  void* ptr;
  aperture_scan_struct_get_ref_orb(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
double ApertureScanProxy::pz_start() const {
  double value;
  aperture_scan_struct_get_pz_start(get_fortran_ptr_(), &value);
  return value;
}
...
std::complex<double> ResonanceHProxy::c_val() const {
  std::complex<double> c_value;
  resonance_h_struct_get_c_val(get_fortran_ptr_(), &c_value);
  return c_value;
}
...
const void* PtcNormalFormProxy::ele_origin() const {
  void* ptr;
  ptc_normal_form_struct_get_ele_origin(get_fortran_ptr_(), &ptr);
  return ptr;
}
...
bool PtcNormalFormProxy::valid_map() const {
  bool value;
  ptc_normal_form_struct_get_valid_map(get_fortran_ptr_(), &value);
  return value;
}
...
double BunchTrackProxy::ds_save() const {
  double value;
  bunch_track_struct_get_ds_save(get_fortran_ptr_(), &value);
  return value;
}
int BunchTrackProxy::n_pt() const {
  int value;
  bunch_track_struct_get_n_pt(get_fortran_ptr_(), &value);
  return value;
}
std::complex<double> SummationRdtProxy::h11001() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h11001(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h00111() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h00111(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h20001() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h20001(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h00201() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h00201(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h10002() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h10002(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h21000() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h21000(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h30000() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h30000(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h10110() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h10110(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h10020() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h10020(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h10200() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h10200(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h31000() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h31000(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h40000() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h40000(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h20110() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h20110(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h11200() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h11200(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h20020() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h20020(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h20200() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h20200(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h00310() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h00310(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h00400() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h00400(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h22000() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h22000(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h00220() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h00220(get_fortran_ptr_(), &c_value);
  return c_value;
}
std::complex<double> SummationRdtProxy::h11110() const {
  std::complex<double> c_value;
  summation_rdt_struct_get_h11110(get_fortran_ptr_(), &c_value);
  return c_value;
}
int LatEleOrder1Proxy::ix_branch() const {
  int value;
  lat_ele_order1_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
...
TaoSpinDnDpzProxy TaoSpinEleProxy::dn_dpz() const {
  void* ptr;
  tao_spin_ele_struct_get_dn_dpz(get_fortran_ptr_(), &ptr);
  return TaoSpinDnDpzProxy(get_fortran_ptr_());
}
...
bool TaoSpinEleProxy::valid() const {
  bool value;
  tao_spin_ele_struct_get_valid(get_fortran_ptr_(), &value);
  return value;
}
EleProxy TaoPlotCacheProxy::ele_to_s() const {
  void* ptr;
  tao_plot_cache_struct_get_ele_to_s(get_fortran_ptr_(), &ptr);
  return EleProxy(get_fortran_ptr_());
}
CoordProxy TaoPlotCacheProxy::orbit() const {
  void* ptr;
  tao_plot_cache_struct_get_orbit(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
bool TaoPlotCacheProxy::err() const {
  bool value;
  tao_plot_cache_struct_get_err(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::tune() const {
  double value;
  tao_spin_polarization_struct_get_tune(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::pol_limit_st() const {
  double value;
  tao_spin_polarization_struct_get_pol_limit_st(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::pol_limit_dk() const {
  double value;
  tao_spin_polarization_struct_get_pol_limit_dk(get_fortran_ptr_(), &value);
  return value;
}
...
double TaoSpinPolarizationProxy::pol_rate_bks() const {
  double value;
  tao_spin_polarization_struct_get_pol_rate_bks(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::depol_rate() const {
  double value;
  tao_spin_polarization_struct_get_depol_rate(get_fortran_ptr_(), &value);
  return value;
}
...
double TaoSpinPolarizationProxy::integral_bn() const {
  double value;
  tao_spin_polarization_struct_get_integral_bn(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::integral_bdn() const {
  double value;
  tao_spin_polarization_struct_get_integral_bdn(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::integral_1ns() const {
  double value;
  tao_spin_polarization_struct_get_integral_1ns(get_fortran_ptr_(), &value);
  return value;
}
double TaoSpinPolarizationProxy::integral_dn2() const {
  double value;
  tao_spin_polarization_struct_get_integral_dn2(get_fortran_ptr_(), &value);
  return value;
}
bool TaoSpinPolarizationProxy::valid() const {
  bool value;
  tao_spin_polarization_struct_get_valid(get_fortran_ptr_(), &value);
  return value;
}
...
TaoSpinPolarizationProxy TaoLatticeBranchProxy::spin() const {
  ...
  return TaoSpinPolarizationProxy(get_fortran_ptr_());
}
SummationRdtProxy TaoLatticeBranchProxy::srdt() const {
  void* ptr;
  tao_lattice_branch_struct_get_srdt(get_fortran_ptr_(), &ptr);
  return SummationRdtProxy(get_fortran_ptr_());
}
CoordProxy TaoLatticeBranchProxy::orb0() const {
  void* ptr;
  tao_lattice_branch_struct_get_orb0(get_fortran_ptr_(), &ptr);
  return CoordProxy(get_fortran_ptr_());
}
NormalModesProxy TaoLatticeBranchProxy::modes_ri() const {
  void* ptr;
  tao_lattice_branch_struct_get_modes_ri(get_fortran_ptr_(), &ptr);
  return NormalModesProxy(get_fortran_ptr_());
}
NormalModesProxy TaoLatticeBranchProxy::modes_6d() const {
  void* ptr;
  tao_lattice_branch_struct_get_modes_6d(get_fortran_ptr_(), &ptr);
  return NormalModesProxy(get_fortran_ptr_());
}
PtcNormalFormProxy TaoLatticeBranchProxy::ptc_normal_form() const {
  void* ptr;
  tao_lattice_branch_struct_get_ptc_normal_form(get_fortran_ptr_(), &ptr);
  return PtcNormalFormProxy(get_fortran_ptr_());
}
...
double TaoLatticeBranchProxy::cache_x_min() const {
  double value;
  tao_lattice_branch_struct_get_cache_x_min(get_fortran_ptr_(), &value);
  return value;
}
double TaoLatticeBranchProxy::cache_x_max() const {
  double value;
  tao_lattice_branch_struct_get_cache_x_max(get_fortran_ptr_(), &value);
  return value;
}
double TaoLatticeBranchProxy::comb_ds_save() const {
  double value;
  tao_lattice_branch_struct_get_comb_ds_save(get_fortran_ptr_(), &value);
  return value;
}
int TaoLatticeBranchProxy::track_state() const {
  int value;
  tao_lattice_branch_struct_get_track_state(get_fortran_ptr_(), &value);
  return value;
}
int TaoLatticeBranchProxy::cache_n_pts() const {
  int value;
  tao_lattice_branch_struct_get_cache_n_pts(get_fortran_ptr_(), &value);
  return value;
}
int TaoLatticeBranchProxy::ix_rad_int_cache() const {
  int value;
  tao_lattice_branch_struct_get_ix_rad_int_cache(get_fortran_ptr_(), &value);
  return value;
}
...
bool TaoLatticeBranchProxy::plot_cache_valid() const {
  bool value;
  tao_lattice_branch_struct_get_plot_cache_valid(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::spin_map_valid() const {
  bool value;
  tao_lattice_branch_struct_get_spin_map_valid(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::twiss_valid() const {
  bool value;
  tao_lattice_branch_struct_get_twiss_valid(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::mode_flip_here() const {
  bool value;
  tao_lattice_branch_struct_get_mode_flip_here(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::chrom_calc_ok() const {
  bool value;
  tao_lattice_branch_struct_get_chrom_calc_ok(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::rad_int_calc_ok() const {
  bool value;
  tao_lattice_branch_struct_get_rad_int_calc_ok(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::emit_6d_calc_ok() const {
  bool value;
  tao_lattice_branch_struct_get_emit_6d_calc_ok(get_fortran_ptr_(), &value);
  return value;
}
bool TaoLatticeBranchProxy::sigma_track_ok() const {
  bool value;
  tao_lattice_branch_struct_get_sigma_track_ok(get_fortran_ptr_(), &value);
  return value;
}
BeamProxy TaoModelElementProxy::beam() const {
  void* ptr;
  tao_model_element_struct_get_beam(get_fortran_ptr_(), &ptr);
  return BeamProxy(get_fortran_ptr_());
}
bool TaoModelElementProxy::save_beam_internally() const {
  bool value;
  tao_model_element_struct_get_save_beam_internally(get_fortran_ptr_(), &value);
  return value;
}
bool TaoModelElementProxy::save_beam_to_file() const {
  bool value;
  tao_model_element_struct_get_save_beam_to_file(get_fortran_ptr_(), &value);
  return value;
}
BeamProxy TaoBeamBranchProxy::beam_at_start() const {
  void* ptr;
  tao_beam_branch_struct_get_beam_at_start(get_fortran_ptr_(), &ptr);
  return BeamProxy(get_fortran_ptr_());
}
BeamInitProxy TaoBeamBranchProxy::beam_init() const {
  void* ptr;
  tao_beam_branch_struct_get_beam_init(get_fortran_ptr_(), &ptr);
  return BeamInitProxy(get_fortran_ptr_());
}
BeamInitProxy TaoBeamBranchProxy::beam_init_used() const {
  void* ptr;
  tao_beam_branch_struct_get_beam_init_used(get_fortran_ptr_(), &ptr);
  return BeamInitProxy(get_fortran_ptr_());
}
...
int TaoBeamBranchProxy::ix_branch() const {
  int value;
  tao_beam_branch_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int TaoBeamBranchProxy::ix_track_start() const {
  int value;
  tao_beam_branch_struct_get_ix_track_start(get_fortran_ptr_(), &value);
  return value;
}
int TaoBeamBranchProxy::ix_track_end() const {
  int value;
  tao_beam_branch_struct_get_ix_track_end(get_fortran_ptr_(), &value);
  return value;
}
...
LatProxy TaoLatticeProxy::lat() const {
  void* ptr;
  tao_lattice_struct_get_lat(get_fortran_ptr_(), &ptr);
  return LatProxy(get_fortran_ptr_());
}
LatProxy TaoLatticeProxy::high_E_lat() const {
  void* ptr;
  tao_lattice_struct_get_high_E_lat(get_fortran_ptr_(), &ptr);
  return LatProxy(get_fortran_ptr_());
}
LatProxy TaoLatticeProxy::low_E_lat() const {
  void* ptr;
  tao_lattice_struct_get_low_E_lat(get_fortran_ptr_(), &ptr);
  return LatProxy(get_fortran_ptr_());
}
RadIntAllEleProxy TaoLatticeProxy::rad_int_by_ele_ri() const {
  void* ptr;
  tao_lattice_struct_get_rad_int_by_ele_ri(get_fortran_ptr_(), &ptr);
...
bool TaoBeamUniProxy::track_beam_in_universe() const {
  bool value;
  tao_beam_uni_struct_get_track_beam_in_universe(get_fortran_ptr_(), &value);
  return value;
}
bool TaoBeamUniProxy::always_reinit() const {
  bool value;
  tao_beam_uni_struct_get_always_reinit(get_fortran_ptr_(), &value);
  return value;
}
...
double TaoDynamicApertureProxy::ellipse_scale() const {
  double value;
  tao_dynamic_aperture_struct_get_ellipse_scale(get_fortran_ptr_(), &value);
  return value;
}
double TaoDynamicApertureProxy::a_emit() const {
  double value;
  tao_dynamic_aperture_struct_get_a_emit(get_fortran_ptr_(), &value);
  return value;
}
...
TaoBeamBranchProxy TaoModelBranchProxy::beam() const {
  void* ptr;
  tao_model_branch_struct_get_beam(get_fortran_ptr_(), &ptr);
  return TaoBeamBranchProxy(get_fortran_ptr_());
}
...
int TaoD2DataProxy::ix_universe() const {
  int value;
  tao_d2_data_struct_get_ix_universe(get_fortran_ptr_(), &value);
  return value;
}
int TaoD2DataProxy::ix_d2_data() const {
  int value;
  tao_d2_data_struct_get_ix_d2_data(get_fortran_ptr_(), &value);
  return value;
}
int TaoD2DataProxy::ix_ref() const {
  int value;
  tao_d2_data_struct_get_ix_ref(get_fortran_ptr_(), &value);
  return value;
}
bool TaoD2DataProxy::data_read_in() const {
  bool value;
  tao_d2_data_struct_get_data_read_in(get_fortran_ptr_(), &value);
  return value;
}
bool TaoD2DataProxy::ref_read_in() const {
  bool value;
  tao_d2_data_struct_get_ref_read_in(get_fortran_ptr_(), &value);
  return value;
}
bool TaoSpinMapProxy::valid() const {
  bool value;
  tao_spin_map_struct_get_valid(get_fortran_ptr_(), &value);
  return value;
}
SpinOrbitMap1Proxy TaoSpinMapProxy::map1() const {
  void* ptr;
  tao_spin_map_struct_get_map1(get_fortran_ptr_(), &ptr);
  return SpinOrbitMap1Proxy(get_fortran_ptr_());
}
SpinAxisProxy TaoSpinMapProxy::axis_input() const {
  void* ptr;
  tao_spin_map_struct_get_axis_input(get_fortran_ptr_(), &ptr);
  return SpinAxisProxy(get_fortran_ptr_());
}
SpinAxisProxy TaoSpinMapProxy::axis0() const {
  void* ptr;
  tao_spin_map_struct_get_axis0(get_fortran_ptr_(), &ptr);
  return SpinAxisProxy(get_fortran_ptr_());
}
SpinAxisProxy TaoSpinMapProxy::axis1() const {
  void* ptr;
  tao_spin_map_struct_get_axis1(get_fortran_ptr_(), &ptr);
  return SpinAxisProxy(get_fortran_ptr_());
}
int TaoSpinMapProxy::ix_ele() const {
  int value;
  tao_spin_map_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int TaoSpinMapProxy::ix_ref() const {
  int value;
  tao_spin_map_struct_get_ix_ref(get_fortran_ptr_(), &value);
  return value;
}
int TaoSpinMapProxy::ix_uni() const {
  int value;
  tao_spin_map_struct_get_ix_uni(get_fortran_ptr_(), &value);
  return value;
}
int TaoSpinMapProxy::ix_branch() const {
  int value;
  tao_spin_map_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
...
int TaoDataProxy::ix_uni() const {
  int value;
  tao_data_struct_get_ix_uni(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_bunch() const {
  int value;
  tao_data_struct_get_ix_bunch(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_branch() const {
  int value;
  tao_data_struct_get_ix_branch(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_ele() const {
  int value;
  tao_data_struct_get_ix_ele(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_ele_start() const {
  int value;
  tao_data_struct_get_ix_ele_start(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_ele_ref() const {
  int value;
  tao_data_struct_get_ix_ele_ref(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_ele_merit() const {
  int value;
  tao_data_struct_get_ix_ele_merit(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_d1() const {
  int value;
  tao_data_struct_get_ix_d1(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_data() const {
  int value;
  tao_data_struct_get_ix_data(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::ix_dModel() const {
  int value;
  tao_data_struct_get_ix_dModel(get_fortran_ptr_(), &value);
  return value;
}
int TaoDataProxy::eval_point() const {
  int value;
  tao_data_struct_get_eval_point(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::meas_value() const {
  double value;
  tao_data_struct_get_meas_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::ref_value() const {
  double value;
  tao_data_struct_get_ref_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::model_value() const {
  double value;
  tao_data_struct_get_model_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::design_value() const {
  double value;
  tao_data_struct_get_design_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::old_value() const {
  double value;
  tao_data_struct_get_old_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::base_value() const {
  double value;
  tao_data_struct_get_base_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::error_rms() const {
  double value;
  tao_data_struct_get_error_rms(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::delta_merit() const {
  double value;
  tao_data_struct_get_delta_merit(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::weight() const {
  double value;
  tao_data_struct_get_weight(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::invalid_value() const {
  double value;
  tao_data_struct_get_invalid_value(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::merit() const {
  double value;
  tao_data_struct_get_merit(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::s() const {
  double value;
  tao_data_struct_get_s(get_fortran_ptr_(), &value);
  return value;
}
double TaoDataProxy::s_offset() const {
  double value;
  tao_data_struct_get_s_offset(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::err_message_printed() const {
  bool value;
  tao_data_struct_get_err_message_printed(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::exists() const {
  bool value;
  tao_data_struct_get_exists(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_model() const {
  bool value;
  tao_data_struct_get_good_model(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_base() const {
  bool value;
  tao_data_struct_get_good_base(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_design() const {
  bool value;
  tao_data_struct_get_good_design(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_meas() const {
  bool value;
  tao_data_struct_get_good_meas(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_ref() const {
  bool value;
  tao_data_struct_get_good_ref(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_user() const {
  bool value;
  tao_data_struct_get_good_user(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_opt() const {
  bool value;
  tao_data_struct_get_good_opt(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::good_plot() const {
  bool value;
  tao_data_struct_get_good_plot(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::useit_plot() const {
  bool value;
  tao_data_struct_get_useit_plot(get_fortran_ptr_(), &value);
  return value;
}
bool TaoDataProxy::useit_opt() const {
  bool value;
  tao_data_struct_get_useit_opt(get_fortran_ptr_(), &value);
  return value;
}
TaoSpinMapProxy TaoDataProxy::spin_map() const {
  void* ptr;
  tao_data_struct_get_spin_map(get_fortran_ptr_(), &ptr);
  return TaoSpinMapProxy(get_fortran_ptr_());
}
const void* TaoDataProxy::d1() const {
  void* ptr;
  tao_data_struct_get_d1(get_fortran_ptr_(), &ptr);
  return ptr;
}
double TaoPingScaleProxy::a_mode_meas() const {
  double value;
  tao_ping_scale_struct_get_a_mode_meas(get_fortran_ptr_(), &value);
  return value;
}
double TaoPingScaleProxy::a_mode_ref() const {
  double value;
  tao_ping_scale_struct_get_a_mode_ref(get_fortran_ptr_(), &value);
  return value;
}
double TaoPingScaleProxy::b_mode_meas() const {
  double value;
  tao_ping_scale_struct_get_b_mode_meas(get_fortran_ptr_(), &value);
  return value;
}
double TaoPingScaleProxy::b_mode_ref() const {
  double value;
  tao_ping_scale_struct_get_b_mode_ref(get_fortran_ptr_(), &value);
  return value;
}
int TaoUniverseCalcProxy::srdt_for_data() const {
  int value;
  tao_universe_calc_struct_get_srdt_for_data(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::rad_int_for_data() const {
  bool value;
  tao_universe_calc_struct_get_rad_int_for_data(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::rad_int_for_plotting() const {
  bool value;
  tao_universe_calc_struct_get_rad_int_for_plotting(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::chrom_for_data() const {
  bool value;
  tao_universe_calc_struct_get_chrom_for_data(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::chrom_for_plotting() const {
  bool value;
  tao_universe_calc_struct_get_chrom_for_plotting(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::lat_sigma_for_data() const {
  bool value;
  tao_universe_calc_struct_get_lat_sigma_for_data(get_fortran_ptr_(), &value);
  return value;
}
...
bool TaoUniverseCalcProxy::dynamic_aperture() const {
  bool value;
  tao_universe_calc_struct_get_dynamic_aperture(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::one_turn_map() const {
  bool value;
  tao_universe_calc_struct_get_one_turn_map(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::lattice() const {
  bool value;
  tao_universe_calc_struct_get_lattice(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::twiss() const {
  bool value;
  tao_universe_calc_struct_get_twiss(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseCalcProxy::track() const {
  bool value;
  tao_universe_calc_struct_get_track(get_fortran_ptr_(), &value);
  return value;
}
...
const void* TaoUniverseProxy::design() const {
  void* ptr;
  tao_universe_struct_get_design(get_fortran_ptr_(), &ptr);
  return ptr;
}
const void* TaoUniverseProxy::base() const {
  void* ptr;
  tao_universe_struct_get_base(get_fortran_ptr_(), &ptr);
  return ptr;
}
TaoBeamUniProxy TaoUniverseProxy::beam() const {
  void* ptr;
  tao_universe_struct_get_beam(get_fortran_ptr_(), &ptr);
  return TaoBeamUniProxy(get_fortran_ptr_());
}
...
TaoPingScaleProxy TaoUniverseProxy::ping_scale() const {
  void* ptr;
  tao_universe_struct_get_ping_scale(get_fortran_ptr_(), &ptr);
  return TaoPingScaleProxy(get_fortran_ptr_());
}
LatProxy TaoUniverseProxy::scratch_lat() const {
  void* ptr;
  tao_universe_struct_get_scratch_lat(get_fortran_ptr_(), &ptr);
  return LatProxy(get_fortran_ptr_());
}
TaoUniverseCalcProxy TaoUniverseProxy::calc() const {
  void* ptr;
  tao_universe_struct_get_calc(get_fortran_ptr_(), &ptr);
  return TaoUniverseCalcProxy(get_fortran_ptr_());
}
LatEleOrderProxy TaoUniverseProxy::ele_order() const {
  void* ptr;
  tao_universe_struct_get_ele_order(get_fortran_ptr_(), &ptr);
  return LatEleOrderProxy(get_fortran_ptr_());
}
TaoSpinMapProxy TaoUniverseProxy::spin_map() const {
  void* ptr;
  tao_universe_struct_get_spin_map(get_fortran_ptr_(), &ptr);
  return TaoSpinMapProxy(get_fortran_ptr_());
}
...
int TaoUniverseProxy::ix_uni() const {
  int value;
  tao_universe_struct_get_ix_uni(get_fortran_ptr_(), &value);
  return value;
}
int TaoUniverseProxy::n_d2_data_used() const {
  int value;
  tao_universe_struct_get_n_d2_data_used(get_fortran_ptr_(), &value);
  return value;
}
int TaoUniverseProxy::n_data_used() const {
  int value;
  tao_universe_struct_get_n_data_used(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseProxy::is_on() const {
  bool value;
  tao_universe_struct_get_is_on(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseProxy::design_same_as_previous() const {
  bool value;
  tao_universe_struct_get_design_same_as_previous(get_fortran_ptr_(), &value);
  return value;
}
bool TaoUniverseProxy::picked_uni() const {
  bool value;
  tao_universe_struct_get_picked_uni(get_fortran_ptr_(), &value);
  return value;
}