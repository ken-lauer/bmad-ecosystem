...
extern "C" void wake_sr_to_f (const CPP_wake_sr& C, Opaque_wake_sr_class* F) {
  ...
  if (n1_trans_wake != 0) {
    ...
    for (auto i{0}; i < n1_trans_wake; i++)
...
extern "C" void wake_sr_to_c2 (CPP_wake_sr& C, c_Char z_file, const Opaque_wake_sr_z_long_class
    *z_z_long, Opaque_wake_sr_mode_class **z_long_wake, Int n1_long_wake,
...
extern "C" void gen_grad_map_to_c2 (CPP_gen_grad_map& C, c_Char z_file, Opaque_gen_grad1_class
    **z_gg, Int n1_gg, c_Int &z_ele_anchor_pt, c_Int &z_field_type, c_Int &z_iz0, c_Int &z_iz1,
    c_Real &z_dz, c_RealArr z_r0, c_Real &z_field_scale, c_Int &z_master_parameter, c_Bool
    &z_curved_ref_frame) {
...
extern "C" void photon_element_to_c2 (CPP_photon_element& C, const
    ...
    *z_reflectivity_table_pi, Opaque_spline_class **z_init_energy_prob, Int
    n1_init_energy_prob, c_RealArr z_integrated_init_energy_prob, Int
