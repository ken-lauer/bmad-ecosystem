...
bool operator==(const CPP_cartesian_map& x, const CPP_cartesian_map& y) {
  ...
  is_eq = is_eq && (x.ptr.has_value() == y.ptr.has_value());
  if (!is_eq)
    return false;
  if (x.ptr)
    is_eq = (*x.ptr == *y.ptr);
...
bool operator==(const CPP_xy_disp& x, const CPP_xy_disp& y) {
  ...
  is_eq = is_eq && (x.deta_dpz == y.deta_dpz);
  is_eq = is_eq && (x.detap_dpz == y.detap_dpz);
  return is_eq;
};
...
bool operator==(const CPP_wall3d_section& x, const CPP_wall3d_section& y) {
  ...
  is_eq = is_eq && (x.material == y.material);
  is_eq = is_eq && is_all_equal(x.v, y.v);
  is_eq = is_eq && (x.surface.has_value() == y.surface.has_value());
  if (!is_eq)
    return false;
  if (x.surface)
    is_eq = (*x.surface == *y.surface);
  is_eq = is_eq && (x.type == y.type);
...
bool operator==(const CPP_ramper_lord& x, const CPP_ramper_lord& y) {
  ...
  is_eq = is_eq && (x.attrib_ptr.has_value() == y.attrib_ptr.has_value());
  if (!is_eq)
    return false;
  if (x.attrib_ptr)
    is_eq = (*x.attrib_ptr == *y.attrib_ptr);
  return is_eq;
};
...
bool operator==(
  ...
  is_eq =
      is_eq && is_all_equal(x.space_charge_mesh_size, y.space_charge_mesh_size);
...
bool operator==(const CPP_bmad_common& x, const CPP_bmad_common& y) {
  ...
  is_eq =
      is_eq && (x.fatal_ds_adaptive_tracking == y.fatal_ds_adaptive_tracking);
...
bool operator==(const CPP_rf_stair_step& x, const CPP_rf_stair_step& y) {
  ...
  is_eq = is_eq && (x.time == y.time);
  is_eq = is_eq && (x.s == y.s);
  is_eq = is_eq && (x.ix_step == y.ix_step);
  return is_eq;
};

//--------------------------------------------------------------

bool operator==(const CPP_rf_ele& x, const CPP_rf_ele& y) {
  bool is_eq = true;
  is_eq = is_eq && is_all_equal(x.steps, y.steps);
  is_eq = is_eq && (x.ds_step == y.ds_step);
  return is_eq;
};
...
bool operator==(const CPP_ele& x, const CPP_ele& y) {
  ...
  is_eq = is_eq && (x.descrip.has_value() == y.descrip.has_value());
  if (!is_eq)
    return false;
  if (x.descrip)
    is_eq = (*x.descrip == *y.descrip);
  is_eq = is_eq && (x.a == y.a);
  is_eq = is_eq && (x.b == y.b);
  is_eq = is_eq && (x.z == y.z);
  is_eq = is_eq && (x.x == y.x);
  is_eq = is_eq && (x.y == y.y);
  is_eq = is_eq && (x.ac_kick.has_value() == y.ac_kick.has_value());
  if (!is_eq)
    return false;
  if (x.ac_kick)
    is_eq = (*x.ac_kick == *y.ac_kick);
  is_eq = is_eq && (x.bookkeeping_state == y.bookkeeping_state);
  is_eq = is_eq && (x.control.has_value() == y.control.has_value());
  if (!is_eq)
    return false;
  if (x.control)
    is_eq = (*x.control == *y.control);
  is_eq = is_eq && (x.rf.has_value() == y.rf.has_value());
  if (!is_eq)
    return false;
  if (x.rf)
    is_eq = (*x.rf == *y.rf);
  ...
  if (x.high_energy_space_charge)
    is_eq = (*x.high_energy_space_charge == *y.high_energy_space_charge);
  is_eq = is_eq && (x.mode3.has_value() == y.mode3.has_value());
  if (!is_eq)
    return false;
  if (x.mode3)
    is_eq = (*x.mode3 == *y.mode3);
  is_eq = is_eq && (x.photon.has_value() == y.photon.has_value());
  if (!is_eq)
    return false;
  if (x.photon)
    is_eq = (*x.photon == *y.photon);
  is_eq = is_eq && (x.rad_map.has_value() == y.rad_map.has_value());
  if (!is_eq)
    return false;
  if (x.rad_map)
    is_eq = (*x.rad_map == *y.rad_map);
  is_eq = is_eq && is_all_equal(x.taylor, y.taylor);
  is_eq =
      is_eq && is_all_equal(x.spin_taylor_ref_orb_in, y.spin_taylor_ref_orb_in);
  is_eq = is_eq && is_all_equal(x.spin_taylor, y.spin_taylor);
  is_eq = is_eq && (x.wake.has_value() == y.wake.has_value());
  if (!is_eq)
    return false;
  if (x.wake)
    is_eq = (*x.wake == *y.wake);
  ...
  is_eq =
      is_eq && (x.taylor_map_includes_offsets == y.taylor_map_includes_offsets);
...
bool operator==(const CPP_branch& x, const CPP_branch& y) {
  ...
  is_eq = is_eq && (x.ix_fixer == y.ix_fixer);
...
bool operator==(const CPP_lat& x, const CPP_lat& y) {
  ...
  is_eq = is_eq && (x.a.has_value() == y.a.has_value());
  if (!is_eq)
    return false;
  if (x.a)
    is_eq = (*x.a == *y.a);
  is_eq = is_eq && (x.b.has_value() == y.b.has_value());
  if (!is_eq)
    return false;
  if (x.b)
    is_eq = (*x.b == *y.b);
  is_eq = is_eq && (x.z.has_value() == y.z.has_value());
  if (!is_eq)
    return false;
  if (x.z)
    is_eq = (*x.z == *y.z);
  is_eq = is_eq && (x.param.has_value() == y.param.has_value());
  if (!is_eq)
    return false;
  if (x.param)
  ...
  is_eq =
      is_eq && (x.particle_start.has_value() == y.particle_start.has_value());
  if (!is_eq)
    return false;
  if (x.particle_start)
    is_eq = (*x.particle_start == *y.particle_start);
  is_eq = is_eq && (x.beam_init == y.beam_init);
  is_eq = is_eq && (x.pre_tracker == y.pre_tracker);
  is_eq = is_eq && is_all_equal(x.custom, y.custom);
  is_eq = is_eq && (x.version == y.version);
  is_eq = is_eq && (x.n_ele_track.has_value() == y.n_ele_track.has_value());
  if (!is_eq)
    return false;
  if (x.n_ele_track)
    is_eq = (*x.n_ele_track == *y.n_ele_track);
  is_eq = is_eq && (x.n_ele_max.has_value() == y.n_ele_max.has_value());
  if (!is_eq)
    return false;
  if (x.n_ele_max)
    is_eq = (*x.n_ele_max == *y.n_ele_max);
