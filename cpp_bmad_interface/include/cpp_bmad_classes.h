...
public:
  ...
  friend ostream& operator<<(ostream& os, const CPP_cartesian_map& obj) {
    ...
    os << "ptr="; if (obj.ptr) os << *obj.ptr; else os << "nullptr, ";
    os << "}";
    return os;
  }
...
public:
  ...
  friend ostream& operator<<(ostream& os, const CPP_wall3d_section& obj) {
    ...
    os << "material=" << obj.material << ", ";
    os << "v=" << obj.v << ", ";
    os << "surface="; if (obj.surface) os << *obj.surface << ", "; else os << "nullptr, ";
    os << "type=" << obj.type << ", ";
...
public:
  ...
  friend ostream& operator<<(ostream& os, const CPP_ramper_lord& obj) {
    ...
    os << "attrib_ptr="; if (obj.attrib_ptr) os << *obj.attrib_ptr; else os << "nullptr, ";
    os << "}";
    return os;
  }
...
public:
  ...
  friend ostream& operator<<(ostream& os, const CPP_ele& obj) {
    ...
    os << "descrip="; if (obj.descrip) os << *obj.descrip << ", "; else os << "nullptr, ";
    os << "a=" << obj.a << ", ";
    os << "b=" << obj.b << ", ";
    os << "z=" << obj.z << ", ";
    os << "x=" << obj.x << ", ";
    os << "y=" << obj.y << ", ";
    os << "ac_kick="; if (obj.ac_kick) os << *obj.ac_kick << ", "; else os << "nullptr, ";
    os << "bookkeeping_state=" << obj.bookkeeping_state << ", ";
    os << "control="; if (obj.control) os << *obj.control << ", "; else os << "nullptr, ";
    os << "floor=" << obj.floor << ", ";
    os << "high_energy_space_charge="; if (obj.high_energy_space_charge) os << *obj.high_energy_space_charge << ", "; else os << "nullptr, ";
    os << "mode3="; if (obj.mode3) os << *obj.mode3 << ", "; else os << "nullptr, ";
    os << "photon="; if (obj.photon) os << *obj.photon << ", "; else os << "nullptr, ";
    os << "rad_map="; if (obj.rad_map) os << *obj.rad_map << ", "; else os << "nullptr, ";
    os << "taylor=" << obj.taylor << ", ";
    os << "spin_taylor_ref_orb_in=" << obj.spin_taylor_ref_orb_in << ", ";
    os << "spin_taylor=" << obj.spin_taylor << ", ";
    os << "wake="; if (obj.wake) os << *obj.wake << ", "; else os << "nullptr, ";
...
public:
  ...
  friend ostream& operator<<(ostream& os, const CPP_lat& obj) {
    ...
    os << "a="; if (obj.a) os << *obj.a << ", "; else os << "nullptr, ";
    os << "b="; if (obj.b) os << *obj.b << ", "; else os << "nullptr, ";
    os << "z="; if (obj.z) os << *obj.z << ", "; else os << "nullptr, ";
    os << "param="; if (obj.param) os << *obj.param << ", "; else os << "nullptr, ";
    ...
    os << "n_ele_track="; if (obj.n_ele_track) os << *obj.n_ele_track << ", "; else os << "nullptr, ";
    os << "n_ele_max="; if (obj.n_ele_max) os << *obj.n_ele_max << ", "; else os << "nullptr, ";
