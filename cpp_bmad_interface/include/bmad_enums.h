...
const int AUTO_APERTURE = 1, RECTANGULAR = 2, ELLIPTICAL = 3, WALL3D = 5,
          CUSTOM_APERTURE = 7;
...
const int CONTROL_VAR = 1, OLD_CONTROL_VAR = 2, ALL_CONTROL_VAR = 3,
          ELEC_MULTIPOLE = 4;
...
const int XFER_MAT_CALC_FAILURE = 7, TWISS_PROPAGATE_FAILURE = 8,
          NO_CLOSED_ORBIT = 9;
...
const int DEF_MAD_BEAM = 21, AB_MULTIPOLE = 22, SOLENOID = 23, PATCH = 24,
          LCAVITY = 25;
...
const int DEF_PARTICLE_START = 39, PHOTON_FORK = 40, FORK = 41, MIRROR = 42,
          CRYSTAL = 43;

const int PIPE = 44, CAPILLARY = 45, MULTILAYER_MIRROR = 46, E_GUN = 47,
          EM_FIELD = 48;

const int FLOOR_SHIFT = 49, FIDUCIAL = 50, UNDULATOR = 51,
          DIFFRACTION_PLATE = 52;

const int PHOTON_INIT = 53, SAMPLE = 54, DETECTOR = 55, SAD_MULT = 56,
          MASK = 57;

const int AC_KICKER = 58, LENS = 59, DEF_SPACE_CHARGE_COM = 60,
          CRAB_CAVITY = 61;
...
const int C11_MAT1 = 25, C12_MAT1 = 26, C21_MAT1 = 27, C22_MAT1 = 28,
          MODE_FLIP1 = 29;
...
const int REF_TILT = 3, DIRECTION = 3, REPETITION_FREQUENCY = 3,
          DETA_DS_MASTER = 3,

          KICK = 3, X_GAIN_ERR = 3, TAYLOR_ORDER = 3, R_SOLENOID = 3,
          FINAL_CHARGE = 3;
...
const int GRAZE_ANGLE = 5, K2 = 5, B_MAX = 5, V_DISPLACE = 5, GRADIENT_TOT = 5,
          HARMON_MASTER = 5,

          KS = 5, FLEXIBLE = 5, CRUNCH = 5, REF_ORBIT_FOLLOWS = 5,
          PC_OUT_MIN = 5;

const int GRADIENT = 6, K3 = 6, NOISE = 6, NEW_BRANCH = 6, IX_BRANCH = 6,
          G_MAX = 6,

          G = 6, SYMMETRY = 6, FIELD_SCALE_FACTOR = 6, PC_OUT_MAX = 6;

const int DG = 7, BBI_CONST = 7, OSC_AMPLITUDE = 7, IX_TO_BRANCH = 7,
          ANGLE_OUT_MAX = 7,

          GRADIENT_ERR = 7, CRITICAL_ANGLE = 7, BRAGG_ANGLE_IN = 7,
          SPIN_DN_DPZ_X = 7;

const int DELTA_E_REF = 8, INTERPOLATION = 8, BRAGG_ANGLE_OUT = 8, K1X = 8,
          SPIN_DN_DPZ_Y = 8,

          CHARGE = 8, X_GAIN_CALIB = 8, IX_TO_ELEMENT = 8, VOLTAGE = 8,
          G_TOT = 8;

const int RHO = 9, VOLTAGE_ERR = 9, BRAGG_ANGLE = 9, K1Y = 9, N_PARTICLE = 9,
          SPIN_DN_DPZ_Z = 9;
...
const int D1_THICKNESS = 20, DEFAULT_TRACKING_SPECIES = 20,
          AUTOSCALE_PHASE = 20,

          N_SLICE = 20, Y_GAIN_CALIB = 20, SIG_E2 = 20;

const int FB1 = 21, POLARITY = 21, CRUNCH_CALIB = 21, ALPHA_ANGLE = 21,
          D2_THICKNESS = 21,

          BETA_A_STRONG = 21, BETA_A_OUT = 21, E_LOSS = 21, GAP = 21,
          SPIN_X = 21,
...
const int FB2 = 22, X_OFFSET_CALIB = 22, V1_UNITCELL = 22, PSI_ANGLE = 22,
          ...
          BETA_B_STRONG = 22, BETA_B_OUT = 22, SPIN_Y = 22, E2_CENTER = 22,
          N_PERIOD = 22,
...
const int Y_OFFSET_CALIB = 23, V_UNITCELL = 23, V2_UNITCELL = 23, SPIN_Z = 23,
          ...
          FQ1 = 23, ALPHA_A_STRONG = 23, ALPHA_A_OUT = 23, E2_PROBABILITY = 23,
          PHI0_MAX = 23,
...
const int FQ2 = 24, PHI0 = 24, TILT_CALIB = 24, E_CENTER_RELATIVE_TO_REF = 24,
          ...
          ALPHA_B_STRONG = 24, ALPHA_B_OUT = 24, IS_MOSAIC = 24,
          PX_APERTURE_WIDTH2 = 24;

const int PHI0_ERR = 25, CURRENT = 25, MOSAIC_THICKNESS = 25,
          PX_APERTURE_CENTER = 25,

          ETA_X_OUT = 25, QUAD_TILT = 25, DE_ETA_MEAS = 25,
          SPATIAL_DISTRIBUTION = 25,

          Y2_EDGE = 25, SPECIES_STRONG = 25;

const int ETA_Y_OUT = 26, MODE = 26, VELOCITY_DISTRIBUTION = 26,
          PY_APERTURE_WIDTH2 = 26,

          PHI0_MULTIPASS = 26, N_SAMPLE = 26, ORIGIN_ELE_REF_PT = 26,
          MOSAIC_ANGLE_RMS_IN_PLANE = 26,

          EPS_STEP_SCALE = 26, E_TOT_STRONG = 26, DTHICKNESS_DX = 26,
          BEND_TILT = 26;

const int ETAP_X_OUT = 27, PHI0_AUTOSCALE = 27, DX_ORIGIN = 27,
...
const int CMAT_12 = 30, DTHETA_ORIGIN = 30, B_PARAM = 30, L_CHORD = 30,
          ...
          DOWNSTREAM_COORD_DIR = 30, PZ_APERTURE_WIDTH2 = 30,
          Y_DISPERSION_CALIB = 30,

          SCALE_FIELD_TO_ONE = 30, VOLTAGE_TOT = 30, SCATTER_METHOD = 30;

const int CMAT_21 = 31, L_ACTIVE = 31, DPHI_ORIGIN = 31, SPLIT_ID = 31,
          REF_CAP_GAMMA = 31,
...
const int CMAT_22 = 32, DPSI_ORIGIN = 32, T_OFFSET = 32, DS_SLICE = 32,
          USE_REFLECTIVITY_TABLE = 32, INIT_NEEDED = 32;
...
const int BL_KICK = 43, B_FIELD = 43, E_FIELD = 43,
          HIGH_ENERGY_SPACE_CHARGE_ON = 43, CRAB_X4 = 43;

const int PHOTON_TYPE = 44, COUPLER_PHASE = 44, DB_FIELD = 44, CRAB_X5 = 44;

const int LATTICE_TYPE = 45, B1_GRADIENT = 45, E1_GRADIENT = 45,
          COUPLER_ANGLE = 45;

const int LIVE_BRANCH = 46, B2_GRADIENT = 46, E2_GRADIENT = 46,
          COUPLER_STRENGTH = 46;

const int GEOMETRY = 47, COUPLER_AT = 47, E_TOT_OFFSET = 47,
...
const int ELECTRIC_DIPOLE_MOMENT = 83, LR_SELF_WAKE_ON = 83, X_REF = 83,
          SPECIES_OUT = 83;
...
const int APERTURE_LIMIT_ON = 99, ALPHA_A = 99, REFLECTIVITY_TABLE = 99,
...
const int INVALID_NAME = 0, IS_LOGICAL = 1, IS_INTEGER = 2, IS_REAL = 3,
          IS_SWITCH = 4, IS_STRING = 5;
...
const int MASS_OF = 31, CHARGE_OF = 32, ANOMALOUS_MOMENT_OF = 33, SPECIES = 34,
          SPECIES_CONST = 35;

const int SINC = 36, CONSTANT = 37, COMMA = 38, RMS = 39, AVERAGE = 40,
          SUM = 41, L_FUNC_PARENS = 42;

const int ARG_COUNT = 43, ANTIPARTICLE = 44, COT = 45, SEC = 46, CSC = 47,
          SIGN = 48;

const int SINH = 49, COSH = 50, TANH = 51, COTH = 52, ASINH = 53, ACOSH = 54,
          ATANH = 55, ACOTH = 56;
