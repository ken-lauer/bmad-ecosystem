...
call test1_f_wake_sr_z_long(ok); if (.not. ok) all_ok = .false.
...
call test1_f_bicubic_cmplx_coef(ok); if (.not. ok) all_ok = .false.
call test1_f_tricubic_cmplx_coef(ok); if (.not. ok) all_ok = .false.
...
call test1_f_surface_segmented_pt(ok); if (.not. ok) all_ok = .false.
call test1_f_surface_segmented(ok); if (.not. ok) all_ok = .false.
call test1_f_surface_h_misalign_pt(ok); if (.not. ok) all_ok = .false.
call test1_f_surface_h_misalign(ok); if (.not. ok) all_ok = .false.
call test1_f_surface_displacement_pt(ok); if (.not. ok) all_ok = .false.
call test1_f_surface_displacement(ok); if (.not. ok) all_ok = .false.
...
call test1_f_ele_reference(ok); if (.not. ok) all_ok = .false.
call test1_f_branch_reference(ok); if (.not. ok) all_ok = .false.
call test1_f_rf_stair_step(ok); if (.not. ok) all_ok = .false.
call test1_f_rf_ele(ok); if (.not. ok) all_ok = .false.
