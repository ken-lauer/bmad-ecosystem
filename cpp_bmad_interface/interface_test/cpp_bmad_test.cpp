...
extern "C" void test_c_ac_kicker_time(
...
extern "C" void test_c_ac_kicker_freq(
...
extern "C" void test_c_interval1_coef(
...
void set_CPP_photon_reflect_table_test_pattern(
...
extern "C" void test_c_photon_reflect_table(
...
extern "C" void test2_f_photon_reflect_surface(
    CPP_photon_reflect_surface&,
    bool&);

void set_CPP_photon_reflect_surface_test_pattern(
...
extern "C" void test_c_photon_reflect_surface(
...
void set_CPP_bpm_phase_coupling_test_pattern(
...
extern "C" void test_c_bpm_phase_coupling(
...
extern "C" void test_c_expression_atom(
...
extern "C" void test_c_wake_sr_z_long(
...
extern "C" void test_c_em_taylor_term(
...
void set_CPP_cartesian_map_term1_test_pattern(
...
extern "C" void test_c_cartesian_map_term1(
...
void set_CPP_cartesian_map_term_test_pattern(
...
extern "C" void test_c_cartesian_map_term(
...
extern "C" void test_c_cartesian_map(
...
extern "C" void test2_f_cylindrical_map_term1(
    CPP_cylindrical_map_term1&,
    bool&);

void set_CPP_cylindrical_map_term1_test_pattern(
...
extern "C" void test_c_cylindrical_map_term1(
...
void set_CPP_cylindrical_map_term_test_pattern(
...
extern "C" void test_c_cylindrical_map_term(
...
extern "C" void test_c_cylindrical_map(
...
extern "C" void test_c_grid_field_pt1(
...
extern "C" void test_c_grid_field_pt(
...
extern "C" void test_c_floor_position(
...
extern "C" void test2_f_high_energy_space_charge(
...
extern "C" void test_c_high_energy_space_charge(
...
void set_CPP_bookkeeping_state_test_pattern(
...
extern "C" void test_c_bookkeeping_state(
...
void set_CPP_surface_segmented_pt_test_pattern(
...
extern "C" void test_c_surface_segmented_pt(
...
void set_CPP_surface_segmented_test_pattern(
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto& item = C.pt[i][j];
        set_CPP_surface_segmented_pt_test_pattern(
            item, ix_patt + i + 2 * j + 3);
      }
    }
  }
}
...
extern "C" void test_c_surface_segmented(
...
extern "C" void test2_f_surface_h_misalign_pt(
    CPP_surface_h_misalign_pt&,
    bool&);

void set_CPP_surface_h_misalign_pt_test_pattern(
...
extern "C" void test_c_surface_h_misalign_pt(
...
void set_CPP_surface_h_misalign_test_pattern(
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto& item = C.pt[i][j];
        set_CPP_surface_h_misalign_pt_test_pattern(
            item, ix_patt + i + 2 * j + 3);
      }
    }
  }
...
extern "C" void test_c_surface_h_misalign(
...
extern "C" void test2_f_surface_displacement_pt(
...
extern "C" void test_c_surface_displacement_pt(
...
void set_CPP_surface_displacement_test_pattern(
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto& item = C.pt[i][j];
        set_CPP_surface_displacement_pt_test_pattern(
            item, ix_patt + i + 2 * j + 3);
      }
    }
  }
...
extern "C" void test_c_surface_displacement(
...
void set_CPP_surface_curvature_test_pattern(
...
extern "C" void test_c_surface_curvature(
...
extern "C" void test_c_photon_target(
...
extern "C" void test_c_photon_material(
...
void set_CPP_photon_element_test_pattern(CPP_photon_element& C, int ix_patt) {
  ...
  set_CPP_photon_reflect_table_test_pattern(
      C.reflectivity_table_sigma, ix_patt);
  // c_side.test_pat[0D_NOT_type]
...
extern "C" void test_c_photon_element(
...
extern "C" void test_c_wall3d_vertex(
...
extern "C" void test_c_wall3d_section(
...
extern "C" void test_c_control_ramp1(
...
void set_CPP_ellipse_beam_init_test_pattern(
...
extern "C" void test_c_ellipse_beam_init(
...
extern "C" void test_c_grid_beam_init(
...
void set_CPP_linac_normal_mode_test_pattern(
...
extern "C" void test_c_linac_normal_mode(
...
void set_CPP_space_charge_common_test_pattern(
...
extern "C" void test_c_space_charge_common(
...
extern "C" void test_c_rad_int_branch(
...
extern "C" void test_c_rad_int_all_ele(
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.cylindrical_map.size(); i++) {
      set_CPP_cylindrical_map_test_pattern(
          C.cylindrical_map[i], ix_patt + i + 1);
    }
  }
  // c_side.test_pat[1D_PTR_type]
  if (ix_patt < 3) {
...
void set_CPP_complex_taylor_term_test_pattern(
...
extern "C" void test_c_complex_taylor_term(
...
extern "C" void test_c_complex_taylor(
...
extern "C" void test_c_aperture_point(
...
extern "C" void test_c_aperture_param(
...
extern "C" void test_c_aperture_scan(
