...
extern "C" void test_c_ac_kicker_time(Opaque_ac_kicker_time_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_ac_kicker_freq(Opaque_ac_kicker_freq_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_interval1_coef(Opaque_interval1_coef_class *F,
                                      bool &c_ok) {
...
extern "C" void test2_f_photon_reflect_table(CPP_photon_reflect_table &,
                                             bool &);

void set_CPP_photon_reflect_table_test_pattern(CPP_photon_reflect_table &C,
                                               int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.p_reflect.size(); i++) {
      ...
      for (size_t j{0}; j < C.p_reflect[0].size(); j++) {
...
extern "C" void
test_c_photon_reflect_table(Opaque_photon_reflect_table_class *F, bool &c_ok) {
...
extern "C" void test2_f_photon_reflect_surface(CPP_photon_reflect_surface &,
                                               bool &);

void set_CPP_photon_reflect_surface_test_pattern(CPP_photon_reflect_surface &C,
                                                 int ix_patt) {
...
extern "C" void
test_c_photon_reflect_surface(Opaque_photon_reflect_surface_class *F,
                              bool &c_ok) {
...
void set_CPP_bpm_phase_coupling_test_pattern(CPP_bpm_phase_coupling &C,
                                             int ix_patt) {
...
extern "C" void test_c_bpm_phase_coupling(Opaque_bpm_phase_coupling_class *F,
                                          bool &c_ok) {
...
extern "C" void test_c_expression_atom(Opaque_expression_atom_class *F,
                                       bool &c_ok) {
...
extern "C" void test_c_wake_sr_z_long(Opaque_wake_sr_z_long_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_em_taylor_term(Opaque_em_taylor_term_class *F,
                                      bool &c_ok) {
...
void set_CPP_cartesian_map_term1_test_pattern(CPP_cartesian_map_term1 &C,
                                              int ix_patt) {
...
extern "C" void test_c_cartesian_map_term1(Opaque_cartesian_map_term1_class *F,
                                           bool &c_ok) {
...
void set_CPP_cartesian_map_term_test_pattern(CPP_cartesian_map_term &C,
                                             int ix_patt) {
...
extern "C" void test_c_cartesian_map_term(Opaque_cartesian_map_term_class *F,
                                          bool &c_ok) {
...
extern "C" void test_c_cartesian_map(Opaque_cartesian_map_class *F,
                                     bool &c_ok) {
...
extern "C" void test2_f_cylindrical_map_term1(CPP_cylindrical_map_term1 &,
                                              bool &);

void set_CPP_cylindrical_map_term1_test_pattern(CPP_cylindrical_map_term1 &C,
                                                int ix_patt) {
...
extern "C" void
test_c_cylindrical_map_term1(Opaque_cylindrical_map_term1_class *F,
                             bool &c_ok) {
...
extern "C" void test2_f_cylindrical_map_term(CPP_cylindrical_map_term &,
                                             bool &);

void set_CPP_cylindrical_map_term_test_pattern(CPP_cylindrical_map_term &C,
                                               int ix_patt) {
...
extern "C" void
test_c_cylindrical_map_term(Opaque_cylindrical_map_term_class *F, bool &c_ok) {
...
extern "C" void test_c_cylindrical_map(Opaque_cylindrical_map_class *F,
                                       bool &c_ok) {
...
extern "C" void test_c_grid_field_pt1(Opaque_grid_field_pt1_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_grid_field_pt(Opaque_grid_field_pt_class *F,
                                     bool &c_ok) {
...
extern "C" void test_c_floor_position(Opaque_floor_position_class *F,
                                      bool &c_ok) {
...
extern "C" void test2_f_high_energy_space_charge(CPP_high_energy_space_charge &,
                                                 bool &);

void set_CPP_high_energy_space_charge_test_pattern(
    CPP_high_energy_space_charge &C, int ix_patt) {
...
extern "C" void
test_c_high_energy_space_charge(Opaque_high_energy_space_charge_class *F,
                                bool &c_ok) {
  ...
  if (C == C2) {
    ...
    cout << " [1] high_energy_space_charge: C SIDE CONVERT F->C: FAILED!"
         << endl;
...
void set_CPP_bookkeeping_state_test_pattern(CPP_bookkeeping_state &C,
                                            int ix_patt) {
...
extern "C" void test_c_bookkeeping_state(Opaque_bookkeeping_state_class *F,
                                         bool &c_ok) {
...
void set_CPP_rad_map_test_pattern(CPP_rad_map &C, int ix_patt) {
  ...
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.damp_dmat.size(); i++)
    for (size_t j{0}; j < C.damp_dmat[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 2 + offset;
      C.damp_dmat[i][j] = rhs;
    }
  // c_side.test_pat[1D_NOT_real]
  ...
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.xfer_damp_mat.size(); i++)
    for (size_t j{0}; j < C.xfer_damp_mat[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 4 + offset;
      C.xfer_damp_mat[i][j] = rhs;
    }
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.stoc_mat.size(); i++)
    for (size_t j{0}; j < C.stoc_mat[0].size(); j++) {
...
void set_CPP_gen_grad1_test_pattern(CPP_gen_grad1 &C, int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.deriv.size(); i++) {
      C.deriv[i].resize(2);
      for (size_t j{0}; j < C.deriv[0].size(); j++) {
        int rhs = 101 + i + 10 * (j + 1) + 4 + offset;
        C.deriv[i][j] = rhs;
      }
    }
...
extern "C" void test2_f_surface_segmented_pt(CPP_surface_segmented_pt &,
                                             bool &);

void set_CPP_surface_segmented_pt_test_pattern(CPP_surface_segmented_pt &C,
                                               int ix_patt) {
...
extern "C" void
test_c_surface_segmented_pt(Opaque_surface_segmented_pt_class *F, bool &c_ok) {
...
void set_CPP_surface_segmented_test_pattern(CPP_surface_segmented &C,
                                            int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto &item = C.pt[i][j];
        set_CPP_surface_segmented_pt_test_pattern(item,
                                                  ix_patt + i + 2 * j + 3);
      }
    }
  }
...
extern "C" void test_c_surface_segmented(Opaque_surface_segmented_class *F,
                                         bool &c_ok) {
...
extern "C" void test2_f_surface_h_misalign_pt(CPP_surface_h_misalign_pt &,
                                              bool &);

void set_CPP_surface_h_misalign_pt_test_pattern(CPP_surface_h_misalign_pt &C,
                                                int ix_patt) {
...
extern "C" void
test_c_surface_h_misalign_pt(Opaque_surface_h_misalign_pt_class *F,
                             bool &c_ok) {
...
void set_CPP_surface_h_misalign_test_pattern(CPP_surface_h_misalign &C,
                                             int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto &item = C.pt[i][j];
        set_CPP_surface_h_misalign_pt_test_pattern(item,
                                                   ix_patt + i + 2 * j + 3);
      }
    }
  }
...
extern "C" void test_c_surface_h_misalign(Opaque_surface_h_misalign_class *F,
                                          bool &c_ok) {
...
extern "C" void test2_f_surface_displacement_pt(CPP_surface_displacement_pt &,
                                                bool &);

void set_CPP_surface_displacement_pt_test_pattern(
    CPP_surface_displacement_pt &C, int ix_patt) {
...
extern "C" void
test_c_surface_displacement_pt(Opaque_surface_displacement_pt_class *F,
                               bool &c_ok) {
  ...
  if (C == C2) {
    ...
    cout << " [1] surface_displacement_pt: C SIDE CONVERT F->C: FAILED!"
         << endl;
...
extern "C" void test2_f_surface_displacement(CPP_surface_displacement &,
                                             bool &);

void set_CPP_surface_displacement_test_pattern(CPP_surface_displacement &C,
                                               int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.pt.size(); i++) {
      ...
      for (size_t j{0}; j < C.pt[0].size(); j++) {
        auto &item = C.pt[i][j];
        set_CPP_surface_displacement_pt_test_pattern(item,
                                                     ix_patt + i + 2 * j + 3);
      }
    }
  }
...
extern "C" void
test_c_surface_displacement(Opaque_surface_displacement_class *F, bool &c_ok) {
...
void set_CPP_surface_curvature_test_pattern(CPP_surface_curvature &C,
                                            int ix_patt) {
  ...
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.xy.size(); i++)
    for (size_t j{0}; j < C.xy[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 1 + offset;
      C.xy[i][j] = rhs;
    }
  // c_side.test_pat[0D_NOT_real]
...
extern "C" void test_c_surface_curvature(Opaque_surface_curvature_class *F,
                                         bool &c_ok) {
...
extern "C" void test_c_photon_target(Opaque_photon_target_class *F,
                                     bool &c_ok) {
...
extern "C" void test_c_photon_material(Opaque_photon_material_class *F,
                                       bool &c_ok) {
...
void set_CPP_photon_element_test_pattern(CPP_photon_element &C, int ix_patt) {
  ...
  // c_side.test_pat[0D_NOT_type]
  set_CPP_photon_reflect_table_test_pattern(C.reflectivity_table_sigma,
                                            ix_patt);
  // c_side.test_pat[0D_NOT_type]
...
extern "C" void test_c_photon_element(Opaque_photon_element_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_wall3d_vertex(Opaque_wall3d_vertex_class *F,
                                     bool &c_ok) {
...
extern "C" void test_c_wall3d_section(Opaque_wall3d_section_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_control_ramp1(Opaque_control_ramp1_class *F,
                                     bool &c_ok) {
...
void set_CPP_ellipse_beam_init_test_pattern(CPP_ellipse_beam_init &C,
                                            int ix_patt) {
...
extern "C" void test_c_ellipse_beam_init(Opaque_ellipse_beam_init_class *F,
                                         bool &c_ok) {
...
extern "C" void test_c_grid_beam_init(Opaque_grid_beam_init_class *F,
                                      bool &c_ok) {
...
void set_CPP_beam_init_test_pattern(CPP_beam_init &C, int ix_patt) {
  ...
  for (size_t i{0}; i < C.distribution_type.size(); i++) {
    ...
    for (size_t j{0}; j < C.distribution_type[i].size(); j++) {
      C.distribution_type[i][j] =
          'a' + (101 + i + 10 * (j + 1) + 2 + offset) % 26;
    }
  }
  // c_side.test_pat[1D_NOT_real]
  for (size_t i{0}; i < C.spin.size(); i++) {
...
void set_CPP_lat_param_test_pattern(CPP_lat_param &C, int ix_patt) {
  ...
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.t1_with_RF.size(); i++)
    for (size_t j{0}; j < C.t1_with_RF[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 4 + offset;
      C.t1_with_RF[i][j] = rhs;
    }
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.t1_no_RF.size(); i++)
    for (size_t j{0}; j < C.t1_no_RF[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 5 + offset;
      C.t1_no_RF[i][j] = rhs;
    }
  // c_side.test_pat[0D_NOT_real]
...
void set_CPP_linac_normal_mode_test_pattern(CPP_linac_normal_mode &C,
                                            int ix_patt) {
...
extern "C" void test_c_linac_normal_mode(Opaque_linac_normal_mode_class *F,
                                         bool &c_ok) {
...
void set_CPP_em_field_test_pattern(CPP_em_field &C, int ix_patt) {
  ...
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.dE.size(); i++)
    for (size_t j{0}; j < C.dE[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 3 + offset;
      C.dE[i][j] = rhs;
    }
  // c_side.test_pat[2D_NOT_real]
  for (size_t i{0}; i < C.dB.size(); i++)
    for (size_t j{0}; j < C.dB[0].size(); j++) {
      int rhs = 101 + i + 10 * (j + 1) + 4 + offset;
      C.dB[i][j] = rhs;
    }
  // c_side.test_pat[0D_NOT_real]
...
void set_CPP_space_charge_common_test_pattern(CPP_space_charge_common &C,
                                              int ix_patt) {
  ...
  for (size_t i{0}; i < C.diagnostic_output_file.size(); i++) {
    ...
    C.diagnostic_output_file[i] = 'a' + rhs % 26;
  }
}

//--------------------------------------------------------------

extern "C" void test_c_space_charge_common(Opaque_space_charge_common_class *F,
                                           bool &c_ok) {
...
extern "C" void test_c_rad_int_branch(Opaque_rad_int_branch_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_rad_int_all_ele(Opaque_rad_int_all_ele_class *F,
                                       bool &c_ok) {
...
void set_CPP_ele_test_pattern(CPP_ele &C, int ix_patt) {
  ...
  if (ix_patt < 3) {
    ...
    set_CPP_high_energy_space_charge_test_pattern(
        C.high_energy_space_charge.value(), ix_patt);
  }
  // c_side.test_pat[0D_PTR_type]
  if (ix_patt < 3) {
    C.mode3.reset();
  ...
  if (ix_patt < 3) {
    ...
    for (size_t i{0}; i < C.cylindrical_map.size(); i++) {
      set_CPP_cylindrical_map_test_pattern(C.cylindrical_map[i],
                                           ix_patt + i + 1);
    }
  }
  // c_side.test_pat[1D_PTR_type]
...
void set_CPP_complex_taylor_term_test_pattern(CPP_complex_taylor_term &C,
                                              int ix_patt) {
...
extern "C" void test_c_complex_taylor_term(Opaque_complex_taylor_term_class *F,
                                           bool &c_ok) {
...
extern "C" void test_c_complex_taylor(Opaque_complex_taylor_class *F,
                                      bool &c_ok) {
...
void set_CPP_bunch_params_test_pattern(CPP_bunch_params &C, int ix_patt) {
  ...
  for (size_t i{0}; i < C.sigma.size(); i++)
    for (size_t j{0}; j < C.sigma[0].size(); j++) {
...
extern "C" void test_c_aperture_point(Opaque_aperture_point_class *F,
                                      bool &c_ok) {
...
void set_CPP_aperture_param_test_pattern(CPP_aperture_param &C, int ix_patt) {
  ...
  for (size_t i{0}; i < C.start_ele.size(); i++) {
    int rhs = 101 + i + 9 + offset;
    C.start_ele[i] = 'a' + rhs % 26;
  }
}

//--------------------------------------------------------------

extern "C" void test_c_aperture_param(Opaque_aperture_param_class *F,
                                      bool &c_ok) {
...
extern "C" void test_c_aperture_scan(Opaque_aperture_scan_class *F,
                                     bool &c_ok) {
