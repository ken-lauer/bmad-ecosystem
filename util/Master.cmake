...
IF (DEBUG)
  ...
  # set (BASE_CXX_FLAGS "${BASE_CXX_FLAGS} -fsanitize=address,undefined -DPYBIND11_DETAILED_ERROR_MESSAGES -fno-omit-frame-pointer -fstack-protector-all -ftrapv")
  # set (CMAKE_CXX_STANDARD_LIBRARIES "${CMAKE_CXX_STANDARD_LIBRARIES} -fsanitize=address -dynamic-libsan")
ELSE ()
