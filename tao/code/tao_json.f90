...
subroutine tao_c_interface_common_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%c_integer)) then
    !line=18 definition='integer(c_int), allocatable :: c_integer(:)' name='c_integer' python_name='c_integer' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default=None default=0 default_factory=''
  ...
  !line=19 definition='character(c_char) :: c_line(n_char_show+1)' name='c_line' python_name='c_line' type='character' python_type='str' size=None dimension='n_char_show+1' comment='' fortran_default=None default='' default_factory=''
  ...
  if (allocated(input%c_real)) then
    !line=17 definition='real(c_double), allocatable :: c_real(:)' name='c_real' python_name='c_real' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine tao_design_lat_input_to_json (input, json_root, depth)
  ...
  !line=177 definition="character(40) :: use_element_range(2) = ''" name='use_element_range' python_name='use_element_range' type='character' python_type='str' size='40' dimension='2' comment='' fortran_default="''" default='' default_factory=''
...
subroutine tao_graph_input_to_json (input, json_root, depth)
  ...
  !line=120 definition='integer :: box(4) = [1, 1, 1, 1]' name='box' python_name='box' type='integer' python_type='int' size=None dimension='4' comment='' fortran_default='[1, 1, 1, 1]' default=[1, 1, 1, 1] default_factory=''
  ...
  !line=117 definition="character(100) :: text_legend(10) = ''" name='text_legend' python_name='text_legend' type='character' python_type='str' size='100' dimension='10' comment='' fortran_default="''" default='' default_factory=''
...
subroutine tao_plot_page_input_to_json (input, json_root, depth)
  ...
  !line=198 definition='real(rp) :: size(2) = 0.0' name='size' python_name='size' type='real' python_type='float' size=None dimension='2' comment='width and height of window in pixels.' fortran_default='0.0' default=0.0 default_factory=''
...
subroutine tao_region_input_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=71 definition='real(rp) :: location(4) = 0' name='location' python_name='location' type='real' python_type='float' size=None dimension='4' comment='location on page.' fortran_default='0' default=0 default_factory=''
...
subroutine tao_beam_shake_struct_to_json (input, json_root, depth)
  ...
  !line=839 definition='real(rp) cbar(2,2)' name='cbar' python_name='cbar' type='real' python_type='float' size=None dimension='2,2' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine tao_building_wall_section_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%point)) then
    !line=626 definition='type (tao_building_wall_point_struct), allocatable :: point(:)' name='point' python_name='point' type='tao_building_wall_point_struct' python_type='TaoBuildingWallPointStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_building_wall_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%section)) then
    !line=631 definition='type (tao_building_wall_section_struct), allocatable :: section(:)' name='section' python_name='section' type='tao_building_wall_section_struct' python_type='TaoBuildingWallSectionStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_command_file_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=719 definition="character(40) :: cmd_arg(9) = ''" name='cmd_arg' python_name='cmd_arg' type='character' python_type='str' size='40' dimension='9' comment='Command file arguments.' fortran_default="''" default='' default_factory=''
...
subroutine tao_common_struct_to_json (input, json_root, depth)
  ...
  !line=741 definition='type (tao_alias_struct) :: alias(200) = tao_alias_struct()' name='alias' python_name='alias' type='tao_alias_struct' python_type='TaoAliasStruct' size=None dimension='200' comment='' fortran_default='tao_alias_struct()' default=None default_factory=''
  ...
  if (allocated(input%alpha)) then
    !line=747 definition='real(rp), allocatable :: covar(:,:), alpha(:,:)' name='alpha' python_name='alpha' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%cmd_file)) then
    !line=743 definition='type (tao_command_file_struct), allocatable :: cmd_file(:)' name='cmd_file' python_name='cmd_file' type='tao_command_file_struct' python_type='TaoCommandFileStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%covar)) then
    !line=747 definition='real(rp), allocatable :: covar(:,:), alpha(:,:)' name='covar' python_name='covar' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%do_loop)) then
    !line=746 definition='type (do_loop_struct), allocatable :: do_loop(:)' name='do_loop' python_name='do_loop' type='do_loop_struct' python_type='DoLoopStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  !line=775 definition='logical :: is_err_message_printed(2) = .false.' name='is_err_message_printed' python_name='is_err_message_printed' type='logical' python_type='bool' size=None dimension='2' comment='Used by tao_set_invalid' fortran_default='.false.' default=False default_factory=''
  ...
  !line=742 definition='type (tao_alias_struct) :: key(100) = tao_alias_struct()' name='key' python_name='key' type='tao_alias_struct' python_type='TaoAliasStruct' size=None dimension='100' comment='' fortran_default='tao_alias_struct()' default=None default_factory=''
  ...
  if (allocated(input%plot_place_buffer)) then
    !line=745 definition='type (tao_plot_region_struct), allocatable :: plot_place_buffer(:)' name='plot_place_buffer' python_name='plot_place_buffer' type='tao_plot_region_struct' python_type='TaoPlotRegionStruct' size=None dimension=':' comment='Used when %external_plotting is on.' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%symbolic_num)) then
    !line=744 definition='type (named_number_struct), allocatable :: symbolic_num(:)' name='symbolic_num' python_name='symbolic_num' type='named_number_struct' python_type='NamedNumberStruct' size=None dimension=':' comment='Named numbers' fortran_default=None default=None default_factory=''
  ...
  !line=783 definition="character(16) :: valid_plot_who(10) = ''" name='valid_plot_who' python_name='valid_plot_who' type='character' python_type='str' size='16' dimension='10' comment='model, base, ref etc...' fortran_default="''" default='' default_factory=''
...
subroutine tao_curve_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%err_symb)) then
    !line=210 definition='real(rp), allocatable :: err_symb(:)' name='err_symb' python_name='err_symb' type='real' python_type='float' size=None dimension=':' comment='Error bars' fortran_default=None default=0.0 default_factory=''
  ...
  ! parent pointer skip: g (tao_graph_struct, pointer to parent graph)
  call tao_histogram_struct_to_json(input%hist, json_val, depth + 1)
  call json%rename(json_val, 'hist')
  call json%add(json_root, json_val)
  call json%add(json_root, 'ix_branch', int(input%ix_branch))
  ...
  if (allocated(input%ix_line)) then
    !line=206 definition='integer, allocatable :: ix_line(:)' name='ix_line' python_name='ix_line' type='integer' python_type='int' size=None dimension=':' comment='Used by wave and aperture curves.' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%ix_symb)) then
    !line=212 definition='integer, allocatable :: ix_symb(:)' name='ix_symb' python_name='ix_symb' type='integer' python_type='int' size=None dimension=':' comment='Corresponding index in d1_data%d(:) array.' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%symb_size)) then
    !line=211 definition='real(rp), allocatable :: symb_size(:)' name='symb_size' python_name='symb_size' type='real' python_type='float' size=None dimension=':' comment='Symbol size. Used with symbol_size_scale.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%x_line)) then
    !line=203 definition='real(rp), allocatable :: x_line(:)' name='x_line' python_name='x_line' type='real' python_type='float' size=None dimension=':' comment='Coords for drawing a curve' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%x_symb)) then
    !line=207 definition='real(rp), allocatable :: x_symb(:)' name='x_symb' python_name='x_symb' type='real' python_type='float' size=None dimension=':' comment='Coords for drawing the symbols' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%y2_line)) then
    !line=205 definition='real(rp), allocatable :: y2_line(:)' name='y2_line' python_name='y2_line' type='real' python_type='float' size=None dimension=':' comment='Second array needed for beam chamber curve.' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%y_line)) then
    !line=204 definition='real(rp), allocatable :: y_line(:)' name='y_line' python_name='y_line' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%y_symb)) then
    !line=208 definition='real(rp), allocatable :: y_symb(:)' name='y_symb' python_name='y_symb' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%z_symb)) then
    !line=209 definition='real(rp), allocatable :: z_symb(:)' name='z_symb' python_name='z_symb' type='real' python_type='float' size=None dimension=':' comment='Symbol color' fortran_default=None default=0.0 default_factory=''
...
subroutine tao_d1_data_struct_to_json (input, json_root, depth)
  ...
  if (associated(input%d)) then
    !line=478 definition='type (tao_data_struct), pointer :: d(:) => null()' name='d' python_name='d' type='tao_data_struct' python_type='TaoDataStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
  ...
  ! parent pointer skip: d2 (tao_d2_data_struct, ptr to parent d2_data)
  call json%add(json_root, 'name', trim(input%name))
...
subroutine tao_d2_data_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%d1)) then
    !line=494 definition='type (tao_d1_data_struct), allocatable :: d1(:)' name='d1' python_name='d1' type='tao_d1_data_struct' python_type='TaoD1DataStruct' size=None dimension=':' comment='Points to children' fortran_default=None default=None default_factory=''
  ...
  !line=493 definition="character(80) :: descrip(10) = ''" name='descrip' python_name='descrip' type='character' python_type='str' size='80' dimension='10' comment='Array for descriptive information.' fortran_default="''" default='' default_factory=''
...
subroutine tao_data_struct_to_json (input, json_root, depth)
  ...
  ! parent pointer skip: d1 (tao_d1_data_struct, Pointer to the parent d1_data_struct)
  call json%add(json_root, 'data_source', trim(input%data_source))
  if (allocated(input%data_type)) then
    call json%add(json_root, 'data_type', trim(input%data_type))
  endif
  ...
  call json%add(json_root, 'merit_type', trim(input%merit_type))
  call json%add(json_root, 'bmad_model_value', input%model_value)
  ...
  if (allocated(input%stack)) then
    !line=468 definition='type (tao_eval_stack1_struct), allocatable :: stack(:)' name='stack' python_name='stack' type='tao_eval_stack1_struct' python_type='TaoEvalStack1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_drawing_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ele_shape)) then
    !line=129 definition='type (tao_ele_shape_struct), allocatable :: ele_shape(:)' name='ele_shape' python_name='ele_shape' type='tao_ele_shape_struct' python_type='TaoEleShapeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_dynamic_aperture_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pz)) then
    !line=1051 definition='real(rp), allocatable :: pz(:)' name='pz' python_name='pz' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%scan)) then
    !line=1050 definition='type (aperture_scan_struct), allocatable :: scan(:)' name='scan' python_name='scan' type='aperture_scan_struct' python_type='ApertureScanStruct' size=None dimension=':' comment='One scan for each pz.' fortran_default=None default=None default_factory=''
...
subroutine tao_ele_pointer_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%eles)) then
    !line=108 definition='type (ele_pointer_struct), allocatable :: eles(:)' name='eles' python_name='eles' type='ele_pointer_struct' python_type='ElePointerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_ele_shape_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%uni)) then
    !line=125 definition='type (tao_ele_pointer_struct), allocatable :: uni(:)' name='uni' python_name='uni' type='tao_ele_pointer_struct' python_type='TaoElePointerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_eval_stack1_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%info)) then
    !line=101 definition='type (tao_expression_info_struct), allocatable :: info(:)' name='info' python_name='info' type='tao_expression_info_struct' python_type='TaoExpressionInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%value)) then
    !line=100 definition='real(rp), allocatable :: value(:)' name='value' python_name='value' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%value_ptr)) then
    !line=102 definition='type (tao_real_pointer_struct), allocatable :: value_ptr(:)' name='value_ptr' python_name='value_ptr' type='tao_real_pointer_struct' python_type='TaoRealPointerStruct' size=None dimension=':' comment='Used to point to data, lattice parameters, etc' fortran_default=None default=None default_factory=''
...
subroutine tao_graph_array_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! parent pointer skip: g (tao_graph_struct, )
...
subroutine tao_graph_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'allow_wrap_around', input%allow_wrap_around)
  !line=275 definition='integer :: box(4) = 0' name='box' python_name='box' type='integer' python_type='int' size=None dimension='4' comment='Defines which box the plot is put in.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'box')
  do i1 = lbound(input%box, 1), ubound(input%box, 1)
    call json%create_integer(json_val, input%box(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (allocated(input%curve)) then
    !line=261 definition='type (tao_curve_struct), allocatable :: curve(:)' name='curve' python_name='curve' type='tao_curve_struct' python_type='TaoCurveStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  call json%add(json_root, json_val)
  call json%add(json_root, 'name', trim(input%name))
  ! parent pointer skip: p (tao_plot_struct, pointer to parent plot)
  call qp_rect_struct_to_json(input%scale_margin, json_val, depth + 1)
  call json%rename(json_val, 'scale_margin')
  call json%add(json_root, json_val)
  call json%add(json_root, 'symbol_size_scale', input%symbol_size_scale)
  !line=258 definition="character(100) :: text_legend(10) = ''" name='text_legend' python_name='text_legend' type='character' python_type='str' size='100' dimension='10' comment='Array for holding descriptive info.' fortran_default="''" default='' default_factory=''
  call json%create_array(json_list1, 'text_legend')
  do i1 = lbound(input%text_legend, 1), ubound(input%text_legend, 1)
    call json%create_string(json_val, trim(input%text_legend(i1)), '')
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'text_legend_origin')
  call json%add(json_root, json_val)
  !line=259 definition="character(100) :: text_legend_out(10) = ''" name='text_legend_out' python_name='text_legend_out' type='character' python_type='str' size='100' dimension='10' comment='Array for holding descriptive info.' fortran_default="''" default='' default_factory=''
...
subroutine tao_lat_sigma_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=875 definition='real(rp) :: mat(6,6) = 0' name='mat' python_name='mat' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine tao_lattice_branch_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%bunch_params)) then
    !line=927 definition='type (bunch_params_struct), allocatable :: bunch_params(:)' name='bunch_params' python_name='bunch_params' type='bunch_params_struct' python_type='BunchParamsStruct' size=None dimension=':' comment='Per element' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%bunch_params_comb)) then
    !line=928 definition='type (bunch_track_struct), allocatable :: bunch_params_comb(:)' name='bunch_params_comb' python_name='bunch_params_comb' type='bunch_track_struct' python_type='BunchTrackStruct' size=None dimension=':' comment='A comb for each bunch in beam.' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%high_E_orb)) then
    !line=939 definition='type (coord_struct), allocatable :: high_E_orb(:), low_E_orb(:)' name='high_E_orb' python_name='high_e_orb' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%lat_sigma)) then
    !line=925 definition='type (tao_lat_sigma_struct), allocatable :: lat_sigma(:)' name='lat_sigma' python_name='lat_sigma' type='tao_lat_sigma_struct' python_type='TaoLatSigmaStruct' size=None dimension=':' comment='Sigma matrix derived from lattice (not beam).' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%low_E_orb)) then
    !line=939 definition='type (coord_struct), allocatable :: high_E_orb(:), low_E_orb(:)' name='low_E_orb' python_name='low_e_orb' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%orbit)) then
    !line=929 definition='type (coord_struct), allocatable :: orbit(:)' name='orbit' python_name='orbit' type='coord_struct' python_type='CoordStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%plot_cache)) then
    !line=930 definition='type (tao_plot_cache_struct), allocatable :: plot_cache(:)' name='plot_cache' python_name='plot_cache' type='tao_plot_cache_struct' python_type='TaoPlotCacheStruct' size=None dimension=':' comment='Plotting data cache' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%spin_ele)) then
    !line=926 definition='type (tao_spin_ele_struct), allocatable :: spin_ele(:)' name='spin_ele' python_name='spin_ele' type='tao_spin_ele_struct' python_type='TaoSpinEleStruct' size=None dimension=':' comment='Spin stuff' fortran_default=None default=None default_factory=''
  ...
  call json%add(json_root, json_val)
  ! parent pointer skip: tao_lat (tao_lattice_struct, Parent tao_lat)
...
subroutine tao_lattice_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%tao_branch)) then
    !line=965 definition='type (tao_lattice_branch_struct), allocatable :: tao_branch(:)' name='tao_branch' python_name='tao_branch' type='tao_lattice_branch_struct' python_type='TaoLatticeBranchStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  ! parent pointer skip: u (tao_universe_struct, Parent universe)
...
subroutine tao_model_branch_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%ele)) then
    !line=1001 definition='type (tao_model_element_struct), allocatable :: ele(:)' name='ele' python_name='ele' type='tao_model_element_struct' python_type='TaoModelElementStruct' size=None dimension=':' comment='Per element information' fortran_default=None default=None default_factory=''
...
subroutine tao_plot_array_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! parent pointer skip: p (tao_plot_struct, )
...
subroutine tao_plot_page_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pattern)) then
    !line=339 definition='type (tao_shape_pattern_struct), allocatable :: pattern(:)' name='pattern' python_name='pattern' type='tao_shape_pattern_struct' python_type='TaoShapePatternStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%region)) then
    !line=341 definition='type (tao_plot_region_struct), allocatable :: region(:)' name='region' python_name='region' type='tao_plot_region_struct' python_type='TaoPlotRegionStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  !line=343 definition='real(rp) :: size(2) = 0' name='size' python_name='size' type='real' python_type='float' size=None dimension='2' comment='width and height of plot window in pixels.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'size')
  do i1 = lbound(input%size, 1), ubound(input%size, 1)
    call json%create_real(json_val, input%size(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (allocated(input%template)) then
    !line=340 definition='type (tao_plot_struct), allocatable :: template(:)' name='template' python_name='template' type='tao_plot_struct' python_type='TaoPlotStruct' size=None dimension=':' comment='Templates for the plots.' fortran_default=None default=None default_factory=''
...
subroutine tao_plot_region_struct_to_json (input, json_root, depth)
  ...
  !line=321 definition='real(rp) :: location(4) = 0' name='location' python_name='location' type='real' python_type='float' size=None dimension='4' comment='[x1, x2, y1, y2] location on page.' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'location')
  do i1 = lbound(input%location, 1), ubound(input%location, 1)
    call json%create_real(json_val, input%location(i1), '')
    call json%add(json_list1, json_val)
...
subroutine tao_plot_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%graph)) then
    !line=298 definition='type (tao_graph_struct), allocatable :: graph(:)' name='graph' python_name='graph' type='tao_graph_struct' python_type='TaoGraphStruct' size=None dimension=':' comment='individual graphs of a plot' fortran_default=None default=None default_factory=''
  ...
  ! parent pointer skip: r (tao_plot_region_struct, pointer to parent.)
  call json%add(json_root, 'type', trim(input%type))
  call json%add(json_root, 'x_axis_type', trim(input%x_axis_type))
...
subroutine tao_scratch_space_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%attribs)) then
    !line=854 definition='type (all_pointer_struct), allocatable :: attribs(:)' name='attribs' python_name='attribs' type='all_pointer_struct' python_type='AllPointerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%axis1)) then
    !line=859 definition='real(rp), allocatable :: axis1(:), axis2(:), axis3(:)' name='axis1' python_name='axis1' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%axis2)) then
    !line=859 definition='real(rp), allocatable :: axis1(:), axis2(:), axis3(:)' name='axis2' python_name='axis2' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%axis3)) then
    !line=859 definition='real(rp), allocatable :: axis1(:), axis2(:), axis3(:)' name='axis3' python_name='axis3' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%cc)) then
    !line=848 definition='type (tao_beam_shake_struct), allocatable :: cc(:)' name='cc' python_name='cc' type='tao_beam_shake_struct' python_type='TaoBeamShakeStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%comp)) then
    !line=855 definition='type (tao_data_var_component_struct), allocatable :: comp(:)' name='comp' python_name='comp' type='tao_data_var_component_struct' python_type='TaoDataVarComponentStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%d1_array)) then
    !line=850 definition='type (tao_d1_data_array_struct), allocatable :: d1_array(:)' name='d1_array' python_name='d1_array' type='tao_d1_data_array_struct' python_type='TaoD1DataArrayStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%eles)) then
    !line=849 definition='type (ele_pointer_struct), allocatable :: eles(:)' name='eles' python_name='eles' type='ele_pointer_struct' python_type='ElePointerStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'eles')
    do i1 = lbound(input%eles, 1), ubound(input%eles, 1)
      call ele_pointer_struct_to_json(input%eles(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%err)) then
    !line=860 definition='real(rp), allocatable :: x(:), y(:), err(:)' name='err' python_name='err' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%info)) then
    !line=856 definition='type (tao_expression_info_struct), allocatable :: info(:)' name='info' python_name='info' type='tao_expression_info_struct' python_type='TaoExpressionInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'info')
    do i1 = lbound(input%info, 1), ubound(input%info, 1)
      call tao_expression_info_struct_to_json(input%info(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%info_ix)) then
    !line=857 definition='type (tao_expression_info_struct), allocatable :: info_x(:), info_y(:), info_ix(:)' name='info_ix' python_name='info_ix' type='tao_expression_info_struct' python_type='TaoExpressionInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%info_x)) then
    !line=857 definition='type (tao_expression_info_struct), allocatable :: info_x(:), info_y(:), info_ix(:)' name='info_x' python_name='info_x' type='tao_expression_info_struct' python_type='TaoExpressionInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%info_y)) then
    !line=857 definition='type (tao_expression_info_struct), allocatable :: info_x(:), info_y(:), info_ix(:)' name='info_y' python_name='info_y' type='tao_expression_info_struct' python_type='TaoExpressionInfoStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%picked)) then
    !line=858 definition='logical, allocatable :: picked(:)' name='picked' python_name='picked' type='logical' python_type='bool' size=None dimension=':' comment='' fortran_default=None default=False default_factory=''
  ...
  if (allocated(input%srdt_cache)) then
    !line=862 definition='complex(rp), allocatable :: srdt_cache(:,:,:)' name='srdt_cache' python_name='srdt_cache' type='complex' python_type='Complex' size=None dimension=':,:,:' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%stack)) then
    !line=852 definition='type (tao_eval_stack1_struct), allocatable :: stack(:)' name='stack' python_name='stack' type='tao_eval_stack1_struct' python_type='TaoEvalStack1Struct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'stack')
    do i1 = lbound(input%stack, 1), ubound(input%stack, 1)
      call tao_eval_stack1_struct_to_json(input%stack(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (allocated(input%v1_array)) then
    !line=851 definition='type (tao_v1_var_array_struct), allocatable :: v1_array(:)' name='v1_array' python_name='v1_array' type='tao_v1_var_array_struct' python_type='TaoV1VarArrayStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%var_array)) then
    !line=853 definition='type (tao_var_array_struct), allocatable :: var_array(:)' name='var_array' python_name='var_array' type='tao_var_array_struct' python_type='TaoVarArrayStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%x)) then
    !line=860 definition='real(rp), allocatable :: x(:), y(:), err(:)' name='x' python_name='x' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%y)) then
    !line=860 definition='real(rp), allocatable :: x(:), y(:), err(:)' name='y' python_name='y' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (allocated(input%y_value)) then
    !line=861 definition='real(rp), allocatable :: y_value(:)' name='y_value' python_name='y_value' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine tao_shape_pattern_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%pt)) then
    !line=139 definition='type (tao_shape_pattern_point_struct), allocatable :: pt(:)' name='pt' python_name='pt' type='tao_shape_pattern_point_struct' python_type='TaoShapePatternPointStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
...
subroutine tao_spin_dn_dpz_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=880 definition='real(rp) partial(3,3)' name='partial' python_name='partial' type='real' python_type='float' size=None dimension='3,3' comment='partial(i:) is spin n0 derivative wrt pz for i^th oscillation mode (1 => a-mode, etc.)' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=881 definition='real(rp) partial2(3,3)' name='partial2' python_name='partial2' type='real' python_type='float' size=None dimension='3,3' comment='partial(i:) is spin n0 derivative wrt pz with i^th oscillation mode missing (1 => a-mode, etc.)' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=879 definition='real(rp) vec(3)' name='vec' python_name='vec' type='real' python_type='float' size=None dimension='3' comment='n0 derivative wrt pz.' fortran_default=None default=0.0 default_factory=''
...
subroutine tao_spin_ele_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=886 definition='real(rp) :: orb_eigen_val(6) = 0' name='orb_eigen_val' python_name='orb_eigen_val' type='real' python_type='float' size=None dimension='6' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=887 definition='real(rp) :: orb_eigen_vec(6,6) = 0' name='orb_eigen_vec' python_name='orb_eigen_vec' type='real' python_type='float' size=None dimension='6,6' comment='(j,:) is j^th vector' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=888 definition='real(rp) :: spin_eigen_vec(6,3) = 0' name='spin_eigen_vec' python_name='spin_eigen_vec' type='real' python_type='float' size=None dimension='6,3' comment='(j,:) is j^th vector' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine tao_spin_map_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=389 definition='real(rp) :: mat8(8,8) = 0' name='mat8' python_name='mat8' type='real' python_type='float' size=None dimension='8,8' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine tao_spin_polarization_struct_to_json (input, json_root, depth)
  ...
  !line=900 definition='real(rp) :: depol_rate_partial(3) = real_garbage$' name='depol_rate_partial' python_name='depol_rate_partial' type='real' python_type='float' size=None dimension='3' comment='Depolarization rate (1/sec) using only single mode to calc dn_dpz.' fortran_default='real_garbage$' default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=901 definition='real(rp) :: depol_rate_partial2(3) = real_garbage$' name='depol_rate_partial2' python_name='depol_rate_partial2' type='real' python_type='float' size=None dimension='3' comment='Depolarization rate (1/sec) using only two modes to calc dn_dpz.' fortran_default='real_garbage$' default=0.0 default_factory=''
  ...
  !line=896 definition='real(rp) :: pol_limit_dk_partial(3) = real_garbage$' name='pol_limit_dk_partial' python_name='pol_limit_dk_partial' type='real' python_type='float' size=None dimension='3' comment='Limit using only single mode to calc dn_dpz' fortran_default='real_garbage$' default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=897 definition='real(rp) :: pol_limit_dk_partial2(3) = real_garbage$' name='pol_limit_dk_partial2' python_name='pol_limit_dk_partial2' type='real' python_type='float' size=None dimension='3' comment='Limit using only single mode to calc dn_dpz' fortran_default='real_garbage$' default=0.0 default_factory=''
  ...
  if (allocated(input%q_ele)) then
    !line=908 definition='type (spin_orbit_map1_struct), allocatable :: q_ele(:)' name='q_ele' python_name='q_ele' type='spin_orbit_map1_struct' python_type='SpinOrbitMap1Struct' size=None dimension=':' comment='Save results from spin_concat_linear_maps in tao_spin_polarization.' fortran_default=None default=None default_factory=''
...
subroutine tao_super_universe_struct_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=1145 definition='type (tao_cmd_history_struct) :: history(1000) = tao_cmd_history_struct()' name='history' python_name='history' type='tao_cmd_history_struct' python_type='TaoCmdHistoryStruct' size=None dimension='1000' comment='command history' fortran_default='tao_cmd_history_struct()' default=None default_factory=''
  ...
  if (allocated(input%key)) then
    !line=1140 definition='integer, allocatable :: key(:)' name='key' python_name='key' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default=None default=0 default_factory=''
    call json%create_array(json_list1, 'key')
    do i1 = lbound(input%key, 1), ubound(input%key, 1)
  ...
  if (allocated(input%u)) then
    !line=1138 definition='type (tao_universe_struct), allocatable :: u(:)' name='u' python_name='u' type='tao_universe_struct' python_type='TaoUniverseStruct' size=None dimension=':' comment='array of universes.' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%v1_var)) then
    !line=1136 definition='type (tao_v1_var_struct), allocatable :: v1_var(:)' name='v1_var' python_name='v1_var' type='tao_v1_var_struct' python_type='TaoV1VarStruct' size=None dimension=':' comment='The variable types' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%var)) then
    !line=1137 definition='type (tao_var_struct), allocatable :: var(:)' name='var' python_name='var' type='tao_var_struct' python_type='TaoVarStruct' size=None dimension=':' comment='array of all variables.' fortran_default=None default=None default_factory=''
...
subroutine tao_universe_pointer_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! parent pointer skip: u (tao_universe_struct, )
...
subroutine tao_universe_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%d2_data)) then
    !line=1111 definition='type (tao_d2_data_struct), allocatable :: d2_data(:)' name='d2_data' python_name='d2_data' type='tao_d2_data_struct' python_type='TaoD2DataStruct' size=None dimension=':' comment='The data types' fortran_default=None default=None default_factory=''
  ...
  if (allocated(input%dModel_dVar)) then
    !line=1118 definition='real(rp), allocatable :: dModel_dVar(:,:)' name='dModel_dVar' python_name='dmodel_dvar' type='real' python_type='float' size=None dimension=':,:' comment='Derivative matrix.' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (allocated(input%data)) then
    !line=1112 definition='type (tao_data_struct), allocatable :: data(:)' name='data' python_name='data' type='tao_data_struct' python_type='TaoDataStruct' size=None dimension=':' comment='Array of all data.' fortran_default=None default=None default_factory=''
  ...
  if (associated(input%model_branch)) then
    !line=1110 definition='type (tao_model_branch_struct), pointer :: model_branch(:)' name='model_branch' python_name='bmad_model_branch' type='tao_model_branch_struct' python_type='TaoModelBranchStruct' size=None dimension=':' comment='model specific information' fortran_default=None default=None default_factory=''
    call json%create_array(json_list1, 'bmad_model_branch')
...
subroutine tao_v1_var_struct_to_json (input, json_root, depth)
  ...
  if (associated(input%v)) then
    !line=592 definition='type (tao_var_struct), pointer :: v(:) => null()' name='v' python_name='v' type='tao_var_struct' python_type='TaoVarStruct' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
...
subroutine tao_var_struct_to_json (input, json_root, depth)
  ...
  if (allocated(input%slave)) then
    !line=549 definition='type (tao_var_slave_struct), allocatable :: slave(:)' name='slave' python_name='slave' type='tao_var_slave_struct' python_type='TaoVarSlaveStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  call json%add(json_root, 'useit_opt', input%useit_opt)
  call json%add(json_root, 'useit_plot', input%useit_plot)
  ! parent pointer skip: v1 (tao_v1_var_struct, Pointer to the parent.)
  call json%add(json_root, 'weight', input%weight)
...
subroutine tao_wave_struct_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1073 definition='real(rp) :: amp_a(2) = 0, amp_b(2) = 0, amp_ba(2) = 0' name='amp_a' python_name='amp_a' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1073 definition='real(rp) :: amp_a(2) = 0, amp_b(2) = 0, amp_ba(2) = 0' name='amp_b' python_name='amp_b' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1073 definition='real(rp) :: amp_a(2) = 0, amp_b(2) = 0, amp_ba(2) = 0' name='amp_ba' python_name='amp_ba' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
  ...
  !line=1074 definition='real(rp) :: coef_a(4) = 0, coef_b(4) = 0, coef_ba(4) = 0' name='coef_a' python_name='coef_a' type='real' python_type='float' size=None dimension='4' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1074 definition='real(rp) :: coef_a(4) = 0, coef_b(4) = 0, coef_ba(4) = 0' name='coef_b' python_name='coef_b' type='real' python_type='float' size=None dimension='4' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=1074 definition='real(rp) :: coef_a(4) = 0, coef_b(4) = 0, coef_ba(4) = 0' name='coef_ba' python_name='coef_ba' type='real' python_type='float' size=None dimension='4' comment='' fortran_default='0' default=0 default_factory=''
  ...
  if (allocated(input%ix_data)) then
    !line=1079 definition='integer, allocatable :: ix_data(:)' name='ix_data' python_name='ix_data' type='integer' python_type='int' size=None dimension=':' comment='Translates from plot point to datum index' fortran_default=None default=0 default_factory=''
  ...
  if (allocated(input%kick)) then
    !line=1081 definition='type (tao_wave_kick_pt_struct), allocatable :: kick(:)' name='kick' python_name='kick' type='tao_wave_kick_pt_struct' python_type='TaoWaveKickPtStruct' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
