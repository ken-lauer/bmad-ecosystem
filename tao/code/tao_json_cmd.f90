...
!
! Print information in a form easily parsed json aware programs.
!
! Input:
...
subroutine tao_json_cmd (input_str)
   ...
   type(json_core) :: json
   type(json_value),pointer :: json_root, json_obj
...
!   x_axis_type (variable parameter)
   ...
   select case (command)
    ...
    case ('foobar')
        ...
        call json%create_object(json_obj,'')
        ...
        ! call json%value_add_member(json_root, 'sub', json_obj)
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/csr_beam_tracking/tao.init
!  args:
!    ix_uni: 1
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/cesr/tao.init
!  args:
...
! -----
! Command syntax:
!   json bunch_comb {flags} {who} {ix_uni}@{ix_branch} {ix_bunch}
!
! Where:
...
! -----
! Command syntax:
!   json bunch_params {ele_id}|{which}
!
! Where:
...
!
! Example:
!   json bunch_params end|model  ! parameters at model lattice element named "end".
!
! Parameters
! ----------
! ele_id
...
! -----
! Command syntax:
!   json bunch1 {ele_id}|{which} {ix_bunch} {coordinate}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
! -----
! Command syntax:
!   json building_wall_list {ix_section}
!
! Where:
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_wall
!  args:
!    ix_section:
!
! Example: 2
...
! -----
! Command syntax:
!   json building_wall_graph {graph}
!
! Where:
...
! -----
! Command syntax:
!   json building_wall_point {ix_section}^^{ix_point}^^{z}^^{x}^^{radius}^^{z_center}^^{x_center}
!
! Where:
...
! -----
! Command syntax:
!   json building_wall_section {ix_section}^^{sec_name}^^{sec_constraint}
!
! Where:
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_optics_matching
!  args:
!    who: data
!
! Example: 2
...
! -----
! Command syntax:
!   json data {ix_uni}@{d2_name}.{d1_name}[{dat_index}]
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
...
!
! Use the "json data-d1" command to get detailed info on a specific d1 array.
!
! Example:
!   json data 1@orbit.x[10]
!
! Parameters
! ----------
! d2_name
...
! -----
! Command syntax:
!   json data_d_array {ix_uni}@{d2_name}.{d1_name}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
...
! -----
! Command syntax:
!   json data_d2_array {ix_uni}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
!
! Example:
!   json data_d2_array 1
!
! Parameters
! ----------
! ix_uni
...
! -----
! Command syntax:
!   json data_d2_create {ix_uni}@{d2_name}^^{n_d1_data}^^{d_data_arrays_name_min_max}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
...
!
! Example:
!   json data_d2_create 2@orbit^^2^^x^^0^^45^^y^^1^^47
...
!    d_data_arrays_name_min_max: x^^0^^45^^y^^1^^47
    ...
    case ('data_d2_create')
      ...
      if (size(d2_array) /= 0) then
         ...
         call out_io (s_warn$, r_name, '"json ' // trim(input_str) // '": Data with this name already exists.', &
...
! -----
! Command syntax:
!   json data_d2_destroy {ix_uni}@{d2_name}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
...
! -----
! Command syntax:
!   json data_parameter {data_array} {parameter}
!
! {parameter} may be any tao_data_struct parameter.
! Example:
!   json data_parameter orbit.x model_value
!
! Parameters
! ----------
! data_array
...
! -----
! Command syntax:
!   json datum_create {datum_name}^^{data_type}^^{ele_ref_name}^^{ele_start_name}^^
...
! -----
! Command syntax:
!   json ele:ac_kicker {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:ac_kicker 3@1>>7|model
...
! -----
! Command syntax:
!   json ele:cartesian_map {ele_id}|{which} {index} {who}
!
! Where:
!   {ele_id} is an element name or index
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:cartesian_map 3@1>>7|model 2 base
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_em_field
!  args:
!   ele_id: 1@0>>1
!   which: model
!   index: 1
...
! -----
! Command syntax:
!   json ele:chamber_wall {ele_id}|{which} {index} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_wall3d
!  args:
!   ele_id: 1@0>>1
!   which: model
!   index: 1
...
! -----
! Command syntax:
!   json ele:control_var {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:control_var 3@1>>7|model
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:cylindrical_map {ele_id}|{which} {index} {who}
!
! Where
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:cylindrical_map 3@1>>7|model 2 base
...
! -----
! Command syntax:
!   json ele:elec_multipoles {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:elec_multipoles 3@1>>7|model
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:floor {ele_id}|{which} {where}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
! -----
! Command syntax:
!   json ele:gen_attribs {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:gen_attribs 3@1>>7|model
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:gen_grad_map {ele_id}|{which} {index} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:gen_grad_map 3@1>>7|model 2 base
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:grid_field {ele_id}|{which} {index} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:grid_field 3@1>>7|model 2 base
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_grid
!  args:
!   ele_id: 1@0>>1
!   which: model
!   index: 1
...
! -----
! Command syntax:
!   json ele:lord_slave {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:lord_slave 3@1>>7|model
...
! -----
! Command syntax:
!   json ele:mat6 {ele_id}|{which} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:mat6 3@1>>7|model mat6
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:multipoles {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:multipoles 3@1>>7|model
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:param {ele_id}|{which} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!   {who} values are the same as {who} values for "json lat_list".
!         Note: Here {who} must be a single parameter and not a list.
!
! Example:
!   json ele:param 3@1>>7|model e_tot
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_photon
!  args:
!   ele_id: 1@0>>1
!   which: model
!   who: orbit.vec.1
...
! -----
! Command syntax:
!   json ele:photon {ele_id}|{which} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
!
! Example:
!   json ele:photon 3@1>>7|model base
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json ele:spin_taylor {ele_id}|{which}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
!
! Example:
!   json ele:spin_taylor 3@1>>7|model
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_spin
!  args:
!   ele_id: 1@0>>2
!   which: model
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_taylor
!  args:
!   ele_id: 1@0>>34
!   which: model
...
! -----
! Command syntax:
!   json ele:wake {ele_id}|{which} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_wake
!  args:
!   ele_id: 1@0>>1
!   which: model
!   who: sr_long
...
! -----
! Command syntax:
!   json ele:wall3d {ele_id}|{which} {index} {who}
!
! Where:
!   {ele_id} is an element name or index.
!   {which} is one of: "model", "base" or "design"
...
! Example:
!   json ele:wall3d 3@1>>7|model 2 base
! This gives element number 7 in branch 1 of universe 3.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json evaluate {flags} {expression}
!
! Where:
!   Optional {flags} are:
!       -array_out : If present, the output will be available in the tao_c_interface_com%c_real.
...
!
! Example:
!   json evaluate 3+data::cbar.11[1:10]|model
!
! Parameters
! ----------
! expression :
...
! -----
! Command syntax:
!   json em_field {ele_id}|{which} {x} {y} {z} {t_or_z}
!
! Where:
!   {which} is one of: "model", "base" or "design"
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_floor_orbit
!  args:
!    graph: r33.g
...
!   time "json lat_calc_done" was called.
!
! Notes
! -----
! Command syntax:
...
! -----
! Command syntax:
!   json lat_list {flags} {ix_uni}@{ix_branch}>>{elements}|{which} {who}
!
! Where:
!  Optional {flags} are:
...
!
! Examples:
!   json lat_list -track 3@0>>Q*|base ele.s,orbit.vec.2
!   json lat_list 3@0>>Q*|base real:ele.s
!
! Also see: "json ele:param"
!
! Parameters
! ----------
! elements
...
! -----
! Command syntax:
!   json lat_param_units {param_name}
!
! Parameters
! ----------
! param_name
...
!
! Example:
!   json matrix 2@1>>q01w|design q02w
!
! Parameters
! ----------
! ele1_id
...
! -----
! Command syntax:
!   json orbit_at_s {ix_uni}@{ele}->{s_offset}|{which}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
...
!
! Example:
!   json orbit_at_s Q10->0.4|model   ! Orbit at 0.4 meters from Q10 element exit end in model lattice.
!
! Parameters
! ----------
! ix_uni : optional
...
! -----
! Command syntax:
!   json plot_lat_layout {ix_uni}@{ix_branch}
!
...
! -----
! Command syntax:
!   json plot_graph {graph_name}
!
! {graph_name} is in the form:
!   {p_name}.{g_name}
! where
!   {p_name} is the plot region name if from a region or the plot name if a template plot.
!   This name is obtained from the json plot_list command.
!   {g_name} is the graph name obtained from the json plot1 command.
!
! Parameters
! ----------
! graph_name
...
! -----
! Command syntax:
!   json plot_histogram {curve_name}
!
! Parameters
! ----------
! curve_name
...
! -----
! Command syntax:
!   json plot_template_manage {template_location}^^{template_name}^^
!                          {n_graph}^^{graph_names}
!
! Where:
...
! -----
! Command syntax:
!   json plot_curve_manage {graph_name}^^{curve_index}^^{curve_name}
!
...
! -----
! Command syntax:
!   json plot_graph_manage {plot_name}^^{graph_index}^^{graph_name}
!
...
! -----
! Command syntax:
!   json plot_line {region_name}.{graph_name}.{curve_name} {x_or_y}
!
...
! Examples:
!   json plot_line r13.g.a   ! String array output.
!   json plot_line r13.g.a x ! x-component of line points loaded into the real array buffer.
!   json plot_line r13.g.a y ! y-component of line points loaded into the real array buffer.
!
! Parameters
! ----------
! region_name
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_plot_line -external_plotting
!  args:
!    region_name: beta
!    graph_name: g
!    curve_name: a
...
! -----
! Command syntax:
!   json plot_symbol {region_name}.{graph_name}.{curve_name} {x_or_y}
!
...
! Examples:
!   json plot_symbol r13.g.a       ! String array output.
!   json plot_symbol r13.g.a x     ! x-component of the symbol positions
!                                      loaded into the real array buffer.
!   json plot_symbol r13.g.a y     ! y-component of the symbol positions
!                                      loaded into the real array buffer.
!
! Parameters
! ----------
...
! -----
! Command syntax:
!   json plot_transfer {from_plot} {to_plot}
!
...
! -----
! Command syntax:
!   json ring_general {ix_uni}@{ix_branch}|{which}
!
...
! -----
! Command syntax:
!   json shape_manage {who} {index} {add_or_delete}
!
! {who} is one of:
!   lat_layout
!   floor_plan
...
!
! Example:
!   json shape_manage floor_plan 2 add
! Note: After adding a shape use "json shape_set" to set shape parameters.
...
! -----
! Command syntax:
!   json shape_pattern_list {ix_pattern}
!
...
! --------
! Example: 1
!  init: -init $ACC_ROOT_DIR/regression_tests/json_test/tao.init_shape
!  args:
!    ix_pattern:
...
! -----
! Command syntax:
!   json shape_pattern_manage {ix_pattern}^^{pat_name}^^{pat_line_width}
!
! Where:
...
! -----
! Command syntax:
!   json shape_pattern_point_manage {ix_pattern}^^{ix_point}^^{s}^^{x}
!
! Where:
...
! -----
! Command syntax:
!   json shape_set {who}^^{shape_index}^^{ele_name}^^{shape}^^{color}^^
...
! -----
! Command syntax:
!   json species_to_int {species_str}
!
! Example:
!   json species_to_int CO2++
!
! Parameters
! ----------
! species_str
...
! -----
! Command syntax:
!   json species_to_str {species_int}
!
! Example:
!   json species_to_str -1     ! Returns 'Electron'
!
! Parameters
! ----------
! species_int
...
! -----
! Command syntax:
!   json spin_invariant {flags} {who} {ix_uni}@{ix_branch}|{which}
!
! Where:
!   {flags} are optional switches:
!       -array_out : If present, the output will be available in the tao_c_interface_com%c_real.
...
! -----
! Command syntax:
!   json spin_polarization {ix_uni}@{ix_branch}|{which}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
!   {ix_branch} is a branch index. Defaults to s%global%default_branch.
...
!
! Example:
!   json spin_polarization 1@0|model
!
! Note: This command is under development. If you want to use please contact David Sagan.
!
! Parameters
...
! -----
! Command syntax:
!   json spin_resonance {ix_uni}@{ix_branch}|{which} {ref_ele}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
!   {ix_branch} is a lattice branch index. Defaults to s%global%default_branch.
...
! -----
! Command syntax:
!   json taylor_map {ele1_id} {ele2_id} {order}
!
! Where:
!   {ele1_id} is the start element.
!   {ele2_id} is the end element.
...
! Note: {ele2_id} should just be an element name or index without universe, branch, or model/base/design specification.
! Example:
!   json taylor_map 2@1>>q01w|design q02w  2
!
! Parameters
! ----------
! ele1_id
...
! -----
! Command syntax:
!   json twiss_at_s {ix_uni}@{ele}->{s_offset}|{which}
!
! Where:
!   {ix_uni} is a universe index. Defaults to s%global%default_universe.
!   {ele} is an element name or index. Default at the Beginning element at start of branch 0.
...
! -----
! Command syntax:
!   json universe {ix_uni}
!
! Use "json global" to get the number of universes.
!
! Parameters
! ----------
! ix_uni
...
! -----
! Command syntax:
!   json var_create {var_name}^^{ele_name}^^{attribute}^^{universes}^^
...
! the "json var_v1_create" command.
!
! Parameters
! ----------
! var_name
...
!    key_delta: 0.01
    ...
    case ('var_create')
      ...
      call tao_var_stuffit2(picked, v_ptr, 'json var_create command')
...
! -----
! Command syntax:
!   json var_v_array {v1_var}
!
! Example:
!   json var_v_array quad_k1
!
! Parameters
! ----------
! v1_var
...
! -----
! Command syntax:
!   json var_v1_create {v1_name} {n_var_min} {n_var_max}
!
! {n_var_min} and {n_var_max} are the lower and upper bounds of the var
! Example:
!   json var_v1_create quad_k1 0 45
