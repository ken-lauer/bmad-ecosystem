...
subroutine R_XY_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=46 definition='REAL(DP) A(2)' name='A' python_name='a' type='REAL' python_type='float' size=None dimension='2' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine T_XYZ_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=56 definition='REAL(DP) D(3),DL' name='D' python_name='d' type='REAL' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine B_CYL_to_json (input, json_root, depth)
  ...
  if (associated(input%a_x)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='a_x' python_name='a_x' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%a_y)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='a_y' python_name='a_y' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%b_x)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='b_x' python_name='b_x' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%b_y)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='b_y' python_name='b_y' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%i)) then
    !line=151 definition='integer, DIMENSION(:), POINTER   :: i,j' name='i' python_name='i' type='integer' python_type='int' size=None dimension=':' comment=',ie,je' fortran_default=None default=0 default_factory=''
  ...
  if (associated(input%j)) then
    !line=151 definition='integer, DIMENSION(:), POINTER   :: i,j' name='j' python_name='j' type='integer' python_type='int' size=None dimension=':' comment=',ie,je' fortran_default=None default=0 default_factory=''
  ...
  if (associated(input%va)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='va' python_name='va' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%vb)) then
    !line=152 definition='real(dp), DIMENSION(:,:), POINTER   :: a_x,a_y,b_x,b_y,va,vb' name='vb' python_name='vb' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine three_d_info_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=120 definition='real(dp)  a(3),b(3)' name='a' python_name='a' type='real' python_type='float' size=None dimension='3' comment='Centre of entrance and exit faces' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=120 definition='real(dp)  a(3),b(3)' name='b' python_name='b' type='real' python_type='float' size=None dimension='3' comment='Centre of entrance and exit faces' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=121 definition='real(dp)  ent(3,3),exi(3,3)' name='ent' python_name='ent' type='real' python_type='float' size=None dimension='3,3' comment='entrace and exit frames for drawing magnet faces' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=121 definition='real(dp)  ent(3,3),exi(3,3)' name='exi' python_name='exi' type='real' python_type='float' size=None dimension='3,3' comment='entrace and exit frames for drawing magnet faces' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=123 definition='real(dp)  o(3),mid(3,3)' name='mid' python_name='mid' type='real' python_type='float' size=None dimension='3,3' comment='frames at the point of tracking' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=123 definition='real(dp)  o(3),mid(3,3)' name='o' python_name='o' type='real' python_type='float' size=None dimension='3' comment='frames at the point of tracking' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=126 definition='real(dp) r0(3),r(3)' name='r' python_name='r' type='real' python_type='float' size=None dimension='3' comment='ray position global returned' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=126 definition='real(dp) r0(3),r(3)' name='r0' python_name='r0' type='real' python_type='float' size=None dimension='3' comment='ray position global returned' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=124 definition='real(dp)  reference_ray(6)' name='reference_ray' python_name='reference_ray' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=128 definition='logical(lp) u(2)' name='u' python_name='u' type='logical' python_type='bool' size=None dimension='2' comment='unstable flag for both ray and reference_ray' fortran_default=None default=False default_factory=''
  ...
  !line=125 definition='real(dp) x(6)' name='x' python_name='x' type='real' python_type='float' size=None dimension='6' comment='ray tracked with reference_ray using a  type(beam)' fortran_default=None default=0.0 default_factory=''
...
subroutine EL_LIST_to_json (input, json_root, depth)
  ...
  if (associated(input%APERTURE_POLYGX)) then
    !line=77 definition='REAL(DP), pointer, dimension (:) :: APERTURE_POLYGX => null()' name='APERTURE_POLYGX' python_name='aperture_polygx' type='REAL' python_type='float' size=None dimension=':' comment='length defined with APERTURE_POLYGN' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%APERTURE_POLYGY)) then
    !line=78 definition='REAL(DP), pointer, dimension (:) :: APERTURE_POLYGY => null()' name='APERTURE_POLYGY' python_name='aperture_polygy' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  !line=75 definition='REAL(DP) APERTURE_R(2),APERTURE_X,APERTURE_Y,APERTURE_DX,APERTURE_DY' name='APERTURE_R' python_name='aperture_r' type='REAL' python_type='float' size=None dimension='2' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=59 definition='real(dp) L,LD,LC,K(NMAX),KS(NMAX)' name='K' python_name='k' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, 'kind', int(input%KIND))
  !line=59 definition='real(dp) L,LD,LC,K(NMAX),KS(NMAX)' name='KS' python_name='ks' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=60 definition='real(dp) ang(3),t(3)' name='ang' python_name='ang' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=61 definition='real(dp) angi(3),ti(3)' name='angi' python_name='angi' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=86 definition='REAL(DP) d_bn(NMAX), d_an(NMAX)' name='d_an' python_name='d_an' type='REAL' python_type='float' size=None dimension='NMAX' comment='oscillation amplitudes of multipoles (modulation)' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=86 definition='REAL(DP) d_bn(NMAX), d_an(NMAX)' name='d_bn' python_name='d_bn' type='REAL' python_type='float' size=None dimension='NMAX' comment='oscillation amplitudes of multipoles (modulation)' fortran_default=None default=0.0 default_factory=''
  ...
  !line=60 definition='real(dp) ang(3),t(3)' name='t' python_name='t' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=61 definition='real(dp) angi(3),ti(3)' name='ti' python_name='ti' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine CHARTlist_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=20 definition='real(dp) D_IN(3),D_OUT(3),ANG_IN(3),ANG_OUT(3)' name='ANG_IN' python_name='ang_in' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=20 definition='real(dp) D_IN(3),D_OUT(3),ANG_IN(3),ANG_OUT(3)' name='ANG_OUT' python_name='ang_out' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=20 definition='real(dp) D_IN(3),D_OUT(3),ANG_IN(3),ANG_OUT(3)' name='D_IN' python_name='d_in' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=20 definition='real(dp) D_IN(3),D_OUT(3),ANG_IN(3),ANG_OUT(3)' name='D_OUT' python_name='d_out' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine MAGNET_CHARTLIST_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=28 definition='LOGICAL(Lp) KIN_KEX_BENDFRINGE_EXACT(4)' name='KIN_KEX_BENDFRINGE_EXACT' python_name='kin_kex_bendfringe_exact' type='LOGICAL' python_type='bool' size=None dimension='4' comment='KILL_ENT_FRINGE, KILL_EXI_FRINGE, bend_fringe,EXACT' fortran_default=None default=False default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=26 definition='real(dp) LC_LD_B0_P0(4)' name='LC_LD_B0_P0' python_name='lc_ld_b0_p0' type='real' python_type='float' size=None dimension='4' comment='LC LD B0 P0C' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=29 definition='INTEGER METHOD_NST_NMUL_permfringe_highest(5)' name='METHOD_NST_NMUL_permfringe_highest' python_name='method_nst_nmul_permfringe_highest' type='INTEGER' python_type='int' size=None dimension='5' comment='METHOD,NST,NMUL,permfringr, highest_fringe' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=27 definition='real(dp) TILTD_EDGE(3)' name='TILTD_EDGE' python_name='tiltd_edge' type='real' python_type='float' size=None dimension='3' comment='TILTD EDGE' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=30 definition='LOGICAL(Lp) kill_spin(2)' name='kill_spin' python_name='kill_spin' type='LOGICAL' python_type='bool' size=None dimension='2' comment='' fortran_default=None default=False default_factory=''
...
subroutine ab_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=104 definition='complex(dp) E(nmul_max,nmul_max)' name='E' python_name='e' type='complex' python_type='Complex' size=None dimension='nmul_max,nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=103 definition='complex(dp) b(nmul_max,nmul_max)' name='b' python_name='b' type='complex' python_type='Complex' size=None dimension='nmul_max,nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=105 definition='real(dp) dz_t_te(3*nmul_max+3)' name='dz_t_te' python_name='dz_t_te' type='real' python_type='float' size=None dimension='3*nmul_max+3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=102 definition='integer n_m(2)' name='n_m' python_name='n_m' type='integer' python_type='int' size=None dimension='2' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=106 definition='real(dp) scale_angc_xc_vc_dc_hc(6)' name='scale_angc_xc_vc_dc_hc' python_name='scale_angc_xc_vc_dc_hc' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine ap_list_to_json (input, json_root, depth)
  ...
  !line=119 definition='real(dp) r(2)' name='r' python_name='r' type='real' python_type='float' size=None dimension='2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'r')
  do i1 = lbound(input%r, 1), ubound(input%r, 1)
    call json%create_real(json_val, input%r(i1), '')
    call json%add(json_list1, json_val)
...
subroutine cav_list_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'a', input%A)
  call json%add(json_root, 'cavity_totalpath', int(input%CAVITY_TOTALPATH))
  !line=64 definition='real(dp) F(harm_max)' name='F' python_name='f' type='real' python_type='float' size=None dimension='harm_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, 'n_bessel', int(input%N_BESSEL))
  !line=65 definition='real(dp) PH(harm_max)' name='PH' python_name='ph' type='real' python_type='float' size=None dimension='harm_max' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine ele_list_to_json (input, json_root, depth)
  ...
  !line=43 definition='real(dp) VOLT_FREQ_PHAS(3)' name='VOLT_FREQ_PHAS' python_name='volt_freq_phas' type='real' python_type='float' size=None dimension='3' comment='alg not used' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=41 definition='real(dp) an(nmul_max)' name='an' python_name='an' type='real' python_type='float' size=None dimension='nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=42 definition='real(dp) bn(nmul_max)' name='bn' python_name='bn' type='real' python_type='float' size=None dimension='nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=45 definition='real(dp) fint_hgap_h1_h2_va_vs(8)' name='fint_hgap_h1_h2_va_vs' python_name='fint_hgap_h1_h2_va_vs' type='real' python_type='float' size=None dimension='8' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=39 definition='character(nlp) name_vorname(2)' name='name_vorname' python_name='name_vorname' type='character' python_type='str' size=None dimension='2' comment='' fortran_default=None default='' default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=46 definition='logical(lp) recut_even_electric_MIS(4)' name='recut_even_electric_MIS' python_name='recut_even_electric_mis' type='logical' python_type='bool' size=None dimension='4' comment='' fortran_default=None default=False default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=49 definition='integer skipptcbf(2)' name='skipptcbf' python_name='skipptcbf' type='integer' python_type='int' size=None dimension='2' comment='' fortran_default=None default=0 default_factory=''
  ...
  !line=48 definition='logical(lp) usebf_do1bf(4)' name='usebf_do1bf' python_name='usebf_do1bf' type='logical' python_type='bool' size=None dimension='4' comment='' fortran_default=None default=False default_factory=''
...
subroutine fibrelist_to_json (input, json_root, depth)
  ...
  !line=2 definition='real(dp) GAMMA0I_GAMBET_MASS_AG(4)' name='GAMMA0I_GAMBET_MASS_AG' python_name='gamma0i_gambet_mass_ag' type='real' python_type='float' size=None dimension='4' comment='GAMMA0I,GAMBET,MASS ,AG  BETA0 is computed' fortran_default=None default=0.0 default_factory=''
...
subroutine hel_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'n_bessel', int(input%N_BESSEL))
  !line=73 definition='real(dp) fake_shift(6)' name='fake_shift' python_name='fake_shift' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine patchlist_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=12 definition='real(dp) A_D(3),B_D(3),A_ANG(3),B_ANG(3), A_L,B_L , A_T,B_T' name='A_ANG' python_name='a_ang' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=12 definition='real(dp) A_D(3),B_D(3),A_ANG(3),B_ANG(3), A_L,B_L , A_T,B_T' name='A_D' python_name='a_d' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  !line=12 definition='real(dp) A_D(3),B_D(3),A_ANG(3),B_ANG(3), A_L,B_L , A_T,B_T' name='B_ANG' python_name='b_ang' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=12 definition='real(dp) A_D(3),B_D(3),A_ANG(3),B_ANG(3), A_L,B_L , A_T,B_T' name='B_D' python_name='b_d' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine siam_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=135 definition='real(dp) angle(3)' name='angle' python_name='angle' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=136 definition='real(dp) d(3)' name='d' python_name='d' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'd')
  do i1 = lbound(input%d, 1), ubound(input%d, 1)
    call json%create_real(json_val, input%d(i1), '')
    call json%add(json_list1, json_val)
...
subroutine sol5_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=88 definition='real(dp) dx_dy_pitchx_pitchy(4)' name='dx_dy_pitchx_pitchy' python_name='dx_dy_pitchx_pitchy' type='real' python_type='float' size=None dimension='4' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine tcav_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=127 definition='real(dp) PSI_DPHAS_DVDS_phase0(4)' name='PSI_DPHAS_DVDS_phase0' python_name='psi_dphas_dvds_phase0' type='real' python_type='float' size=None dimension='4' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine thin3_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=81 definition='real(dp) dx_dy_pitchx_pitchy(4)' name='dx_dy_pitchx_pitchy' python_name='dx_dy_pitchx_pitchy' type='real' python_type='float' size=None dimension='4' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'dx_dy_pitchx_pitchy')
  do i1 = lbound(input%dx_dy_pitchx_pitchy, 1), ubound(input%dx_dy_pitchx_pitchy, 1)
    call json%create_real(json_val, input%dx_dy_pitchx_pitchy(i1), '')
    call json%add(json_list1, json_val)
...
subroutine tp10_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'driftkick', input%DRIFTKICK)
  !line=95 definition='real(dp) ae(nmul_max)' name='ae' python_name='ae' type='real' python_type='float' size=None dimension='nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=96 definition='real(dp) be(nmul_max)' name='be' python_name='be' type='real' python_type='float' size=None dimension='nmul_max' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine track_list_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'name', trim(input%name))
  !line=143 definition='integer range(3),direction' name='range' python_name='range' type='integer' python_type='int' size=None dimension='3' comment='' fortran_default=None default=0 default_factory=''
...
subroutine wig_list_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=155 definition='real(dp) a(mode_max)' name='a' python_name='a' type='real' python_type='float' size=None dimension='mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=160 definition='real(dp) ae(mode_max)' name='ae' python_name='ae' type='real' python_type='float' size=None dimension='mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'ae')
  do i1 = lbound(input%ae, 1), ubound(input%ae, 1)
    call json%create_real(json_val, input%ae(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=153 definition='real(dp) ex(wiggler_suntao),ey(wiggler_suntao)' name='ex' python_name='ex' type='real' python_type='float' size=None dimension='wiggler_suntao' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=153 definition='real(dp) ex(wiggler_suntao),ey(wiggler_suntao)' name='ey' python_name='ey' type='real' python_type='float' size=None dimension='wiggler_suntao' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=156 definition='real(dp) f(mode_max)' name='f' python_name='f' type='real' python_type='float' size=None dimension='mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'f')
  do i1 = lbound(input%f, 1), ubound(input%f, 1)
    call json%create_real(json_val, input%f(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=161 definition='real(dp) fe(mode_max)' name='fe' python_name='fe' type='real' python_type='float' size=None dimension='mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=157 definition='integer form(mode_max)' name='form' python_name='form' type='integer' python_type='int' size=None dimension='mode_max' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=162 definition='integer forme(mode_max)' name='forme' python_name='forme' type='integer' python_type='int' size=None dimension='mode_max' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=152 definition='real(dp) internal(6)' name='internal' python_name='internal' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=158 definition='real(dp) k(3,mode_max)' name='k' python_name='k' type='real' python_type='float' size=None dimension='3,mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=163 definition='real(dp) ke(3,mode_max)' name='ke' python_name='ke' type='real' python_type='float' size=None dimension='3,mode_max' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine fibre_monitor_data_to_json (input, json_root, depth)
  ...
  if (associated(input%A)) then
    !line=23 definition='real(dp), pointer :: A(:,:)' name='A' python_name='a' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%At)) then
    !line=24 definition='real(dp), pointer :: At(:,:)' name='At' python_name='at' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%bpm)) then
    !line=18 definition='real(dp), pointer :: bpm(:,:)' name='bpm' python_name='bpm' type='real' python_type='float' size=None dimension=':,:' comment='store fake experiment from alex_track_monitors' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%mom)) then
    !line=22 definition='real(dp), pointer :: mom(:,:)' name='mom' python_name='mom' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  ! parent pointer skip: p (fibre, fibre location)
  if (associated(input%r)) then
    !line=19 definition='real(dp), pointer :: r(:,:)' name='r' python_name='r' type='real' python_type='float' size=None dimension=':,:' comment='store fake experiment from alex_track_monitors' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%xf)) then
    !line=20 definition='real(dp), pointer :: xf(:,:)' name='xf' python_name='xf' type='real' python_type='float' size=None dimension=':,:' comment='real data put here' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%xn)) then
    !line=21 definition='real(dp), pointer :: xn(:,:)' name='xn' python_name='xn' type='real' python_type='float' size=None dimension=':,:' comment='real data put here' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine hermite_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=83 definition='real(dp) :: a(6,6)=0' name='a' python_name='a' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%a, 2), ubound(input%a, 2)
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%a, 1), ubound(input%a, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=84 definition='real(dp):: ai(6,6)=0' name='ai' python_name='ai' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=88 definition='real(dp) b(2,2)' name='b' python_name='b' type='real' python_type='float' size=None dimension='2,2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%b, 2), ubound(input%b, 2)
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%b, 1), ubound(input%b, 1)
  ...
  !line=87 definition='real(dp) ::f(6)=0' name='f' python_name='f' type='real' python_type='float' size=None dimension='6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'f')
  do i1 = lbound(input%f, 1), ubound(input%f, 1)
    call json%create_real(json_val, input%f(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=82 definition='real(dp) :: h(2)' name='h' python_name='h' type='real' python_type='float' size=None dimension='2' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%he)) then
    !line=101 definition='real(dp), pointer ::  he(:,:,:,:,:) => null()' name='he' python_name='he' type='real' python_type='float' size=None dimension=':,:,:,:,:' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  !line=85 definition='real(dp):: m(6,6)=0' name='m' python_name='m' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  !line=86 definition='real(dp):: mi(6,6)=0' name='mi' python_name='mi' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%ms)) then
    !line=90 definition='type(damap), pointer :: ms(:,:)' name='ms' python_name='ms' type='damap' python_type='Damap' size=None dimension=':,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%p)) then
    !line=91 definition='type(probe_8), pointer :: p(:,:)' name='p' python_name='p' type='probe_8' python_type='Probe8' size=None dimension=':,:' comment='' fortran_default=None default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%x0)) then
    !line=92 definition='real(dp), pointer ::  x0(:,:,:) => null()' name='x0' python_name='x0' type='real' python_type='float' size=None dimension=':,:,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list3, 'dim-3')
...
subroutine bunch_to_json (input, json_root, depth)
  ...
  if (associated(input%stable)) then
    !line=45 definition='logical, pointer :: stable(:)' name='stable' python_name='stable' type='logical' python_type='bool' size=None dimension=':' comment='' fortran_default=None default=False default_factory=''
  ...
  if (associated(input%turn)) then
    !line=46 definition='real(dp) , pointer :: turn(:)' name='turn' python_name='turn' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  ! config skip_members: bunch%xs (probe, )
...
subroutine probe_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=350 definition='type(rf_phasor)  AC(nacmax)' name='AC' python_name='ac' type='rf_phasor' python_type='RfPhasor' size=None dimension='nacmax' comment='' fortran_default=None default=None default_factory=''
  ...
  call json%add(json_root, json_val)
  !line=348 definition='type(spinor) s(3)' name='s' python_name='s' type='spinor' python_type='Spinor' size=None dimension='3' comment='' fortran_default=None default=None default_factory=''
  ...
  !line=347 definition='real(dp) x(6)' name='x' python_name='x' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call json%create_real(json_val, input%x(i1), '')
    call json%add(json_list1, json_val)
...
subroutine quaternion_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=127 definition='real(dp) x(0:3)' name='x' python_name='x' type='real' python_type='float' size=None dimension='0:3' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call json%create_real(json_val, input%x(i1), '')
    call json%add(json_list1, json_val)
...
subroutine spinor_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=162 definition='real(dp) x(3)' name='x' python_name='x' type='real' python_type='float' size=None dimension='3' comment='x(3) = (s_x, s_y, s_z)   with  |s|=1' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call json%create_real(json_val, input%x(i1), '')
    call json%add(json_list1, json_val)
...
subroutine tree_element_to_json (input, json_root, depth)
  ...
  if (associated(input%CC)) then
    !line=305 definition='real(dp) ,  DIMENSION(:), POINTER :: CC' name='CC' python_name='cc' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%JL)) then
    !line=307 definition='integer,  DIMENSION(:), POINTER :: JL,JV' name='JL' python_name='jl' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default=None default=0 default_factory=''
  ...
  if (associated(input%JV)) then
    !line=307 definition='integer,  DIMENSION(:), POINTER :: JL,JV' name='JV' python_name='jv' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default=None default=0 default_factory=''
  ...
  if (associated(input%e_ij)) then
    !line=309 definition='real(dp), pointer :: e_ij(:,:)' name='e_ij' python_name='e_ij' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%fix)) then
    !line=306 definition='real(dp) ,  DIMENSION(:), POINTER :: fixr,fix,fix0' name='fix' python_name='fix' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%fix0)) then
    !line=306 definition='real(dp) ,  DIMENSION(:), POINTER :: fixr,fix,fix0' name='fix0' python_name='fix0' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%fixr)) then
    !line=306 definition='real(dp) ,  DIMENSION(:), POINTER :: fixr,fix,fix0' name='fixr' python_name='fixr' type='real' python_type='float' size=None dimension=':' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%rad)) then
    !line=310 definition='real(dp), pointer :: rad(:,:)' name='rad' python_name='rad' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine CONTROL_to_json (input, json_root, depth)
  ...
  if (associated(input%wedge_coeff)) then
    !line=322 definition='real(dp), pointer :: wedge_coeff(:) => null()' name='wedge_coeff' python_name='wedge_coeff' type='real' python_type='float' size=None dimension=':' comment='QUAD_KICK IN WEDGE' fortran_default='null()' default=0.0 default_factory=''
...
subroutine my_1D_taylor_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1484 definition='real(dp) a(0:N_my_1D_taylor)' name='a' python_name='a' type='real' python_type='float' size=None dimension='0:N_my_1D_taylor' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
...
subroutine my_linear_taylor_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=1994 definition='complex(dp) a(0:n_mono)' name='a' python_name='a' type='complex' python_type='Complex' size=None dimension='0:n_mono' comment='@2  &nbsp; Taylor series \x83e\x83C\x83\x89\x81[\x93W\x8aJ\x81i\x83e\x83C\x83\x89\x81[\x82Ä\x82ñ\x82©\x82¢) \x95\x82\x93®\x8f¬\x90\x94\x93_\x90\x94\x81i\x82Ó\x82Ç\x82¤\x82µ\x82å\x82¤\x82·\x82¤\x82Ä\x82ñ\x82·\x82¤\x81j' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
...
subroutine ABELL_to_json (input, json_root, depth)
  ...
  if (associated(input%AN)) then
    !line=92 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='MULTIPLICATIVE FACTOR USUALLY 1' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%B)) then
    !line=94 definition='complex(dp), POINTER :: B(:,:) => null(),E(:,:) => null()' name='B' python_name='b' type='complex' python_type='Complex' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%B, 2), ubound(input%B, 2)
      call json%create_array(json_list1, 'b')
      do i1 = lbound(input%B, 1), ubound(input%B, 1)
  ...
  if (associated(input%BN)) then
    !line=92 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='MULTIPLICATIVE FACTOR USUALLY 1' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%DZ)) then
    !line=93 definition='real(dp), POINTER :: DZ(:) => null(), T(:) => null(), TE(:) => null()' name='DZ' python_name='dz' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%E)) then
    !line=94 definition='complex(dp), POINTER :: B(:,:) => null(),E(:,:) => null()' name='E' python_name='e' type='complex' python_type='Complex' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%E, 2), ubound(input%E, 2)
      call json%create_array(json_list1, 'e')
      do i1 = lbound(input%E, 1), ubound(input%E, 1)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  if (associated(input%SCALE)) then
    call json%add(json_root, 'scale', input%SCALE)
  endif
  if (associated(input%T)) then
    !line=93 definition='real(dp), POINTER :: DZ(:) => null(), T(:) => null(), TE(:) => null()' name='T' python_name='t' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 't')
    do i1 = lbound(input%T, 1), ubound(input%T, 1)
      call json%create_real(json_val, input%T(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%TE)) then
    !line=93 definition='real(dp), POINTER :: DZ(:) => null(), T(:) => null(), TE(:) => null()' name='TE' python_name='te' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
...
subroutine ABELLP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=104 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
  ...
  if (associated(input%B)) then
    !line=106 definition='complex(dp), POINTER :: B(:,:) => null(),E(:,:) => null()' name='B' python_name='b' type='complex' python_type='Complex' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%B, 2), ubound(input%B, 2)
      call json%create_array(json_list1, 'b')
      do i1 = lbound(input%B, 1), ubound(input%B, 1)
  ...
  if (associated(input%BN)) then
    !line=104 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
  ...
  if (associated(input%DZ)) then
    !line=105 definition='real(dp), POINTER :: DZ(:) => null(),T(:) => null(), TE(:) => null()' name='DZ' python_name='dz' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'dz')
    do i1 = lbound(input%DZ, 1), ubound(input%DZ, 1)
      call json%create_real(json_val, input%DZ(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%E)) then
    !line=106 definition='complex(dp), POINTER :: B(:,:) => null(),E(:,:) => null()' name='E' python_name='e' type='complex' python_type='Complex' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%E, 2), ubound(input%E, 2)
      call json%create_array(json_list1, 'e')
      do i1 = lbound(input%E, 1), ubound(input%E, 1)
  ...
  if (associated(input%T)) then
    !line=105 definition='real(dp), POINTER :: DZ(:) => null(),T(:) => null(), TE(:) => null()' name='T' python_name='t' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 't')
    do i1 = lbound(input%T, 1), ubound(input%T, 1)
      call json%create_real(json_val, input%T(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%TE)) then
    !line=105 definition='real(dp), POINTER :: DZ(:) => null(),T(:) => null(), TE(:) => null()' name='TE' python_name='te' type='real' python_type='float' size=None dimension=':' comment=', phi0(:) => null()' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'te')
    do i1 = lbound(input%TE, 1), ubound(input%TE, 1)
      call json%create_real(json_val, input%TE(i1), '')
      call json%add(json_list1, json_val)
...
subroutine AFFINE_FRAME_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=7 definition='REAL(DP), POINTER,DIMENSION(:)  ::   A        => null()' name='A' python_name='a' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ANGLE)) then
    !line=5 definition='REAL(DP), POINTER,DIMENSION(:)  ::   ANGLE(:) => null()' name='ANGLE' python_name='angle' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'angle')
    do i1 = lbound(input%ANGLE, 1), ubound(input%ANGLE, 1)
      call json%create_real(json_val, input%ANGLE(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%B)) then
    !line=9 definition='REAL(DP), POINTER,DIMENSION(:)  ::   B        => null()' name='B' python_name='b' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%B, 1), ubound(input%B, 1)
      call json%create_real(json_val, input%B(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%D)) then
    !line=6 definition='REAL(DP), POINTER,DIMENSION(:)  ::   D(:)     => null()' name='D' python_name='d' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'd')
    do i1 = lbound(input%D, 1), ubound(input%D, 1)
      call json%create_real(json_val, input%D(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ENT)) then
    !line=8 definition='REAL(DP), POINTER,DIMENSION(:,:)::   ENT      => null()' name='ENT' python_name='ent' type='REAL' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%ENT, 2), ubound(input%ENT, 2)
      call json%create_array(json_list1, 'ent')
      do i1 = lbound(input%ENT, 1), ubound(input%ENT, 1)
  ...
  if (associated(input%EXI)) then
    !line=10 definition='REAL(DP), POINTER,DIMENSION(:,:)::   EXI      => null()' name='EXI' python_name='exi' type='REAL' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%EXI, 2), ubound(input%EXI, 2)
      call json%create_array(json_list1, 'exi')
      do i1 = lbound(input%EXI, 1), ubound(input%EXI, 1)
...
subroutine BEAM_BEAM_NODE_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=529 definition='REAL(DP), POINTER :: A(:)  => null()' name='A' python_name='a' type='REAL' python_type='float' size=None dimension=':' comment='patch angles' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BBK)) then
    !line=528 definition='REAL(DP), POINTER :: BBK(:,:)  => null()' name='BBK' python_name='bbk' type='REAL' python_type='float' size=None dimension=':,:' comment='kick on closed orbit' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%D)) then
    !line=530 definition='REAL(DP), POINTER :: D(:)  => null()' name='D' python_name='d' type='REAL' python_type='float' size=None dimension=':' comment='patch translation' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'd')
    do i1 = lbound(input%D, 1), ubound(input%D, 1)
      call json%create_real(json_val, input%D(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FK)) then
    !line=526 definition='REAL(DP), POINTER :: SX(:) => null(),SY(:) => null(),FK(:) => null()' name='FK' python_name='fk' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%S)) then
    !line=524 definition='REAL(DP), POINTER :: S(:)  => null()' name='S' python_name='s' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 's')
    do i1 = lbound(input%S, 1), ubound(input%S, 1)
  ...
  if (associated(input%SX)) then
    !line=526 definition='REAL(DP), POINTER :: SX(:) => null(),SY(:) => null(),FK(:) => null()' name='SX' python_name='sx' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%SY)) then
    !line=526 definition='REAL(DP), POINTER :: SX(:) => null(),SY(:) => null(),FK(:) => null()' name='SY' python_name='sy' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%XM)) then
    !line=527 definition='REAL(DP), POINTER :: XM(:) => null(),YM(:) => null()' name='XM' python_name='xm' type='REAL' python_type='float' size=None dimension=':' comment='trivial transverse displacement: not needed' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%YM)) then
    !line=527 definition='REAL(DP), POINTER :: XM(:) => null(),YM(:) => null()' name='YM' python_name='ym' type='REAL' python_type='float' size=None dimension=':' comment='trivial transverse displacement: not needed' fortran_default='null()' default=0.0 default_factory=''
...
subroutine CAV4_to_json (input, json_root, depth)
  ...
  if (associated(input%AN)) then
    !line=117 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AN0)) then
    !line=128 definition='real(dp),  DIMENSION(:), POINTER :: AN0 => null(),BN0 => null()' name='AN0' python_name='an0' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%BN)) then
    !line=117 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN0)) then
    !line=128 definition='real(dp),  DIMENSION(:), POINTER :: AN0 => null(),BN0 => null()' name='BN0' python_name='bn0' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%F)) then
    !line=119 definition='real(dp), POINTER :: F(:) => null()' name='F' python_name='f' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%F, 1), ubound(input%F, 1)
      call json%create_real(json_val, input%F(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%PH)) then
    !line=121 definition='real(dp), POINTER :: PH(:) => null()' name='PH' python_name='ph' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ph')
    do i1 = lbound(input%PH, 1), ubound(input%PH, 1)
      call json%create_real(json_val, input%PH(i1), '')
      call json%add(json_list1, json_val)
...
subroutine CAV4P_to_json (input, json_root, depth)
  ...
  if (associated(input%AN)) then
    !line=136 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AN0)) then
    !line=148 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN0 => null(),BN0 => null()' name='AN0' python_name='an0' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an0')
    do i1 = lbound(input%AN0, 1), ubound(input%AN0, 1)
  ...
  if (associated(input%BN)) then
    !line=136 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN0)) then
    !line=148 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN0 => null(),BN0 => null()' name='BN0' python_name='bn0' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn0')
    do i1 = lbound(input%BN0, 1), ubound(input%BN0, 1)
  ...
  if (associated(input%F)) then
    !line=139 definition='TYPE(REAL_8), POINTER :: F(:) => null()' name='F' python_name='f' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%F, 1), ubound(input%F, 1)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  if (associated(input%PH)) then
    !line=140 definition='TYPE(REAL_8), POINTER :: PH(:) => null()' name='PH' python_name='ph' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'ph')
    do i1 = lbound(input%PH, 1), ubound(input%PH, 1)
...
subroutine CAV_TRAV_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=159 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=159 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
...
subroutine CAV_TRAVP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=172 definition='type(real_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call real_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=172 definition='type(real_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call real_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine CHART_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=39 definition='real(dp),dimension(:),  POINTER::   D_IN => null() ,ANG_IN => null()' name='ANG_IN' python_name='ang_in' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'ang_in')
  do i1 = lbound(input%ANG_IN, 1), ubound(input%ANG_IN, 1)
    call json%create_real(json_val, input%ANG_IN(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=40 definition='real(dp),dimension(:),  POINTER::   D_OUT => null() ,ANG_OUT => null()' name='ANG_OUT' python_name='ang_out' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'ang_out')
  do i1 = lbound(input%ANG_OUT, 1), ubound(input%ANG_OUT, 1)
    call json%create_real(json_val, input%ANG_OUT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=39 definition='real(dp),dimension(:),  POINTER::   D_IN => null() ,ANG_IN => null()' name='D_IN' python_name='d_in' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd_in')
  do i1 = lbound(input%D_IN, 1), ubound(input%D_IN, 1)
    call json%create_real(json_val, input%D_IN(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=40 definition='real(dp),dimension(:),  POINTER::   D_OUT => null() ,ANG_OUT => null()' name='D_OUT' python_name='d_out' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd_out')
  do i1 = lbound(input%D_OUT, 1), ubound(input%D_OUT, 1)
    call json%create_real(json_val, input%D_OUT(i1), '')
    call json%add(json_list1, json_val)
...
subroutine DAMAP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=190 definition='TYPE (TAYLOR) V(ndim2)' name='V' python_name='v' type='TAYLOR' python_type='Taylor' size=None dimension='ndim2' comment='Ndim2=6 but allocated to nd2=2,4,6 ! etienne_oct_2004' fortran_default=None default=None default_factory=''
...
subroutine DKD2_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=49 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=49 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=50 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=50 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
...
subroutine DKD2P_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=59 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=59 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=60 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=60 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
...
subroutine DRAGTFINN_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=227 definition='real(dp)  constant(ndim2)' name='constant' python_name='constant' type='real' python_type='float' size=None dimension='ndim2' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine ELEMENT_to_json (input, json_root, depth)
  ...
  !line=222 definition='real(dp),   DIMENSION(:), POINTER:: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'an')
  do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
    call json%create_real(json_val, input%AN(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=222 definition='real(dp),   DIMENSION(:), POINTER:: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'bn')
  do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
    call json%create_real(json_val, input%BN(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=228 definition='real(dp),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null();' name='D0_AN' python_name='d0_an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=228 definition='real(dp),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null();' name='D0_BN' python_name='d0_bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null();' default=0.0 default_factory=''
  ...
  !line=228 definition='real(dp),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null();' name='D_AN' python_name='d_an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd_an')
  do i1 = lbound(input%D_AN, 1), ubound(input%D_AN, 1)
    call json%create_real(json_val, input%D_AN(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=228 definition='real(dp),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null();' name='D_BN' python_name='d_bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd_bn')
  do i1 = lbound(input%D_BN, 1), ubound(input%D_BN, 1)
    call json%create_real(json_val, input%D_BN(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=223 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=223 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(),HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (associated(input%backward)) then
    !line=265 definition='type(tree_element), pointer :: forward(:)=> null(),backward(:)=> null()' name='backward' python_name='backward' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='Taylor tracking on a fibre' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%forward)) then
    !line=265 definition='type(tree_element), pointer :: forward(:)=> null(),backward(:)=> null()' name='forward' python_name='forward' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='Taylor tracking on a fibre' fortran_default='null()' default=None default_factory=''
  ...
  ! config skip_members: ELEMENT%girders (element, magnets on a girder)
  ...
  ! config skip_members: ELEMENT%siamese (element, magnets somewhat glued together)
...
subroutine ELEMENTP_to_json (input, json_root, depth)
  ...
  if (associated(input%AN)) then
    !line=294 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN   => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='MULTIPOLE COMPONENT' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=294 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN   => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='MULTIPOLE COMPONENT' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=301 definition='TYPE(REAL_8),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null()' name='D0_AN' python_name='d0_an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'd0_an')
  do i1 = lbound(input%D0_AN, 1), ubound(input%D0_AN, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=301 definition='TYPE(REAL_8),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null()' name='D0_BN' python_name='d0_bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'd0_bn')
  do i1 = lbound(input%D0_BN, 1), ubound(input%D0_BN, 1)
  ...
  !line=301 definition='TYPE(REAL_8),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null()' name='D_AN' python_name='d_an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'd_an')
  do i1 = lbound(input%D_AN, 1), ubound(input%D_AN, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=301 definition='TYPE(REAL_8),   DIMENSION(:), POINTER:: D_AN => null(),D_BN => null(),D0_AN => null(),D0_BN => null()' name='D_BN' python_name='d_bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'd_bn')
  do i1 = lbound(input%D_BN, 1), ubound(input%D_BN, 1)
  ...
  !line=295 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(),HGAP  => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  !line=295 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(),HGAP  => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  if (associated(input%backward)) then
    !line=333 definition='type(tree_element), pointer :: forward(:)=> null(),backward(:)=> null()' name='backward' python_name='backward' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'backward')
    do i1 = lbound(input%backward, 1), ubound(input%backward, 1)
      call tree_element_to_json(input%backward(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%forward)) then
    !line=333 definition='type(tree_element), pointer :: forward(:)=> null(),backward(:)=> null()' name='forward' python_name='forward' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'forward')
    do i1 = lbound(input%forward, 1), ubound(input%forward, 1)
      call tree_element_to_json(input%forward(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine ENGE_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=394 definition='real(dp),  DIMENSION(:), POINTER :: A => null()' name='A' python_name='a' type='real' python_type='float' size=None dimension=':' comment='ENGE  COEFFICIENTS' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AN)) then
    !line=393 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=393 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
...
subroutine ENGEP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=404 definition='real(dp),  DIMENSION(:), POINTER :: A => null()' name='A' python_name='a' type='real' python_type='float' size=None dimension=':' comment='ENGE  COEFFICIENTS' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AN)) then
    !line=402 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=402 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine EXTRA_WORK_to_json (input, json_root, depth)
  ...
  if (associated(input%ORB)) then
    !line=541 definition='REAL(DP), POINTER :: ORB(:)  => null()' name='ORB' python_name='orb' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine E_BEAM_to_json (input, json_root, depth)
  ...
  if (associated(input%Z)) then
    !line=556 definition='type(probe), POINTER :: Z(:)  => null()' name='Z' python_name='z' type='probe' python_type='Probe' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
...
subroutine FIBRE_to_json (input, json_root, depth)
  ...
  ! config skip_members: FIBRE%N (FIBRE, )
  ! config skip_members: FIBRE%NEXT (FIBRE, )
  ! parent pointer skip: P (FIBRE, tying them in the so-called database universe M_u)
  ...
  ! config skip_members: FIBRE%PREVIOUS (FIBRE, )
...
subroutine GMAP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'n', int(input%N))
  !line=196 definition='TYPE (TAYLOR) V(lnv)' name='V' python_name='v' type='TAYLOR' python_type='Taylor' size=None dimension='lnv' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'v')
  do i1 = lbound(input%V, 1), ubound(input%V, 1)
    call TAYLOR_to_json(input%V(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine HELICAL_DIPOLE_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=447 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null(),fake_shift=> null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=447 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null(),fake_shift=> null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%fake_shift)) then
    !line=447 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null(),fake_shift=> null()' name='fake_shift' python_name='fake_shift' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'fake_shift')
    do i1 = lbound(input%fake_shift, 1), ubound(input%fake_shift, 1)
      call json%create_real(json_val, input%fake_shift(i1), '')
      call json%add(json_list1, json_val)
...
subroutine HELICAL_DIPOLEP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=455 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=455 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%fake_shift)) then
    !line=456 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: fake_shift=> null()' name='fake_shift' python_name='fake_shift' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'fake_shift')
    do i1 = lbound(input%fake_shift, 1), ubound(input%fake_shift, 1)
...
subroutine INTEGRATION_NODE_to_json (input, json_root, depth)
  ...
  ! config skip_members: INTEGRATION_NODE%NEXT (INTEGRATION_NODE, )
  if (associated(input%PARENT_FIBRE)) then
    call FIBRE_to_json(input%PARENT_FIBRE, json_val, depth + 1)
    call json%rename(json_val, 'PARENT_FIBRE')
    call json%add(json_root, json_val)
  ...
  ! config skip_members: INTEGRATION_NODE%PREVIOUS (INTEGRATION_NODE, )
  if (associated(input%S)) then
    !line=367 definition='real(dp), POINTER :: S(:)  => null()' name='S' python_name='s' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 's')
    do i1 = lbound(input%S, 1), ubound(input%S, 1)
      call json%create_real(json_val, input%S(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%a)) then
    !line=370 definition='real(dp), pointer :: ent(:,:),a(:)  => null()' name='a' python_name='a' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%a, 1), ubound(input%a, 1)
      call json%create_real(json_val, input%a(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%b)) then
    !line=371 definition='real(dp), pointer :: exi(:,:),b(:)  => null()' name='b' python_name='b' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%b, 1), ubound(input%b, 1)
      call json%create_real(json_val, input%b(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ent)) then
    !line=370 definition='real(dp), pointer :: ent(:,:),a(:)  => null()' name='ent' python_name='ent' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%ent, 2), ubound(input%ent, 2)
      call json%create_array(json_list1, 'ent')
      do i1 = lbound(input%ent, 1), ubound(input%ent, 1)
  ...
  if (associated(input%exi)) then
    !line=371 definition='real(dp), pointer :: exi(:,:),b(:)  => null()' name='exi' python_name='exi' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default=None default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%exi, 2), ubound(input%exi, 2)
      call json%create_array(json_list1, 'exi')
      do i1 = lbound(input%exi, 1), ubound(input%exi, 1)
  ...
  if (associated(input%ref)) then
    !line=369 definition='real(dp), POINTER :: ref(:)  => null()' name='ref' python_name='ref' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine KICKT3_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=68 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=68 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
...
subroutine KICKT3P_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=79 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=79 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine KTK_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=203 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=203 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=206 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=206 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (associated(input%MATX)) then
    !line=204 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATX' python_name='matx' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%MATY)) then
    !line=204 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATY' python_name='maty' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%lx)) then
    !line=205 definition='real(dp),  DIMENSION(:), POINTER :: lx => null(), ly => null()' name='lx' python_name='lx' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%ly)) then
    !line=205 definition='real(dp),  DIMENSION(:), POINTER :: lx => null(), ly => null()' name='ly' python_name='ly' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine KTKP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=215 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=215 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=218 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=218 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  if (associated(input%MATX)) then
    !line=216 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATX' python_name='matx' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATX, 2), ubound(input%MATX, 2)
      call json%create_array(json_list1, 'matx')
      do i1 = lbound(input%MATX, 1), ubound(input%MATX, 1)
  ...
  if (associated(input%MATY)) then
    !line=216 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATY' python_name='maty' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATY, 2), ubound(input%MATY, 2)
      call json%create_array(json_list1, 'maty')
      do i1 = lbound(input%MATY, 1), ubound(input%MATY, 1)
  ...
  call json%add(json_root, json_val)
  if (associated(input%lx)) then
    !line=217 definition='TYPE(REAL_8), DIMENSION(:), POINTER :: lx => null(), ly => null()' name='lx' python_name='lx' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'lx')
    do i1 = lbound(input%lx, 1), ubound(input%lx, 1)
  ...
  if (associated(input%ly)) then
    !line=217 definition='TYPE(REAL_8), DIMENSION(:), POINTER :: lx => null(), ly => null()' name='ly' python_name='ly' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'ly')
    do i1 = lbound(input%ly, 1), ubound(input%ly, 1)
...
subroutine LAYOUT_to_json (input, json_root, depth)
  ...
  if (associated(input%DNA)) then
    !line=432 definition='TYPE(layout_array), POINTER :: DNA(:)  => null()' name='DNA' python_name='dna' type='layout_array' python_type='LayoutArray' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
  ...
  ! config skip_members: LAYOUT%NEXT (LAYOUT, )
  if (associated(input%NTHIN)) then
    call json%add(json_root, 'nthin', int(input%NTHIN))
  endif
  ! config skip_members: LAYOUT%PREVIOUS (LAYOUT, )
...
subroutine MADX_APERTURE_to_json (input, json_root, depth)
  ...
  if (associated(input%POLYGX)) then
    !line=156 definition='REAL(DP),pointer :: POLYGX(:)  => null(), POLYGY(:)  => null()' name='POLYGX' python_name='polygx' type='REAL' python_type='float' size=None dimension=':' comment='arbitrary polygon' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%POLYGY)) then
    !line=156 definition='REAL(DP),pointer :: POLYGX(:)  => null(), POLYGY(:)  => null()' name='POLYGY' python_name='polygy' type='REAL' python_type='float' size=None dimension=':' comment='arbitrary polygon' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%R)) then
    !line=154 definition='REAL(DP),pointer :: R(:)  => null()' name='R' python_name='r' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'r')
    do i1 = lbound(input%R, 1), ubound(input%R, 1)
      call json%create_real(json_val, input%R(i1), '')
      call json%add(json_list1, json_val)
...
subroutine MAGNET_CHART_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=168 definition='type(S_APERTURE), pointer:: A(:)  => null()' name='A' python_name='a' type='S_APERTURE' python_type='SAperture' size=None dimension=':' comment='never used : different aperture at every node' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%A, 1), ubound(input%A, 1)
  ...
  if (associated(input%EDGE)) then
    !line=175 definition='real(dp),  DIMENSION(:), POINTER :: EDGE  => null()' name='EDGE' python_name='edge' type='real' python_type='float' size=None dimension=':' comment='INTERNAL FRAME  design entrance and exit angle' fortran_default='null()' default=0.0 default_factory=''
...
subroutine MAGNET_FRAME_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=15 definition='REAL(DP), POINTER,DIMENSION(:)  ::   A   => null()' name='A' python_name='a' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%B)) then
    !line=19 definition='REAL(DP), POINTER,DIMENSION(:)  ::   B   => null()' name='B' python_name='b' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%B, 1), ubound(input%B, 1)
      call json%create_real(json_val, input%B(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ENT)) then
    !line=16 definition='REAL(DP), POINTER,DIMENSION(:,:)::   ENT => null()' name='ENT' python_name='ent' type='REAL' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%ENT, 2), ubound(input%ENT, 2)
      call json%create_array(json_list1, 'ent')
      do i1 = lbound(input%ENT, 1), ubound(input%ENT, 1)
  ...
  if (associated(input%EXI)) then
    !line=20 definition='REAL(DP), POINTER,DIMENSION(:,:)::   EXI => null()' name='EXI' python_name='exi' type='REAL' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%EXI, 2), ubound(input%EXI, 2)
      call json%create_array(json_list1, 'exi')
      do i1 = lbound(input%EXI, 1), ubound(input%EXI, 1)
  ...
  if (associated(input%MID)) then
    !line=18 definition='REAL(DP), POINTER,DIMENSION(:,:)::   MID => null()' name='MID' python_name='mid' type='REAL' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MID, 2), ubound(input%MID, 2)
      call json%create_array(json_list1, 'mid')
      do i1 = lbound(input%MID, 1), ubound(input%MID, 1)
  ...
  if (associated(input%O)) then
    !line=17 definition='REAL(DP), POINTER,DIMENSION(:)  ::   O   => null()' name='O' python_name='o' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'o')
    do i1 = lbound(input%O, 1), ubound(input%O, 1)
      call json%create_real(json_val, input%O(i1), '')
      call json%add(json_list1, json_val)
...
subroutine MUL_BLOCK_to_json (input, json_root, depth)
  ...
  !line=91 definition='real(dp) AN(NMAX),BN(NMAX)' name='AN' python_name='an' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'an')
  do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
    call json%create_real(json_val, input%AN(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=91 definition='real(dp) AN(NMAX),BN(NMAX)' name='BN' python_name='bn' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'bn')
  do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
    call json%create_real(json_val, input%BN(i1), '')
    call json%add(json_list1, json_val)
...
subroutine NSMI_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%BN)) then
    !line=264 definition='real(dp),  DIMENSION(:), POINTER :: BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
...
subroutine NSMIP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%BN)) then
    !line=269 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine ORBIT_LATTICE_to_json (input, json_root, depth)
  ...
  if (associated(input%ORBIT_NODES)) then
    !line=492 definition='TYPE(ORBIT_NODE), pointer :: ORBIT_NODES(:)  => null()' name='ORBIT_NODES' python_name='orbit_nodes' type='ORBIT_NODE' python_type='OrbitNode' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
  ...
  if (associated(input%dt)) then
    !line=515 definition='real(dp), pointer :: dt(:)  => null()' name='dt' python_name='dt' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine ORBIT_NODE_to_json (input, json_root, depth)
  ...
  if (associated(input%LATTICE)) then
    !line=484 definition='REAL(DP), POINTER :: LATTICE(:)  => null()' name='LATTICE' python_name='lattice' type='REAL' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine PANCAKE_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%B)) then
    !line=427 definition='type(tree_element),  POINTER :: B(:) => null()' name='B' python_name='b' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%B, 1), ubound(input%B, 1)
...
subroutine PANCAKEP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%B)) then
    !line=436 definition='type(tree_element),  POINTER :: B(:) => null()' name='B' python_name='b' type='tree_element' python_type='TreeElement' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'b')
    do i1 = lbound(input%B, 1), ubound(input%B, 1)
      call tree_element_to_json(input%B(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine PATCH_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=28 definition='REAL(DP),DIMENSION(:), POINTER:: A_ANG => null() ,B_ANG => null()' name='A_ANG' python_name='a_ang' type='REAL' python_type='float' size=None dimension=':' comment='ENTRACE AND EXIT ROTATIONS    A_ANG(3)' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'a_ang')
  do i1 = lbound(input%A_ANG, 1), ubound(input%A_ANG, 1)
    call json%create_real(json_val, input%A_ANG(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=27 definition='REAL(DP),DIMENSION(:), POINTER:: A_D => null() ,B_D => null()' name='A_D' python_name='a_d' type='REAL' python_type='float' size=None dimension=':' comment='ENTRACE AND EXIT TRANSLATIONS  A_D(3)' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'a_d')
  do i1 = lbound(input%A_D, 1), ubound(input%A_D, 1)
    call json%create_real(json_val, input%A_D(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=28 definition='REAL(DP),DIMENSION(:), POINTER:: A_ANG => null() ,B_ANG => null()' name='B_ANG' python_name='b_ang' type='REAL' python_type='float' size=None dimension=':' comment='ENTRACE AND EXIT ROTATIONS    A_ANG(3)' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'b_ang')
  do i1 = lbound(input%B_ANG, 1), ubound(input%B_ANG, 1)
    call json%create_real(json_val, input%B_ANG(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=27 definition='REAL(DP),DIMENSION(:), POINTER:: A_D => null() ,B_D => null()' name='B_D' python_name='b_d' type='REAL' python_type='float' size=None dimension=':' comment='ENTRACE AND EXIT TRANSLATIONS  A_D(3)' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'b_d')
  do i1 = lbound(input%B_D, 1), ubound(input%B_D, 1)
    call json%create_real(json_val, input%B_D(i1), '')
    call json%add(json_list1, json_val)
...
subroutine POL_BLOCK_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=131 definition='INTEGER IAN(NMAX),IBN(NMAX)' name='IAN' python_name='ian' type='INTEGER' python_type='int' size=None dimension='NMAX' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=131 definition='INTEGER IAN(NMAX),IBN(NMAX)' name='IBN' python_name='ibn' type='INTEGER' python_type='int' size=None dimension='NMAX' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, 'name', trim(input%NAME))
  call json%add(json_root, 'npara', int(input%NPARA))
  !line=132 definition='real(dp) SAN(NMAX),SBN(NMAX)' name='SAN' python_name='san' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=132 definition='real(dp) SAN(NMAX),SBN(NMAX)' name='SBN' python_name='sbn' type='real' python_type='float' size=None dimension='NMAX' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%TPSAFIT)) then
    !line=127 definition='real(dp),DIMENSION(:), POINTER :: TPSAFIT => null()' name='TPSAFIT' python_name='tpsafit' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine POL_BLOCK_INICOND_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=146 definition='INTEGER       :: ALFA(3)' name='ALFA' python_name='alfa' type='INTEGER' python_type='int' size=None dimension='3' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=145 definition='INTEGER       :: BETA(3)' name='BETA' python_name='beta' type='INTEGER' python_type='int' size=None dimension='3' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=147 definition='INTEGER       :: DISPERSION(4)' name='DISPERSION' python_name='dispersion' type='INTEGER' python_type='int' size=None dimension='4' comment='' fortran_default=None default=0 default_factory=''
...
subroutine POL_BLOCK_sagan_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=11 definition='INTEGER Iinternal(6)' name='Iinternal' python_name='iinternal' type='INTEGER' python_type='int' size=None dimension='6' comment='' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=12 definition='real(dp) SInternal(6)' name='SInternal' python_name='sinternal' type='real' python_type='float' size=None dimension='6' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine POL_sagan_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=6 definition='real(dp) Sa(n_max)' name='Sa' python_name='sa' type='real' python_type='float' size=None dimension='n_max' comment='' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=5 definition='INTEGER ia(n_max)' name='ia' python_name='ia' type='INTEGER' python_type='int' size=None dimension='n_max' comment='' fortran_default=None default=0 default_factory=''
...
subroutine SAGAN_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=56 definition='real(dp),  DIMENSION(:), POINTER :: AN=> null(),BN=> null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component (OPTIONAL)' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=56 definition='real(dp),  DIMENSION(:), POINTER :: AN=> null(),BN=> null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component (OPTIONAL)' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%INTERNAL)) then
    !line=57 definition='real(dp),  DIMENSION(:),  POINTER ::INTERNAL  => null()' name='INTERNAL' python_name='internal' type='real' python_type='float' size=None dimension=':' comment='INTERNAL IS AN EXAMPLE' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'internal')
    do i1 = lbound(input%INTERNAL, 1), ubound(input%INTERNAL, 1)
      call json%create_real(json_val, input%INTERNAL(i1), '')
      call json%add(json_list1, json_val)
...
subroutine SAGANP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=67 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN=> null(),BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component (OPTIONAL)' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=67 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN=> null(),BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component (OPTIONAL)' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%INTERNAL)) then
    !line=68 definition='TYPE(REAL_8), DIMENSION(:),POINTER ::INTERNAL=> null()' name='INTERNAL' python_name='internal' type='REAL_8' python_type='Real8' size=None dimension=':' comment='INTERNAL IS AN EXAMPLE' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'internal')
    do i1 = lbound(input%INTERNAL, 1), ubound(input%INTERNAL, 1)
...
subroutine SOL5_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=181 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=181 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(),BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=182 definition='real(dp), DIMENSION(:),    POINTER:: FINT => null(),HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=182 definition='real(dp), DIMENSION(:),    POINTER:: FINT => null(),HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
...
subroutine SOL5P_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=190 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=190 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=193 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=193 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine SSMI_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=274 definition='real(dp),  DIMENSION(:), POINTER :: AN  => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
...
subroutine SSMIP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=279 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine STREX_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=370 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=370 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=372 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=372 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
...
subroutine STREXP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=381 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=381 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=383 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=383 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine SUPERDRIFT_to_json (input, json_root, depth)
  ...
  !line=35 definition='REAL(DP),DIMENSION(:), POINTER:: D => null(),ang => null()' name='D' python_name='d' type='REAL' python_type='float' size=None dimension=':' comment='TRANSLATIONS  A_D(3) and Angles' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd')
  do i1 = lbound(input%D, 1), ubound(input%D, 1)
    call json%create_real(json_val, input%D(i1), '')
    call json%add(json_list1, json_val)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  !line=35 definition='REAL(DP),DIMENSION(:), POINTER:: D => null(),ang => null()' name='ang' python_name='ang' type='REAL' python_type='float' size=None dimension=':' comment='TRANSLATIONS  A_D(3) and Angles' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'ang')
  do i1 = lbound(input%ang, 1), ubound(input%ang, 1)
    call json%create_real(json_val, input%ang(i1), '')
    call json%add(json_list1, json_val)
...
subroutine SUPERDRIFTP_to_json (input, json_root, depth)
  ...
  !line=42 definition='REAL(DP),DIMENSION(:), POINTER:: D => null(),ang => null()' name='D' python_name='d' type='REAL' python_type='float' size=None dimension=':' comment='TRANSLATIONS  A_D(3) and Angles' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'd')
  do i1 = lbound(input%D, 1), ubound(input%D, 1)
    call json%create_real(json_val, input%D(i1), '')
    call json%add(json_list1, json_val)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  !line=42 definition='REAL(DP),DIMENSION(:), POINTER:: D => null(),ang => null()' name='ang' python_name='ang' type='REAL' python_type='float' size=None dimension=':' comment='TRANSLATIONS  A_D(3) and Angles' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'ang')
  do i1 = lbound(input%ang, 1), ubound(input%ang, 1)
    call json%create_real(json_val, input%ang(i1), '')
    call json%add(json_list1, json_val)
...
subroutine TEAPOT_to_json (input, json_root, depth)
  ...
  if (associated(input%AE)) then
    !line=293 definition='real(dp),  DIMENSION(:), POINTER :: AE => null(), BE => null()' name='AE' python_name='ae' type='real' python_type='float' size=None dimension=':' comment='an,bn for electric stuff' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ae')
    do i1 = lbound(input%AE, 1), ubound(input%AE, 1)
      call json%create_real(json_val, input%AE(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AN)) then
    !line=286 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BE)) then
    !line=293 definition='real(dp),  DIMENSION(:), POINTER :: AE => null(), BE => null()' name='BE' python_name='be' type='real' python_type='float' size=None dimension=':' comment='an,bn for electric stuff' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'be')
    do i1 = lbound(input%BE, 1), ubound(input%BE, 1)
      call json%create_real(json_val, input%BE(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=286 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=289 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=289 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (associated(input%PHI)) then
    !line=294 definition='real(dp),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='PHI' python_name='phi' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%bf_x)) then
    !line=287 definition='real(dp),  DIMENSION(:), POINTER :: bf_x => null(),bf_y => null()' name='bf_x' python_name='bf_x' type='real' python_type='float' size=None dimension=':' comment='B field polynomial' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%bf_y)) then
    !line=287 definition='real(dp),  DIMENSION(:), POINTER :: bf_x => null(),bf_y => null()' name='bf_y' python_name='bf_y' type='real' python_type='float' size=None dimension=':' comment='B field polynomial' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%e_x)) then
    !line=294 definition='real(dp),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='e_x' python_name='e_x' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%e_y)) then
    !line=294 definition='real(dp),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='e_y' python_name='e_y' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%vm)) then
    !line=294 definition='real(dp),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='vm' python_name='vm' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine TEAPOTP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AE)) then
    !line=310 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AE => null(), BE => null()' name='AE' python_name='ae' type='REAL_8' python_type='Real8' size=None dimension=':' comment='an,bn for electric stuff' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'ae')
    do i1 = lbound(input%AE, 1), ubound(input%AE, 1)
  ...
  if (associated(input%AN)) then
    !line=303 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BE)) then
    !line=310 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AE => null(), BE => null()' name='BE' python_name='be' type='REAL_8' python_type='Real8' size=None dimension=':' comment='an,bn for electric stuff' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'be')
    do i1 = lbound(input%BE, 1), ubound(input%BE, 1)
  ...
  if (associated(input%BN)) then
    !line=303 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=306 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=306 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  if (associated(input%PHI)) then
    !line=311 definition='TYPE(REAL_8),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='PHI' python_name='phi' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'phi')
    do i1 = lbound(input%PHI, 1), ubound(input%PHI, 1)
  ...
  if (associated(input%bf_x)) then
    !line=304 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: bf_x => null(),bf_y => null()' name='bf_x' python_name='bf_x' type='REAL_8' python_type='Real8' size=None dimension=':' comment='B field polynomial' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bf_x')
    do i1 = lbound(input%bf_x, 1), ubound(input%bf_x, 1)
  ...
  if (associated(input%bf_y)) then
    !line=304 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: bf_x => null(),bf_y => null()' name='bf_y' python_name='bf_y' type='REAL_8' python_type='Real8' size=None dimension=':' comment='B field polynomial' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bf_y')
    do i1 = lbound(input%bf_y, 1), ubound(input%bf_y, 1)
  ...
  if (associated(input%e_x)) then
    !line=311 definition='TYPE(REAL_8),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='e_x' python_name='e_x' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'e_x')
    do i1 = lbound(input%e_x, 1), ubound(input%e_x, 1)
  ...
  if (associated(input%e_y)) then
    !line=311 definition='TYPE(REAL_8),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='e_y' python_name='e_y' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'e_y')
    do i1 = lbound(input%e_y, 1), ubound(input%e_y, 1)
  ...
  if (associated(input%vm)) then
    !line=311 definition='TYPE(REAL_8),  DIMENSION(:),  POINTER :: e_x => null(),e_y => null(),PHI => null(),vm => null()' name='vm' python_name='vm' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'vm')
    do i1 = lbound(input%vm, 1), ubound(input%vm, 1)
...
subroutine TEMPORAL_BEAM_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%TP)) then
    !line=384 definition='TYPE(TEMPORAL_PROBE), pointer :: TP(:)' name='TP' python_name='tp' type='TEMPORAL_PROBE' python_type='TemporalProbe' size=None dimension=':' comment='' fortran_default=None default=None default_factory=''
  ...
  !line=385 definition='real(DP) a(3),ent(3,3),p0c,total_time' name='a' python_name='a' type='real' python_type='float' size=None dimension='3' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=385 definition='real(DP) a(3),ent(3,3),p0c,total_time' name='ent' python_name='ent' type='real' python_type='float' size=None dimension='3,3' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%ent, 2), ubound(input%ent, 2)
    call json%create_array(json_list1, 'ent')
    do i1 = lbound(input%ent, 1), ubound(input%ent, 1)
...
subroutine TEMPORAL_PROBE_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=379 definition='real(DP)   IC(3)' name='IC' python_name='ic' type='real' python_type='float' size=None dimension='3' comment='(x,y,z,px,py,pz) at dt0' fortran_default=None default=0.0 default_factory=''
  ...
  !line=378 definition='real(DP)   POS(6),T' name='POS' python_name='pos' type='real' python_type='float' size=None dimension='6' comment='(x,y,z,px,py,pz) at dt0 and total time' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, 'r', input%r)
  !line=380 definition='type(spinor) s(3)' name='s' python_name='s' type='spinor' python_type='Spinor' size=None dimension='3' comment='spin vectors at dt0' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 's')
  do i1 = lbound(input%s, 1), ubound(input%s, 1)
    call spinor_to_json(input%s(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine TKTF_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=227 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call json%create_real(json_val, input%AN(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=227 definition='real(dp),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call json%create_real(json_val, input%BN(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=233 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call json%create_real(json_val, input%FINT(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, 'h1', input%H1)
  call json%add(json_root, 'h2', input%H2)
  !line=233 definition='real(dp), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='real' python_type='float' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call json%create_real(json_val, input%HGAP(i1), '')
    call json%add(json_list1, json_val)
  ...
  if (associated(input%MATX)) then
    !line=228 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATX' python_name='matx' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATX, 2), ubound(input%MATX, 2)
      call json%create_array(json_list1, 'matx')
      do i1 = lbound(input%MATX, 1), ubound(input%MATX, 1)
  ...
  if (associated(input%MATX2)) then
    !line=229 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX2 => null(), MATY2 => null()' name='MATX2' python_name='matx2' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%MATY)) then
    !line=228 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATY' python_name='maty' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATY, 2), ubound(input%MATY, 2)
      call json%create_array(json_list1, 'maty')
      do i1 = lbound(input%MATY, 1), ubound(input%MATY, 1)
  ...
  if (associated(input%MATY2)) then
    !line=229 definition='real(dp),  DIMENSION(:,:), POINTER :: MATX2 => null(), MATY2 => null()' name='MATY2' python_name='maty2' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%RMATX)) then
    !line=231 definition='real(dp), DIMENSION(:,:), POINTER :: RMATX => null(), RMATY => null()' name='RMATX' python_name='rmatx' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%RMATY)) then
    !line=231 definition='real(dp), DIMENSION(:,:), POINTER :: RMATX => null(), RMATY => null()' name='RMATY' python_name='rmaty' type='real' python_type='float' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  if (associated(input%Rlx)) then
    !line=232 definition='real(dp), DIMENSION(:), POINTER ::   Rlx => null()' name='Rlx' python_name='rlx' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%lx)) then
    !line=230 definition='real(dp), DIMENSION(:), POINTER :: lx => null()' name='lx' python_name='lx' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'lx')
    do i1 = lbound(input%lx, 1), ubound(input%lx, 1)
      call json%create_real(json_val, input%lx(i1), '')
      call json%add(json_list1, json_val)
...
subroutine TKTFP_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%AN)) then
    !line=246 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='AN' python_name='an' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%AN, 1), ubound(input%AN, 1)
      call REAL_8_to_json(input%AN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%BN)) then
    !line=246 definition='TYPE(REAL_8),  DIMENSION(:), POINTER :: AN => null(), BN => null()' name='BN' python_name='bn' type='REAL_8' python_type='Real8' size=None dimension=':' comment='Multipole component' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%BN, 1), ubound(input%BN, 1)
      call REAL_8_to_json(input%BN(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  !line=252 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='FINT' python_name='fint' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'fint')
  do i1 = lbound(input%FINT, 1), ubound(input%FINT, 1)
    call REAL_8_to_json(input%FINT(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  call json%rename(json_val, 'H2')
  call json%add(json_root, json_val)
  !line=252 definition='TYPE(REAL_8), DIMENSION(:),   POINTER:: FINT => null(), HGAP => null()' name='HGAP' python_name='hgap' type='REAL_8' python_type='Real8' size=None dimension=':' comment='FRINGE FUDGE FOR MAD' fortran_default='null()' default=None default_factory=''
  call json%create_array(json_list1, 'hgap')
  do i1 = lbound(input%HGAP, 1), ubound(input%HGAP, 1)
    call REAL_8_to_json(input%HGAP(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
  ...
  if (associated(input%MATX)) then
    !line=247 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATX' python_name='matx' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATX, 2), ubound(input%MATX, 2)
      call json%create_array(json_list1, 'matx')
      do i1 = lbound(input%MATX, 1), ubound(input%MATX, 1)
  ...
  if (associated(input%MATX2)) then
    !line=248 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX2 => null(), MATY2 => null()' name='MATX2' python_name='matx2' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATX2, 2), ubound(input%MATX2, 2)
      call json%create_array(json_list1, 'matx2')
      do i1 = lbound(input%MATX2, 1), ubound(input%MATX2, 1)
  ...
  if (associated(input%MATY)) then
    !line=247 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX => null(), MATY => null()' name='MATY' python_name='maty' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATY, 2), ubound(input%MATY, 2)
      call json%create_array(json_list1, 'maty')
      do i1 = lbound(input%MATY, 1), ubound(input%MATY, 1)
  ...
  if (associated(input%MATY2)) then
    !line=248 definition='TYPE(REAL_8),  DIMENSION(:,:), POINTER :: MATX2 => null(), MATY2 => null()' name='MATY2' python_name='maty2' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%MATY2, 2), ubound(input%MATY2, 2)
      call json%create_array(json_list1, 'maty2')
      do i1 = lbound(input%MATY2, 1), ubound(input%MATY2, 1)
  ...
  ! parent pointer skip: P (MAGNET_CHART, )
  if (associated(input%RMATX)) then
    !line=250 definition='TYPE(REAL_8), DIMENSION(:,:), POINTER :: RMATX => null(), RMATY => null()' name='RMATX' python_name='rmatx' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%RMATX, 2), ubound(input%RMATX, 2)
      call json%create_array(json_list1, 'rmatx')
      do i1 = lbound(input%RMATX, 1), ubound(input%RMATX, 1)
  ...
  if (associated(input%RMATY)) then
    !line=250 definition='TYPE(REAL_8), DIMENSION(:,:), POINTER :: RMATX => null(), RMATY => null()' name='RMATY' python_name='rmaty' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='LINEAR MATRIX' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%RMATY, 2), ubound(input%RMATY, 2)
      call json%create_array(json_list1, 'rmaty')
      do i1 = lbound(input%RMATY, 1), ubound(input%RMATY, 1)
  ...
  if (associated(input%Rlx)) then
    !line=251 definition='TYPE(REAL_8), DIMENSION(:),   POINTER :: Rlx => null()' name='Rlx' python_name='rlx' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'rlx')
    do i1 = lbound(input%Rlx, 1), ubound(input%Rlx, 1)
  ...
  if (associated(input%lx)) then
    !line=249 definition='TYPE(REAL_8), DIMENSION(:), POINTER :: lx => null()' name='lx' python_name='lx' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'lx')
    do i1 = lbound(input%lx, 1), ubound(input%lx, 1)
      call REAL_8_to_json(input%lx(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine UNIVERSAL_TAYLOR_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%C)) then
    !line=96 definition='REAL(DP), POINTER,dimension(:)::C' name='C' python_name='c' type='REAL' python_type='float' size=None dimension=':' comment='Coefficients C(N)' fortran_default=None default=0.0 default_factory=''
  ...
  if (associated(input%J)) then
    !line=97 definition='INTEGER, POINTER,dimension(:,:)::J' name='J' python_name='j' type='INTEGER' python_type='int' size=None dimension=':,:' comment='Exponents of each coefficients J(N,NV)' fortran_default=None default=0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine acceleration_to_json (input, json_root, depth)
  ...
  if (associated(input%de)) then
    !line=12 definition='real(dp), pointer :: r=> null(),de(:)=> null(),e_in(:)=> null()' name='de' python_name='de' type='real' python_type='float' size=None dimension=':' comment=', unit_time' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%e_in)) then
    !line=12 definition='real(dp), pointer :: r=> null(),de(:)=> null(),e_in(:)=> null()' name='e_in' python_name='e_in' type='real' python_type='float' size=None dimension=':' comment=', unit_time' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%tableau)) then
    !line=17 definition='type(temps_energie),pointer :: tableau(:) => null()' name='tableau' python_name='tableau' type='temps_energie' python_type='TempsEnergie' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
...
subroutine c_UNIVERSAL_TAYLOR_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%C)) then
    !line=102 definition='complex(DP), POINTER,dimension(:)::C => null()' name='C' python_name='c' type='complex' python_type='Complex' size=None dimension=':' comment='Coefficients C(N)' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'c')
    do i1 = lbound(input%C, 1), ubound(input%C, 1)
  ...
  if (associated(input%J)) then
    !line=103 definition='INTEGER, POINTER,dimension(:,:)::J=> null()' name='J' python_name='j' type='INTEGER' python_type='int' size=None dimension=':,:' comment='Exponents of each coefficients J(N,NV)' fortran_default='null()' default=0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%J, 2), ubound(input%J, 2)
      call json%create_array(json_list1, 'j')
      do i1 = lbound(input%J, 1), ubound(input%J, 1)
...
subroutine c_damap_to_json (input, json_root, depth)
  ...
  if (associated(input%cm)) then
    !line=440 definition='complex(dpn), pointer :: cm(:,:)=> null()' name='cm' python_name='cm' type='complex' python_type='Complex' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
  ...
  !line=437 definition='complex(dp) e_ij(6,6)' name='e_ij' python_name='e_ij' type='complex' python_type='Complex' size=None dimension='6,6' comment='@1 stochastic fluctuation in radiation theory' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%e_ij, 2), ubound(input%e_ij, 2)
    call json%create_array(json_list1, 'e_ij')
    do i1 = lbound(input%e_ij, 1), ubound(input%e_ij, 1)
  ...
  nullify(json_list2)
  if (associated(input%m)) then
    !line=441 definition='real(dpn),pointer :: m(:,:)=> null()' name='m' python_name='m' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%m, 2), ubound(input%m, 2)
      call json%create_array(json_list1, 'm')
      do i1 = lbound(input%m, 1), ubound(input%m, 1)
  ...
  call json%add(json_root, json_val)
  !line=435 definition='type (c_taylor) v(lnv)' name='v' python_name='v' type='c_taylor' python_type='CTaylor' size=None dimension='lnv' comment='@1 orbital part of the map' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'v')
  do i1 = lbound(input%v, 1), ubound(input%v, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=439 definition='complex(dp) x0(lnv)' name='x0' python_name='x0' type='complex' python_type='Complex' size=None dimension='lnv' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x0')
  do i1 = lbound(input%x0, 1), ubound(input%x0, 1)
...
subroutine c_dascratch_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! config skip_members: c_dascratch%NEXT (c_dascratch, )
  ! config skip_members: c_dascratch%PREVIOUS (c_dascratch, )
  if (associated(input%t)) then
...
subroutine c_factored_lie_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'dir', int(input%dir))
  if (associated(input%f)) then
    !line=486 definition='type (c_vector_field), pointer :: f(:)=>null()' name='f' python_name='f' type='c_vector_field' python_type='CVectorField' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%f, 1), ubound(input%f, 1)
...
subroutine c_lattice_function_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=18 definition='real(dp) :: H(3,6,6) = 0,B(3,6,6) =0' name='B' python_name='b' type='real' python_type='float' size=None dimension='3,6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  call json%add(json_root, json_list3)
  nullify(json_list3)
  !line=17 definition='real(dp) :: E(3,6,6) =0 ,K(3,6,6) =0' name='E' python_name='e' type='real' python_type='float' size=None dimension='3,6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  call json%add(json_root, json_list3)
  nullify(json_list3)
  !line=18 definition='real(dp) :: H(3,6,6) = 0,B(3,6,6) =0' name='H' python_name='h' type='real' python_type='float' size=None dimension='3,6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  call json%add(json_root, json_list3)
  nullify(json_list3)
  !line=17 definition='real(dp) :: E(3,6,6) =0 ,K(3,6,6) =0' name='K' python_name='k' type='real' python_type='float' size=None dimension='3,6,6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  call json%add(json_root, json_list3)
  nullify(json_list3)
  !line=19 definition='real(dp) :: S(1:3,1:3,0:6) =0' name='S' python_name='s' type='real' python_type='float' size=None dimension='1:3,1:3,0:6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list3, 'dim-3')
  ...
  call json%add(json_root, json_list3)
  nullify(json_list3)
  !line=20 definition='real(dp) ::phase(3) =0 ,damping(3) =0 , spin(2) =0' name='damping' python_name='damping' type='real' python_type='float' size=None dimension='3' comment='' fortran_default='0' default=0 default_factory=''
  ...
  !line=21 definition='real(dp):: fix(6) =0' name='fix' python_name='fix' type='real' python_type='float' size=None dimension='6' comment='' fortran_default='0' default=0 default_factory=''
  call json%create_array(json_list1, 'fix')
  do i1 = lbound(input%fix, 1), ubound(input%fix, 1)
    call json%create_real(json_val, input%fix(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=20 definition='real(dp) ::phase(3) =0 ,damping(3) =0 , spin(2) =0' name='phase' python_name='phase' type='real' python_type='float' size=None dimension='3' comment='' fortran_default='0' default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=25 definition='real(dp) :: sigmas(6,6)' name='sigmas' python_name='sigmas' type='real' python_type='float' size=None dimension='6,6' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=20 definition='real(dp) ::phase(3) =0 ,damping(3) =0 , spin(2) =0' name='spin' python_name='spin' type='real' python_type='float' size=None dimension='2' comment='' fortran_default='0' default=0 default_factory=''
...
subroutine c_linear_map_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=12 definition='complex(dp) mat(6,6)' name='mat' python_name='mat' type='complex' python_type='Complex' size=None dimension='6,6' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=13 definition='complex(dp)  q(0:3,0:6)' name='q' python_name='q' type='complex' python_type='Complex' size=None dimension='0:3,0:6' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine c_normal_form_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  !line=497 definition='integer NRES,M(NDIM2t/2,NRESO),ms(NRESO)' name='M' python_name='m' type='integer' python_type='int' size=None dimension='NDIM2t/2,NRESO' comment='@1 stores resonances to be left in the map, including spin (ms)' fortran_default=None default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%M, 2), ubound(input%M, 2)
    call json%create_array(json_list1, 'm')
    do i1 = lbound(input%M, 1), ubound(input%M, 1)
  ...
  call json%add(json_root, json_val)
  !line=495 definition='complex(dp) b_ijr(6,6)' name='b_ijr' python_name='b_ijr' type='complex' python_type='Complex' size=None dimension='6,6' comment='@1   stochastic kick in resonance basis' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=498 definition='real(dp) tune(NDIM2t/2),damping(NDIM2t/2),spin_tune,quaternion_angle' name='damping' python_name='damping' type='real' python_type='float' size=None dimension='NDIM2t/2' comment='@1 Stores simple information' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'damping')
  do i1 = lbound(input%damping, 1), ubound(input%damping, 1)
    call json%create_real(json_val, input%damping(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=496 definition='real(dp) emittance(3)' name='emittance' python_name='emittance' type='real' python_type='float' size=None dimension='3' comment='@1  Equilibrium emittances as defined by Chao (computed from s_ijr(2*i-1,2*i) i=1,2,3 )' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  ! parent pointer skip: g (c_factored_lie, @1 nonlinear part of a in phasors)
  call c_factored_lie_to_json(input%ker, json_val, depth + 1)
  call json%rename(json_val, 'ker')
  call json%add(json_root, json_val)
  !line=497 definition='integer NRES,M(NDIM2t/2,NRESO),ms(NRESO)' name='ms' python_name='ms' type='integer' python_type='int' size=None dimension='NRESO' comment='@1 stores resonances to be left in the map, including spin (ms)' fortran_default=None default=0 default_factory=''
  call json%create_array(json_list1, 'ms')
  do i1 = lbound(input%ms, 1), ubound(input%ms, 1)
  ...
  !line=493 definition='complex(dp) s_ij0(6,6)' name='s_ij0' python_name='s_ij0' type='complex' python_type='Complex' size=None dimension='6,6' comment='@1  equilibrium beam sizes' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=494 definition='complex(dp) s_ijr(6,6)' name='s_ijr' python_name='s_ijr' type='complex' python_type='Complex' size=None dimension='6,6' comment='@1  equilibrium beam sizes in resonance basis' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  ...
  !line=498 definition='real(dp) tune(NDIM2t/2),damping(NDIM2t/2),spin_tune,quaternion_angle' name='tune' python_name='tune' type='real' python_type='float' size=None dimension='NDIM2t/2' comment='@1 Stores simple information' fortran_default=None default=0.0 default_factory=''
...
subroutine c_quaternion_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=430 definition='type(c_taylor) x(0:3)' name='x' python_name='x' type='c_taylor' python_type='CTaylor' size=None dimension='0:3' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
...
subroutine c_ray_to_json (input, json_root, depth)
  ...
  call json%rename(json_val, 'q')
  call json%add(json_root, json_val)
  !line=524 definition='complex(dp) s1(3),s2(3),s3(3)' name='s1' python_name='s1' type='complex' python_type='Complex' size=None dimension='3' comment='# 3 spin directions' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=524 definition='complex(dp) s1(3),s2(3),s3(3)' name='s2' python_name='s2' type='complex' python_type='Complex' size=None dimension='3' comment='# 3 spin directions' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=524 definition='complex(dp) s1(3),s2(3),s3(3)' name='s3' python_name='s3' type='complex' python_type='Complex' size=None dimension='3' comment='# 3 spin directions' fortran_default=None default=0.0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=521 definition='complex(dp) x(lnv)' name='x' python_name='x' type='complex' python_type='Complex' size=None dimension='lnv' comment='# orbital and/or magnet modulation clocks' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
...
subroutine c_spinmatrix_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=416 definition='type(c_taylor) s(3,3)' name='s' python_name='s' type='c_taylor' python_type='CTaylor' size=None dimension='3,3' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%s, 2), ubound(input%s, 2)
    call json%create_array(json_list1, 's')
    do i1 = lbound(input%s, 1), ubound(input%s, 1)
...
subroutine c_spinor_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=420 definition='type(c_taylor) v(3)' name='v' python_name='v' type='c_taylor' python_type='CTaylor' size=None dimension='3' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'v')
  do i1 = lbound(input%v, 1), ubound(input%v, 1)
    call c_taylor_to_json(input%v(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine c_vector_field_to_json (input, json_root, depth)
  ...
  call json%rename(json_val, 'q')
  call json%add(json_root, json_val)
  !line=464 definition='type (c_taylor) v(lnv)' name='v' python_name='v' type='c_taylor' python_type='CTaylor' size=None dimension='lnv' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'v')
  do i1 = lbound(input%v, 1), ubound(input%v, 1)
    call c_taylor_to_json(input%v(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine c_vector_field_fourier_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%f)) then
    !line=480 definition='type (c_vector_field), pointer :: f(:)  =>null()' name='f' python_name='f' type='c_vector_field' python_type='CVectorField' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%f, 1), ubound(input%f, 1)
      call c_vector_field_to_json(input%f(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
...
subroutine c_yu_w_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 'n', int(input%n))
  if (associated(input%w)) then
    !line=425 definition='type (c_taylor),pointer :: w(:,:)=> null()' name='w' python_name='w' type='c_taylor' python_type='CTaylor' size=None dimension=':,:' comment='@1 orbital part of the map' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
...
subroutine complex_quaternion_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=131 definition='complex(dp) x(0:3)' name='x' python_name='x' type='complex' python_type='Complex' size=None dimension='0:3' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call complex_to_json(input%x(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine dascratch_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! config skip_members: dascratch%NEXT (dascratch, )
  ! config skip_members: dascratch%PREVIOUS (dascratch, )
  if (associated(input%t)) then
    call taylor_to_json(input%t, json_val, depth + 1)
    call json%rename(json_val, 't')
    call json%add(json_root, json_val)
...
subroutine fibre_appearance_to_json (input, json_root, depth)
  ...
  ! config skip_members: fibre_appearance%next (fibre_appearance, )
...
subroutine fibre_array_to_json (input, json_root, depth)
  ...
  ! parent pointer skip: p (fibre, )
  if (associated(input%pos)) then
    call json%add(json_root, 'pos', int(input%pos))
  endif
  if (associated(input%s)) then
    !line=534 definition='real(dp), pointer :: s(:)=> null()' name='s' python_name='s' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 's')
    do i1 = lbound(input%s, 1), ubound(input%s, 1)
      call json%create_real(json_val, input%s(i1), '')
      call json%add(json_list1, json_val)
...
subroutine genfield_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=266 definition='real(dp) constant(ndim2),eps' name='constant' python_name='constant' type='real' python_type='float' size=None dimension='ndim2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'constant')
  do i1 = lbound(input%constant, 1), ubound(input%constant, 1)
    call json%create_real(json_val, input%constant(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=262 definition='type (taylor) d(ndim,ndim)' name='d' python_name='d' type='taylor' python_type='Taylor' size=None dimension='ndim,ndim' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list2, 'dim-2')
...
subroutine girder_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  ! config skip_members: girder%NEXT (girder, )
  ! config skip_members: girder%PREVIOUS (girder, Terminated link list)
  !line=59 definition='real(dp), pointer:: a(:) => null(),ent(:,:) => null()' name='a' python_name='a' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
  ...
  !line=59 definition='real(dp), pointer:: a(:) => null(),ent(:,:) => null()' name='ent' python_name='ent' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%ent, 2), ubound(input%ent, 2)
    call json%create_array(json_list1, 'ent')
    do i1 = lbound(input%ent, 1), ubound(input%ent, 1)
...
subroutine girder_info_to_json (input, json_root, depth)
  ...
  ! config skip_members: girder_info%NEXT (girder_info, Terminated link list)
  !line=69 definition='real(dp), pointer:: a(:) => null(),ent(:,:) => null()' name='a' python_name='a' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'a')
  do i1 = lbound(input%a, 1), ubound(input%a, 1)
    call json%create_real(json_val, input%a(i1), '')
    call json%add(json_list1, json_val)
  ...
  nullify(json_list1)
  if (associated(input%d)) then
    !line=67 definition='real(dp), POINTER ::  d(:)  => null()' name='d' python_name='d' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'd')
    do i1 = lbound(input%d, 1), ubound(input%d, 1)
      call json%create_real(json_val, input%d(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=69 definition='real(dp), pointer:: a(:) => null(),ent(:,:) => null()' name='ent' python_name='ent' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%ent, 2), ubound(input%ent, 2)
    call json%create_array(json_list1, 'ent')
    do i1 = lbound(input%ent, 1), ubound(input%ent, 1)
...
subroutine info_to_json (input, json_root, depth)
  ...
  if (associated(input%beta)) then
    !line=356 definition='real(dp),pointer ::  beta(:)  => null()' name='beta' python_name='beta' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'beta')
    do i1 = lbound(input%beta, 1), ubound(input%beta, 1)
  ...
  if (associated(input%fix)) then
    !line=358 definition='real(dp),pointer ::  fix(:)  => null()' name='fix' python_name='fix' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'fix')
    do i1 = lbound(input%fix, 1), ubound(input%fix, 1)
      call json%create_real(json_val, input%fix(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%fix0)) then
    !line=357 definition='real(dp),pointer ::  fix0(:)  => null()' name='fix0' python_name='fix0' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'fix0')
    do i1 = lbound(input%fix0, 1), ubound(input%fix0, 1)
      call json%create_real(json_val, input%fix0(i1), '')
      call json%add(json_list1, json_val)
  ...
  !line=360 definition='real(dp), pointer:: m(:,:)  => null()' name='m' python_name='m' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%m, 2), ubound(input%m, 2)
    call json%create_array(json_list1, 'm')
    do i1 = lbound(input%m, 1), ubound(input%m, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=359 definition='real(dp), pointer:: pos(:)  => null()' name='pos' python_name='pos' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  call json%create_array(json_list1, 'pos')
  do i1 = lbound(input%pos, 1), ubound(input%pos, 1)
    call json%create_real(json_val, input%pos(i1), '')
    call json%add(json_list1, json_val)
...
subroutine node_array_to_json (input, json_root, depth)
  ...
  if (associated(input%s)) then
    !line=543 definition='complex(dp), pointer :: s(:)=> null()' name='s' python_name='s' type='complex' python_type='Complex' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 's')
    do i1 = lbound(input%s, 1), ubound(input%s, 1)
...
subroutine normalform_to_json (input, json_root, depth)
  ...
  call json%rename(json_val, 'A_t')
  call json%add(json_root, json_val)
  !line=253 definition='real(dp) TUNE(NDIM),DAMPING(NDIM)' name='DAMPING' python_name='damping' type='real' python_type='float' size=None dimension='NDIM' comment='@1 linear tune and linear damping' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'damping')
  do i1 = lbound(input%DAMPING, 1), ubound(input%DAMPING, 1)
    call json%create_real(json_val, input%DAMPING(i1), '')
    call json%add(json_list1, json_val)
  ...
  call json%add(json_root, json_val)
  !line=255 definition='integer NRES,M(NDIM,NRESO),PLANE(NDIM)' name='M' python_name='m' type='integer' python_type='int' size=None dimension='NDIM,NRESO' comment='@1 NRES,M(NDIM,NRESO) -> resonances left in the map' fortran_default=None default=0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%M, 2), ubound(input%M, 2)
    call json%create_array(json_list1, 'm')
    do i1 = lbound(input%M, 1), ubound(input%M, 1)
  ...
  call json%add(json_root, json_val)
  call json%add(json_root, 'nres', int(input%NRES))
  !line=255 definition='integer NRES,M(NDIM,NRESO),PLANE(NDIM)' name='PLANE' python_name='plane' type='integer' python_type='int' size=None dimension='NDIM' comment='@1 NRES,M(NDIM,NRESO) -> resonances left in the map' fortran_default=None default=0 default_factory=''
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=253 definition='real(dp) TUNE(NDIM),DAMPING(NDIM)' name='TUNE' python_name='tune' type='real' python_type='float' size=None dimension='NDIM' comment='@1 linear tune and linear damping' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'tune')
  do i1 = lbound(input%TUNE, 1), ubound(input%TUNE, 1)
    call json%create_real(json_val, input%TUNE(i1), '')
    call json%add(json_list1, json_val)
...
subroutine probe_8_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=363 definition='real(dp) E_ij(6,6)' name='E_ij' python_name='e_ij' type='real' python_type='float' size=None dimension='6,6' comment='Envelope for stochastic radiation' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list2, 'dim-2')
  do i2 = lbound(input%E_ij, 2), ubound(input%E_ij, 2)
    call json%create_array(json_list1, 'e_ij')
    do i1 = lbound(input%E_ij, 1), ubound(input%E_ij, 1)
  ...
  call json%add(json_root, json_list2)
  nullify(json_list2)
  !line=361 definition='type(rf_phasor_8)  ac(nacmax)' name='ac' python_name='ac' type='rf_phasor_8' python_type='RfPhasor8' size=None dimension='nacmax' comment='Modulation of magnet' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'ac')
  do i1 = lbound(input%ac, 1), ubound(input%ac, 1)
  ...
  call json%rename(json_val, 'q')
  call json%add(json_root, json_val)
  !line=359 definition='type(spinor_8) s(3)' name='s' python_name='s' type='spinor_8' python_type='Spinor8' size=None dimension='3' comment='Polymorphic spin s(1:3)' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 's')
  do i1 = lbound(input%s, 1), ubound(input%s, 1)
  ...
  ! parent pointer skip: u (logical, )
  call json%add(json_root, 'use_q', input%use_q)
  !line=358 definition='type(real_8) x(6)' name='x' python_name='x' type='real_8' python_type='Real8' size=None dimension='6' comment='Polymorphic orbital ray' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
  ...
  call json%add(json_root, json_list1)
  nullify(json_list1)
  !line=364 definition='real(dp) x0(6)' name='x0' python_name='x0' type='real' python_type='float' size=None dimension='6' comment='initial value of the ray for TPSA calculations with c_damap' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x0')
  do i1 = lbound(input%x0, 1), ubound(input%x0, 1)
...
subroutine quaternion_8_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=135 definition='type(real_8) x(0:3)' name='x' python_name='x' type='real_8' python_type='Real8' size=None dimension='0:3' comment='' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call real_8_to_json(input%x(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine ramping_to_json (input, json_root, depth)
  ...
  if (associated(input%table)) then
    !line=203 definition='type(time_energy),pointer :: table(:) => null()' name='table' python_name='table' type='time_energy' python_type='TimeEnergy' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
...
subroutine reversedragtfinn_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=234 definition='real(dp)  CONSTANT(NDIM2)' name='CONSTANT' python_name='constant' type='real' python_type='float' size=None dimension='NDIM2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'constant')
  do i1 = lbound(input%CONSTANT, 1), ubound(input%CONSTANT, 1)
    call json%create_real(json_val, input%CONSTANT(i1), '')
    call json%add(json_list1, json_val)
...
subroutine rf_phasor_to_json (input, json_root, depth)
  ...
  call json%add(json_root, 't', input%t)
  !line=333 definition='real(dp) x(2)' name='x' python_name='x' type='real' python_type='float' size=None dimension='2' comment='' fortran_default=None default=0.0 default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call json%create_real(json_val, input%x(i1), '')
    call json%add(json_list1, json_val)
...
subroutine rf_phasor_8_to_json (input, json_root, depth)
  ...
  call json%add(json_root, json_val)
  call json%add(json_root, 't', input%t)
  !line=340 definition='type(real_8)  x(2)' name='x' python_name='x' type='real_8' python_type='Real8' size=None dimension='2' comment='The two hands of the clock' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call real_8_to_json(input%x(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine spinor_8_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=166 definition='type(real_8) x(3)' name='x' python_name='x' type='real_8' python_type='Real8' size=None dimension='3' comment='x(3) = (s_x, s_y, s_z)   with  |s|=1' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'x')
  do i1 = lbound(input%x, 1), ubound(input%x, 1)
    call real_8_to_json(input%x(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
...
subroutine sub_taylor_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=79 definition='INTEGER j(lnv)' name='j' python_name='j' type='INTEGER' python_type='int' size=None dimension='lnv' comment='' fortran_default=None default=0 default_factory=''
  call json%create_array(json_list1, 'j')
  do i1 = lbound(input%j, 1), ubound(input%j, 1)
    call json%create_integer(json_val, input%j(i1), '')
    call json%add(json_list1, json_val)
...
subroutine temps_energie_to_json (input, json_root, depth)
  ...
  if (associated(input%phase)) then
    !line=7 definition='real(dp),pointer :: volt(:)=> null(),phase(:)=> null(),tc=> null()' name='phase' python_name='phase' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'phase')
    do i1 = lbound(input%phase, 1), ubound(input%phase, 1)
      call json%create_real(json_val, input%phase(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%volt)) then
    !line=7 definition='real(dp),pointer :: volt(:)=> null(),phase(:)=> null(),tc=> null()' name='volt' python_name='volt' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine tilting_to_json (input, json_root, depth)
  ...
  !line=189 definition='real(dp) tilt(0:nmax)' name='tilt' python_name='tilt' type='real' python_type='float' size=None dimension='0:nmax' comment='' fortran_default=None default=0.0 default_factory=''
...
subroutine time_energy_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%an)) then
    !line=196 definition='real(dp),pointer :: an(:) => null(),bn(:) => null()' name='an' python_name='an' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'an')
    do i1 = lbound(input%an, 1), ubound(input%an, 1)
      call json%create_real(json_val, input%an(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%bn)) then
    !line=196 definition='real(dp),pointer :: an(:) => null(),bn(:) => null()' name='bn' python_name='bn' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'bn')
    do i1 = lbound(input%bn, 1), ubound(input%bn, 1)
      call json%create_real(json_val, input%bn(i1), '')
      call json%add(json_list1, json_val)
...
subroutine tree_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  !line=216 definition='type (taylor) branch(ndim2)' name='branch' python_name='branch' type='taylor' python_type='Taylor' size=None dimension='ndim2' comment='' fortran_default=None default=None default_factory=''
...
subroutine undu_R_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=18 definition='real(dp), DIMENSION(:), pointer :: A=> null()' name='A' python_name='a' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
      call json%create_real(json_val, input%A(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%AE)) then
    !line=23 definition='real(dp), DIMENSION(:), pointer :: AE=> null()' name='AE' python_name='ae' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ae')
    do i1 = lbound(input%AE, 1), ubound(input%AE, 1)
      call json%create_real(json_val, input%AE(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%F)) then
    !line=19 definition='real(dp), DIMENSION(:), pointer :: F=> null()' name='F' python_name='f' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%F, 1), ubound(input%F, 1)
      call json%create_real(json_val, input%F(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FE)) then
    !line=24 definition='real(dp), DIMENSION(:), pointer :: FE=> null()' name='FE' python_name='fe' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'fe')
    do i1 = lbound(input%FE, 1), ubound(input%FE, 1)
      call json%create_real(json_val, input%FE(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FORM)) then
    !line=30 definition='integer, DIMENSION(:), pointer :: FORM=> null()' name='FORM' python_name='form' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default='null()' default=0 default_factory=''
    call json%create_array(json_list1, 'form')
    do i1 = lbound(input%FORM, 1), ubound(input%FORM, 1)
      call json%create_integer(json_val, input%FORM(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FORME)) then
    !line=31 definition='integer, DIMENSION(:), pointer :: FORME=> null()' name='FORME' python_name='forme' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default='null()' default=0 default_factory=''
    call json%create_array(json_list1, 'forme')
    do i1 = lbound(input%FORME, 1), ubound(input%FORME, 1)
      call json%create_integer(json_val, input%FORME(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%K)) then
    !line=17 definition='real(dp), DIMENSION(:,:), pointer :: K=> null()' name='K' python_name='k' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%K, 2), ubound(input%K, 2)
      call json%create_array(json_list1, 'k')
      do i1 = lbound(input%K, 1), ubound(input%K, 1)
  ...
  if (associated(input%KE)) then
    !line=22 definition='real(dp), DIMENSION(:,:), pointer :: KE=> null()' name='KE' python_name='ke' type='real' python_type='float' size=None dimension=':,:' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%KE, 2), ubound(input%KE, 2)
      call json%create_array(json_list1, 'ke')
      do i1 = lbound(input%KE, 1), ubound(input%KE, 1)
  ...
  if (associated(input%ex)) then
    !line=27 definition='real(dp), DIMENSION(:), pointer :: ex=> null(),ey=> null()' name='ex' python_name='ex' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ex')
    do i1 = lbound(input%ex, 1), ubound(input%ex, 1)
      call json%create_real(json_val, input%ex(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ey)) then
    !line=27 definition='real(dp), DIMENSION(:), pointer :: ex=> null(),ey=> null()' name='ey' python_name='ey' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ey')
    do i1 = lbound(input%ey, 1), ubound(input%ey, 1)
      call json%create_real(json_val, input%ey(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%x0)) then
    !line=20 definition='real(dp), DIMENSION(:), pointer :: x0=> null()' name='x0' python_name='x0' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'x0')
    do i1 = lbound(input%x0, 1), ubound(input%x0, 1)
      call json%create_real(json_val, input%x0(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%x0E)) then
    !line=25 definition='real(dp), DIMENSION(:), pointer :: x0E=> null()' name='x0E' python_name='x0e' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%y0)) then
    !line=21 definition='real(dp), DIMENSION(:), pointer :: y0=> null()' name='y0' python_name='y0' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
  ...
  if (associated(input%y0E)) then
    !line=26 definition='real(dp), DIMENSION(:), pointer :: y0E=> null()' name='y0E' python_name='y0e' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
...
subroutine undu_p_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  if (associated(input%A)) then
    !line=36 definition='TYPE(REAL_8), DIMENSION(:), pointer :: A=> null()' name='A' python_name='a' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'a')
    do i1 = lbound(input%A, 1), ubound(input%A, 1)
  ...
  if (associated(input%AE)) then
    !line=41 definition='TYPE(REAL_8), DIMENSION(:), pointer :: AE=> null()' name='AE' python_name='ae' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'ae')
    do i1 = lbound(input%AE, 1), ubound(input%AE, 1)
      call REAL_8_to_json(input%AE(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%F)) then
    !line=37 definition='TYPE(REAL_8), DIMENSION(:), pointer :: F=> null()' name='F' python_name='f' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'f')
    do i1 = lbound(input%F, 1), ubound(input%F, 1)
      call REAL_8_to_json(input%F(i1), json_val, depth + 1)
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FE)) then
    !line=42 definition='TYPE(REAL_8), DIMENSION(:), pointer :: FE=> null()' name='FE' python_name='fe' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'fe')
    do i1 = lbound(input%FE, 1), ubound(input%FE, 1)
  ...
  if (associated(input%FORM)) then
    !line=48 definition='integer, DIMENSION(:), pointer :: FORM=> null()' name='FORM' python_name='form' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default='null()' default=0 default_factory=''
    call json%create_array(json_list1, 'form')
    do i1 = lbound(input%FORM, 1), ubound(input%FORM, 1)
      call json%create_integer(json_val, input%FORM(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%FORME)) then
    !line=49 definition='integer, DIMENSION(:), pointer :: FORME=> null()' name='FORME' python_name='forme' type='integer' python_type='int' size=None dimension=':' comment='' fortran_default='null()' default=0 default_factory=''
    call json%create_array(json_list1, 'forme')
    do i1 = lbound(input%FORME, 1), ubound(input%FORME, 1)
      call json%create_integer(json_val, input%FORME(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%K)) then
    !line=35 definition='TYPE(REAL_8), DIMENSION(:,:), pointer :: K=> null()' name='K' python_name='k' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%K, 2), ubound(input%K, 2)
      call json%create_array(json_list1, 'k')
      do i1 = lbound(input%K, 1), ubound(input%K, 1)
  ...
  if (associated(input%KE)) then
    !line=40 definition='TYPE(REAL_8), DIMENSION(:,:), pointer :: KE=> null()' name='KE' python_name='ke' type='REAL_8' python_type='Real8' size=None dimension=':,:' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list2, 'dim-2')
    do i2 = lbound(input%KE, 2), ubound(input%KE, 2)
      call json%create_array(json_list1, 'ke')
      do i1 = lbound(input%KE, 1), ubound(input%KE, 1)
  ...
  if (associated(input%ex)) then
    !line=45 definition='real(dp), DIMENSION(:), pointer :: ex=> null(),ey=> null()' name='ex' python_name='ex' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ex')
    do i1 = lbound(input%ex, 1), ubound(input%ex, 1)
      call json%create_real(json_val, input%ex(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%ey)) then
    !line=45 definition='real(dp), DIMENSION(:), pointer :: ex=> null(),ey=> null()' name='ey' python_name='ey' type='real' python_type='float' size=None dimension=':' comment='' fortran_default='null()' default=0.0 default_factory=''
    call json%create_array(json_list1, 'ey')
    do i1 = lbound(input%ey, 1), ubound(input%ey, 1)
      call json%create_real(json_val, input%ey(i1), '')
      call json%add(json_list1, json_val)
  ...
  if (associated(input%x0)) then
    !line=38 definition='TYPE(REAL_8), DIMENSION(:), pointer :: x0=> null()' name='x0' python_name='x0' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'x0')
    do i1 = lbound(input%x0, 1), ubound(input%x0, 1)
  ...
  if (associated(input%x0E)) then
    !line=43 definition='TYPE(REAL_8), DIMENSION(:), pointer :: x0E=> null()' name='x0E' python_name='x0e' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'x0e')
    do i1 = lbound(input%x0E, 1), ubound(input%x0E, 1)
  ...
  if (associated(input%y0)) then
    !line=39 definition='TYPE(REAL_8), DIMENSION(:), pointer :: y0=> null()' name='y0' python_name='y0' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'y0')
    do i1 = lbound(input%y0, 1), ubound(input%y0, 1)
  ...
  if (associated(input%y0E)) then
    !line=44 definition='TYPE(REAL_8), DIMENSION(:), pointer :: y0E=> null()' name='y0E' python_name='y0e' type='REAL_8' python_type='Real8' size=None dimension=':' comment='' fortran_default='null()' default=None default_factory=''
    call json%create_array(json_list1, 'y0e')
    do i1 = lbound(input%y0E, 1), ubound(input%y0E, 1)
...
subroutine vecfield_to_json (input, json_root, depth)
  ...
  call json%create_object(json_root, '')
  call json%add(json_root, 'ifac', int(input%ifac))
  !line=202 definition='type (taylor) v(ndim2)' name='v' python_name='v' type='taylor' python_type='Taylor' size=None dimension='ndim2' comment='@1 <font face="Times New Roman">V<sub>i</sub>&#8706;<sub>i</sub></font> Operator' fortran_default=None default=None default_factory=''
  call json%create_array(json_list1, 'v')
  do i1 = lbound(input%v, 1), ubound(input%v, 1)
    call taylor_to_json(input%v(i1), json_val, depth + 1)
    call json%add(json_list1, json_val)
